...
### [1] [Microsecond-Scale Coherent Control of a Forbidden Clock Transition with Doppler-Free Multiphoton Excitations](https://arxiv.org/abs/2607.06789)
...
### [2] [Absolute frequency measurement of the $^{176}$Lu$^+\,(^{3}\mathrm{D}_1)$ standard against the NRC-FCs2 fountain with $2.6\times10^{-16}$ uncertainty](https://arxiv.org/abs/2607.07044)
...
### [3] [Density effects in precision laser spectroscopy of exotic helium atoms](https://arxiv.org/abs/2607.07125)
...
### [4] [Collision and static widths of self-broadened line shapes in optically saturated high-density atomic vapor](https://arxiv.org/abs/2607.07303)
...
### [5] [Precision spectroscopy of the fine and hyperfine structures of high molecular Rydberg-Stark states: Metrology of molecular hydrogen ions](https://arxiv.org/abs/2607.07636)
...
### [6] [Hadronic vacuum polarization in hydrogen-like atoms and ions amid the interplay of recoil and finite-size effects](https://arxiv.org/abs/2607.07658)
...
### [7] [Impact of Courant number on the results of numerical simulating of signal propagation in non-dispersive homogeneous media](https://arxiv.org/abs/2607.06707)
...
### [8] [Path Integral Monte Carlo for Fictitious Identical Particles with ξ-Ensemble](https://arxiv.org/abs/2607.06955)
*Yunuo Xiong*
...
### [9] [Radiation Damage Cascades in Fullerite Using Molecular Dynamics](https://arxiv.org/abs/2607.06962)
...
### [10] [Inverse Low-Dimensional Manifold Reconstruction Framework for Spatiotemporal Reconstruction of Compressible Physical Fields](https://arxiv.org/abs/2607.07084)
...
### [11] [Collaborate to decorrelate in path space: Hamiltonian replica exchange transition interface sampling (HRETIS)](https://arxiv.org/abs/2607.07453)
...
### [12] [Semilocal exchange functionals from the exact-exchange condition for the hydrogen atom: Hydrogenic exactness and recovery of Rydberg-like bound states](https://arxiv.org/abs/2607.07648)
*Fumihiro Imoto*
...
### [13] [Scaling WaterLily.jl with MPI and an improved geometric multigrid solver](https://arxiv.org/abs/2607.07687)
...
### [14] [Five-Dimensional Beam Sigma Matrix Determination in Transport Lines with Differentiable Simulation](https://arxiv.org/abs/2607.06759)
...
### [15] [An Innovative Computational Fluid Dynamics Discrete Dipole Approximation (CFD-DDA) Platform for Predicting Airborne Virus-in-Saliva Disinfection by Ultraviolet Irradiation](https://arxiv.org/abs/2607.06746)
...
### [16] [Physically consistent formulation for the bound vortex sheet strength in the Wagner model](https://arxiv.org/abs/2607.06884)
...
### [17] [Route survival and spectral modification of finite-depth salt-finger plume forests under imposed mean shear](https://arxiv.org/abs/2607.07012)
*Sriram P. Kalathoor*
...
### [18] [Learning Turbulence Closures with Physics-Informed Neural Networks for the Rayleigh-Taylor Transition to Turbulence](https://arxiv.org/abs/2607.07020)
...
### [19] [Elastic pseudoturbulence induced by low-Galilei settling spheres](https://arxiv.org/abs/2607.07194)
...
### [20] [Interaction of vortex rings generated by two unsynchronised drop impacts](https://arxiv.org/abs/2607.07214)
...
### [21] [Skin friction prediction for attached flows based on two-dimensional inviscid solutions](https://arxiv.org/abs/2607.07246)
...
### [22] [Three-dimensional global stability analysis of turbulent screeching jets](https://arxiv.org/abs/2607.07300)
...
### [23] [An improved fully one-sided diffuse-interface immersed boundary method with target-value reconstruction for compressible flows](https://arxiv.org/abs/2607.07432)
...
### [24] [A fully one-sided diffuse-interface immersed boundary method for wall-modeled large-eddy simulation](https://arxiv.org/abs/2607.07443)
...
### [25] [Experimental evidence of Kelvin wave turbulence along a vortex core](https://arxiv.org/abs/2607.07535)
...
### [26] [Beyond Silica Assumptions: Optical Network Design in the Hollow-Core Era](https://arxiv.org/abs/2607.06877)
...
### [27] [Exoplanet Detection Using Adaptive Quantum-Optimal Measurement](https://arxiv.org/abs/2607.06931)
...
### [28] [Single-laser stimulated Brillouin scattering microscopy](https://arxiv.org/abs/2607.06961)
...
### [29] [Scalar-Wave Dispersion in Vectorial Photonic Crystals via Site-Adapted p Orbitals](https://arxiv.org/abs/2607.07224)
...
### [30] [Rayleigh Bound States in the Continuum](https://arxiv.org/abs/2607.07228)
...
### [31] [Beyond white- and black-box modeling tools in optical communications and optical computing: physics-informed data-driven modeling](https://arxiv.org/abs/2607.07274)
...
### [32] [Pulley coupler engineering for frequency comb generation based on the supermodal approach](https://arxiv.org/abs/2607.07317)
...
### [33] [Time domain Stokes mechanism of pair correlated k gap solitons in nonlinear photonic time crystal slabs](https://arxiv.org/abs/2607.07340)
...
### [34] [Transmissibility, boundary-guided waves, and representative unit cell choice in finite-sized metamaterials](https://arxiv.org/abs/2607.07349)
...
### [35] [Coexistence and manipulation of multiple singularities in a reconfigurable non-Hermitian metasurface](https://arxiv.org/abs/2607.07402)
...
### [36] [Chip-scale nanostructured chaotic billiards for broadband speckle spectrometry](https://arxiv.org/abs/2607.07450)
...
### [37] [Pic2Spec: Generative Modeling Reconstructs Single Cell Raman Fingerprints from Brightfield Images](https://arxiv.org/abs/2607.07651)
...
### [38] [Predicting Multi-Order Magnetic Polariton Resonances for Radiative Properties Tailoring by Distributed Circuit Model](https://arxiv.org/abs/2607.07657)
...
### [39] [Energy transfer and conversion in Strongly Anisotropic Magnetohydrodynamic Turbulence](https://arxiv.org/abs/2607.06572)
...
### [40] [Spatiotemporal Dynamics of Hydrogen Plasma Smelting Reduction of iron ore: A Multi-Species Diagnostic Approach](https://arxiv.org/abs/2607.06840)
*Ram Krushna Mohanta,Kai Lopez,Sai Vishnu Korsipati,Hariswaran Sitaraman,Laxminarayan Raja,Noemi Leick,Seetharaman Sridhar*
...
### [42] [Ultrafast proton radiography of the magnetic fields generated by a laser-driven coil current](https://arxiv.org/abs/2607.06946)
...
### [43] [Magnetic field generation by the Rayleigh-Taylor instability in laser-driven planar plastic targets](https://arxiv.org/abs/2607.06965)
...
### [44] [Terahertz Generation through Photon Deceleration of Long-Wavelength Infrared Laser Pulses in Plasma](https://arxiv.org/abs/2607.07005)
*Srimanta Maity*
...
### [45] [Counter-streaming heat-flux closure for electron-only collisionless magnetic reconnection](https://arxiv.org/abs/2607.07106)
...
### [46] [Observation of Self-Similarity in the Magnetic Fields Generated by the Ablative Nonlinear Rayleigh-Taylor Instability](https://arxiv.org/abs/2607.07356)
