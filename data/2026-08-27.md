...
### [3] [Rapidly Convergent Finite-Element Domain Decomposition Method With Two-Channel Transmission Conditions](https://arxiv.org/abs/2608.25041)
...
### [4] [Energy Yield and Lifetime Climate Classification via Machine Learning for Optimizing Photovoltaic Module Design and Materials](https://arxiv.org/abs/2608.25448)
...
### [5] [A unified gas-kinetic wave-particle method for multiscale gas-mixture flow with an elementary chemical reaction](https://arxiv.org/abs/2608.25650)
...
### [6] [The Hidden Second Law of Thermodynamics behind the Boltzmann-Grad Limit](https://arxiv.org/abs/2608.25056)
*Zhaohua Wu*
...
### [7] [Wing-Rotor Aerodynamic Interactions in Small UAVs During Hover and Cruise](https://arxiv.org/abs/2608.25150)
...
### [8] [First-principles perturbative theory of anomalous scaling in a stochastic shell model of turbulence](https://arxiv.org/abs/2608.25167)
*Alexei A. Mailybaev*
...
### [9] [Physics-Guided Generative Surrogates for Parametric Rarefied Flows with Neural-Field Auto-Decoders: A Pipeline-Level Study of Flow Matching and Diffusion](https://arxiv.org/abs/2608.25454)
...
### [10] [An SPH--mesh Coupling for Vesicle Dynamics in Shear Flow](https://arxiv.org/abs/2608.25522)
...
### [11] [A Scalable OpenLB LAMMPS Framework for Fully Resolved Simulations of Hindered Settling of Arbitrary Non-Spherical Particles](https://arxiv.org/abs/2608.26030)
...
### [12] [Vortex filament dynamics and vortex ring motion revisited](https://arxiv.org/abs/2608.25827)
*Andrew D Gilbert*
...
### [13] [Fock-Space Representation of the Lebowitz--Frisch--Helfand Kinetic Model](https://arxiv.org/abs/2608.25833)
*Ilya Karlin*
...
### [14] [A Compensated Koopman Neural Operator with Selective State-Space Dynamics for Unsteady Flows](https://arxiv.org/abs/2608.25879)
...
### [15] [Neural-Network and Reduced-order Modeling Workflows for AI-Driven CFD: Fast Response Surfaces, Reduced Dynamics and Jet in Cross-flow Examples](https://arxiv.org/abs/2608.26064)
...
### [16] [Single-Mode Control of High-Speed and Low-Threshold III-V/Si Quantum Dot Microring Lasers via Azimuthal Gratings](https://arxiv.org/abs/2608.25064)
...
### [17] [First-Principles Prediction of Nonlinear Optical Response in $\text{TiO}_2$ for High-Power Dielectric Mirror Applications](https://arxiv.org/abs/2608.25129)
...
### [18] [Intrinsic Radial Landau Rainbow in Triaxial Strained Photonic Crystal](https://arxiv.org/abs/2608.25260)
...
### [19] [Nanophotonic control of spatial information in scintillation detectors](https://arxiv.org/abs/2608.25294)
...
### [20] [Analog Time-Frequency Analysis and Frequency Measurement of Ultra-Wideband Microwave Signals via Dual-Comb Channelization](https://arxiv.org/abs/2608.25378)
...
### [21] [The double-indexed geometric phase for electromagnetics](https://arxiv.org/abs/2608.25409)
...
### [22] [Generalizing Thermal Transport in High-Contrast Metamaterials through Interfacial Fresnel Reflection](https://arxiv.org/abs/2608.25499)
...
### [23] [Robust Unidirectional Edge States in the Continuum in non-Topological Floquet Photonic Crystals](https://arxiv.org/abs/2608.25708)
...
### [24] [Room-temperature graphene sub-terahertz detector integrated on a silicon dielectric waveguide](https://arxiv.org/abs/2608.25895)
...
### [25] [From rings to resonance: an inverse method links biophotonic structural color to inverse photonic glasses](https://arxiv.org/abs/2608.25900)
...
### [26] [Nonconcentric Multi-shell Nanowires: Geometry-Induced Plasmon Hybridization and Near-Field Localization](https://arxiv.org/abs/2608.25974)
...
### [27] [Optical extinction and near-field properties of plasmonic dimers: Role of particle shape and separation](https://arxiv.org/abs/2608.26073)
...
### [28] [High-charge collimated and energy-selected laser-driven MeV electron beams produced by magnetic selection](https://arxiv.org/abs/2608.25020)
...
### [29] [Enhancing 10 TeV $γγ$-collider luminosity through scattering-laser wavelength selection in the presence of prolific electron-positron pair production](https://arxiv.org/abs/2608.25137)
...
### [30] [Feasibility demonstration of a high-momentum, high-purity muon beamline at the J-PARC Hadron Experimental Facility](https://arxiv.org/abs/2608.25374)
...
### [31] [A generalized energy-consistent finite difference scheme for 10-moment magnetohydrodynamics](https://arxiv.org/abs/2608.25441)
...
### [32] [Ion-acoustic eigenmodes in a helical magnetic mirror](https://arxiv.org/abs/2608.25526)
*Ivan Chernoshtanov*
...
### [33] [Machine learning methods for modelling local, linear gyrokinetic simulations of MAST-U pedestal turbulence](https://arxiv.org/abs/2608.25945)
...
### [34] [First Plasma Commissioning and Operational Highlights from India's First Spherical Tokamak at IPR](https://arxiv.org/abs/2608.26024)
...
### [35] [Experimental Characterization of Additively Manufactured Metallic Alloys for Electric Propulsion Applications](https://arxiv.org/abs/2608.26048)
