...
### [1] [New Bounds on Exotic Long-Range Spin-Spin Interactions](https://arxiv.org/abs/2607.00200)
...
### [2] [Correct Asymptotic Wavefunctions for Calculating Photoelectron Angular Distributions of O2- and NO-](https://arxiv.org/abs/2607.00336)
...
### [3] [Parts-per-million-accurate determination of the K$α$ photoionization resonance of Be-like oxygen with resolution of its $^{16}$O-$^{18}$O isotopic shift](https://arxiv.org/abs/2607.00996)
...
### [4] [Surface charges in a Rydberg atom-nanowaveguide hybrid quantum system](https://arxiv.org/abs/2607.00513)
...
### [5] [Nuclear-size correction to the one-loop self-energy in hydrogenlike ions](https://arxiv.org/abs/2607.00554)
...
### [6] [Nondipole Contributions to Attosecond Chiral Photoionization Asymmetries](https://arxiv.org/abs/2607.00598)
...
### [7] [Improved Particle Confinement with Resonant Magnetic Perturbations in DIII-D Tokamak H-Mode Plasmas](https://arxiv.org/abs/2607.00287)
...
### [8] [Reexamination of collisional ionization cross sections including double photoionization processes](https://arxiv.org/abs/2607.00875)
...
### [9] [A Scoping Review of Physics Informed Machine Learning for Wave Propagation Modeling in Seismology](https://arxiv.org/abs/2607.00178)
...
### [10] [LSR-Net: Long-Short-Range Operator Learning for Pattern Dynamics on Manifolds](https://arxiv.org/abs/2607.00750)
...
### [11] [Lanczos Method for QRPA Strength Functions in Atomic Nuclei](https://arxiv.org/abs/2607.01114)
...
### [12] [Verification of a sequential thermo-poroelasticity formulation in PFLOTRAN](https://arxiv.org/abs/2607.01156)
...
### [25] [A High-Order Arbitrary Lagrangian-Eulerian Discontinuous Galerkin Method for the Boltzmann Equation in Nearly Incompressible Flows](https://arxiv.org/abs/2607.00199)
...
### [26] [Visualization of Inertial and Kelvin Waves on the Quantum Vortex Lattice in Superfluid Helium](https://arxiv.org/abs/2607.00821)
...
### [27] [Visualizing Lagrangian Heat Transport Paths and Density Structures in Unsteady Heat Transfer](https://arxiv.org/abs/2607.00909)
...
### [28] [Lock-exchange flow regimes under low air Froude number bubble curtains](https://arxiv.org/abs/2607.00960)
...
### [29] [The PICNN-Assisted Physics-Preserving Scheme for Thermodynamically Consistent Two-Phase Flow in Porous Media](https://arxiv.org/abs/2607.01020)
...
### [30] [Numerical Study of Compressibility and Velocity Parameter Effects on Spatially Evolving Supersonic Turbulent Shear Layers](https://arxiv.org/abs/2607.01097)
...
### [31] [Objective kinetic theory for FENE dumbbell suspension](https://arxiv.org/abs/2607.01157)
...
### [32] [No evidence of vorticity production from initially irrotational turbulent gravitational collapse](https://arxiv.org/abs/2607.01207)
