...
### [1] [The influence of volumetric shrinkage on the metal solidification process under localized energy deposition](https://arxiv.org/abs/2606.04200)
...
### [2] [ATLAS-NN: Adaptive Transfer Learnable Symplectic-aware Neural Network for Long-Time Hamiltonian Dynamics](https://arxiv.org/abs/2606.04447)
...
### [3] [Factorizing binary tensors into quantics tensor trains](https://arxiv.org/abs/2606.04506)
...
### [4] [Reconstructing Unobservable Temperature Fields via Simulation-Aided Intelligent Sensing](https://arxiv.org/abs/2606.04582)
...
### [5] [Size and solvent effects on cellulose transverse anisotropy and toughening design](https://arxiv.org/abs/2606.05074)
*Xu Dong*
...
### [6] [GEMINI: Generalized Ensnarlment Measure from Incomplete-linkage of Network-network Interactions](https://arxiv.org/abs/2606.05153)
...
### [7] [Radiation-induced electron spin polarization in ultrarelativistic kinetic turbulence](https://arxiv.org/abs/2606.04332)
...
### [8] [High-beta runaway transitions in a fluid model of electromagnetic ion-temperature-gradient turbulence](https://arxiv.org/abs/2606.04616)
...
### [9] [A Reduced-Order Particle-in-Cell Method with Azimuthal Fourier-Decomposed Fields for Nominally Axisymmetric Plasmas](https://arxiv.org/abs/2606.04887)
*Shaun Andrews*
...
### [10] [Influence of Aspect ratio in the Convection in Rotating Annulus In the Presence of Localized Heating](https://arxiv.org/abs/2606.04151)
...
### [11] [Shear-driven dynamics of surfactant-laden droplets on rough substrates](https://arxiv.org/abs/2606.04422)
...
### [12] [Drag and Yielding of Rotating Bodies in Yield-Stress Fluids](https://arxiv.org/abs/2606.04861)
...
### [13] [Energetics, shearing and pumping efficiency of propagating contractions over villi-patterned wall](https://arxiv.org/abs/2606.04831)
...
### [14] [Photon shot-noise-limited Rydberg-EIT electrometry](https://arxiv.org/abs/2606.04354)
...
### [15] [Atom Interferometry with Transverse Optical Modes](https://arxiv.org/abs/2606.04430)
...
### [16] [Ionization energies for Rydberg $^4 \mathrm{He}$ ($1snp\,^{1,3}P$) states using the correlated B-spline basis function method](https://arxiv.org/abs/2606.04768)
...
Abstract: We extend the correlated B-spline basis function (C-BSBF) method to high-precision calculations of the ionization energies of helium Rydberg $n^{1,3}P$ states ($n=24$--$35$). Using a unified basis set, we evaluate nonrelativistic energies, relativistic corrections of order $mα^4$ (including finite-mass recoil), QED contributions of order $mα^5$, and partial $mα^6$ terms (singlet-triplet mixing, one- and two-loop radiative corrections). The remaining higher-order contributions are estimated via $1/n^3$ scaling. The resulting ionization energies achieve kHz-level accuracy and are in excellent agreement with independent Hylleraas calculations, thereby providing a cross-validation between two distinct theoretical approaches. Combining these Rydberg ionization energies with high-precision experimental $2S \rightarrow nP$ transition frequencies yields the ionization energies for the metastable $2^{1}S$ and $2^{3}S$ states as \num{960332040.533(10)}$_\mathrm{stat}(20)_ \mathrm{sys}$~MHz and \num{1152842742.7274(53)}$_\mathrm{stat}(25)_ \mathrm{sys}$~MHz, respectively. The C-BSBF results differ from the experimental ionization energies obtained from Rydberg-series extrapolations by 0.032(47) MHz for the $2 \, ^1 S$ state and by 0.019(10) MHz for the $2 \, ^3 S$ state, indicating that both differences would benefit from further scrutiny through improved experimental precision.
...
### [17] [Geometric scaling limits of phase-only control in multimode coherent systems](https://arxiv.org/abs/2606.04288)
...
### [18] [Highly efficient difference-frequency generation for mid-infrared pulses by passively synchronous seeding](https://arxiv.org/abs/2606.04330)
...
### [19] [Near-Perfect Chirality and Giant Spin-Orbit Conversion in a Single Plasmonic Cavity](https://arxiv.org/abs/2606.04393)
...
### [20] [Magnetic field free nonreciprocity in tapered atomic cladded nano waveguide](https://arxiv.org/abs/2606.04589)
...
### [21] [Confocal Subsurface Backscattering Microscopy for Optical Identification of Nanoscale Threading Dislocations in SiC Substrates](https://arxiv.org/abs/2606.04607)
...
### [22] [Higher-order exceptional points in a multimode continuum optoacoustic system](https://arxiv.org/abs/2606.04671)
...
### [23] [Spatial Deformation Mechnisim of Meta-Atom Coupling and Scaling](https://arxiv.org/abs/2606.04796)
...
### [24] [Wave-optical formulation of the image-rotation property in Dove prisms: A Fourier-optics approach](https://arxiv.org/abs/2606.05027)
