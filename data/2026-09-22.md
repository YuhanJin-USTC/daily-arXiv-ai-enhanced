...
### [5] [Proton Heating Rates in the Inner Heliosphere: Helios Observations](https://arxiv.org/abs/2609.22552)
...
### [6] [Interactions Between Two Magnetized Plasma Pressure Filaments: Drift-Alfvén Modes and Transport](https://arxiv.org/abs/2609.22627)
...
### [7] [Interaction renormalization and the plasma staircase](https://arxiv.org/abs/2609.22915)
...
### [8] [Real-Time Plasma State Prediction via FPGA-Accelerated Quantized Recurrent Probabilistic Neural Networks](https://arxiv.org/abs/2609.23141)
...
### [9] [Scalar Dissipation Criticality in Compressible Magnetized Turbulence](https://arxiv.org/abs/2609.23177)
...
### [10] [VEQDB: A Compact and Reconstructible Multi-Device Tokamak Equilibrium Database](https://arxiv.org/abs/2609.23296)
...
### [11] [Machine Learning Accelerated Plasma Simulation through Physics Guided Time Jumps](https://arxiv.org/abs/2609.23358)
...
### [12] [Plasma localization of charged debris](https://arxiv.org/abs/2609.23437)
...
### [13] [On the statistical theory of strong electrolytes and high-temperature plasmas: New applications of the work by Yukhnovskii and Kelbg II](https://arxiv.org/abs/2609.23621)
*W. Ebeling,M. Holovko*
...
### [14] [Effects of particle-induced electron emission on transport properties in electrically-biased plasma sheaths under fusion-relevant conditions](https://arxiv.org/abs/2609.23689)
...
### [15] [Chaos-induced transport due to electrostatic-fluctuations in a toroidal plasma](https://arxiv.org/abs/2609.23791)
...
### [16] [Physics-Informed Kolmogorov-Arnold Networks for Grad-Shafranov Tokamak Equilibria](https://arxiv.org/abs/2609.23846)
...
### [17] [Geodesic Acoustic Modes in pair plasmas confined in tokamak magnetic fields](https://arxiv.org/abs/2609.24256)
...
### [18] [Horizon-Aware Early Event Prediction for Tokamak Disruption Alarms](https://arxiv.org/abs/2609.24443)
...
### [19] [Stochastic consensus dynamics for decentralized decision systems](https://arxiv.org/abs/2609.22454)
...
### [20] [TubeLab: Interactive inverse design of wind instrument bores with hard spectral constraints](https://arxiv.org/abs/2609.22468)
...
### [21] [Exact ballistic energy transport and emergent XXZ dynamics in an integrable three-state chain](https://arxiv.org/abs/2609.22817)
...
### [22] [Diff-NekRS: A Scalable Differentiable Framework for Multi-Timestep Solver-in-the-Loop Training](https://arxiv.org/abs/2609.23208)
...
### [23] [MadVfold: accelerating NLO event generation and reducing negative weights with SIMD vectorization and GPUs](https://arxiv.org/abs/2609.23500)
*Andrea Valassi*
...
### [24] [A subcell-refined entropy-residual-driven limiting strategy for high-order discontinuous Galerkin methods](https://arxiv.org/abs/2609.24268)
...
### [25] [VNS Tokamak for Medical Isotope Production](https://arxiv.org/abs/2609.24371)
...
### [26] [Persistent homology of Hamiltonian orbits with applications to beam physics: Euler-Betti classification and topological chaos indicators](https://arxiv.org/abs/2609.22412)
...
### [27] [Experimental Verification of Circumferential Bunch Length Variation and Head-Tail Exchange Affecting Microwave Instability in a Storage Ring](https://arxiv.org/abs/2609.22721)
...
### [28] [Design and Operation of a 3-Crystal Multi-Volume Reflection Array for Loss Reduction in CERN SPS Slow Extraction](https://arxiv.org/abs/2609.23823)
...
### [29] [Bayesian Optimization of The Relativistic Heavy Ion Collider Luminosity via $s^*$ Control](https://arxiv.org/abs/2609.24978)
...
### [30] [Iterative Construction of n-Dimensional Navier-Stokes Solutions with Non-Gradient Convection](https://arxiv.org/abs/2609.22372)
...
### [31] [Stabilization of Yih's Viscosity Jump Interface in a Channel](https://arxiv.org/abs/2609.22384)
*Miroslav Krstic*
...
### [32] [An experimental and numerical study of the circular hydraulic jump](https://arxiv.org/abs/2609.22403)
...
### [33] [Applications of a moving surface drag model: From Stokes waves to offshore wind farms](https://arxiv.org/abs/2609.22448)
...
### [34] [Modelling friction and heat transfer in turbulent forced convection over porous lattices](https://arxiv.org/abs/2609.22621)
...
### [35] [Underwater bubble transport on superhydrophobic cylindrical rod](https://arxiv.org/abs/2609.22722)
...
### [36] [Exact explicit wave-angle solutions for equilibrium oblique detonations](https://arxiv.org/abs/2609.23068)
...
### [37] [Equivariant Neural Prediction of the Stokes Resistance Tensors for Arbitrary Microparticle Shapes](https://arxiv.org/abs/2609.23105)
...
### [38] [Channel confinement mollifies roll wave instabilities](https://arxiv.org/abs/2609.23108)
...
### [39] [Wall-modelled large-eddy simulation of turbulent channel flow with unstable stratification](https://arxiv.org/abs/2609.23311)
...
### [42] [Multiscale Kinetic Methods for Nonequilibrium Flow and Transport](https://arxiv.org/abs/2609.24183)
*Zhaoli Guo,Kun Xu*
...
### [44] [A high-order ghost-point immersed boundary method coupled with auxiliary differential equations for time-domain impedance walls](https://arxiv.org/abs/2609.24785)
*Abdoulaye Ouattara*
...
### [45] [Design of a combined polarimetric and velocimetric measurement for viscoelastic stress, and its constitutive resolving power](https://arxiv.org/abs/2609.23787)
...
### [46] [Discrete topology sensing in turbulence via signed pairwise graphlets of the velocity gradient tensor](https://arxiv.org/abs/2609.23799)
*Radouan Boukharfane*
...
### [47] [Physics-Informed Latent Neural Operator for Three-Dimensional Compressor Cascade Flow Prediction](https://arxiv.org/abs/2609.23844)
...
### [48] [Fluid Flow as Transport of Probability: Entropy, Compressibility, and Irreversibility](https://arxiv.org/abs/2609.23850)
*Ankit Bhattacharjee*
...
### [49] [The Positive Defect Problem: Target and Admissibility Criteria for a Programmatic Search for Unforced Navier-Stokes Blowup](https://arxiv.org/abs/2609.23868)
...
### [50] [Mechanism-Separated Closed-Form Transition Modeling via Field Inversion and Symbolic Regression](https://arxiv.org/abs/2609.24162)
...
### [57] [Resolved multiple-droplet evaporation](https://arxiv.org/abs/2609.24866)
*Alexander W Wray*
...
### [58] [All-optical spin-selective control and shaping of frequency conversion pathways](https://arxiv.org/abs/2609.22530)
...
### [59] [Ultrafast light-sheet optical tweezers for in situ parallelized biomechanical characterization of cells and soft tissues](https://arxiv.org/abs/2609.22540)
...
### [60] [Cascaded Brillouin-Kerr microcombs in surface nanoscale axial photonic resonators](https://arxiv.org/abs/2609.22629)
...
### [61] [Rubidium referenced Kerr comb with cavity phase matching](https://arxiv.org/abs/2609.22692)
...
### [62] [Non-Polynomial Wave Computation through Recurrent Resonant Scattering](https://arxiv.org/abs/2609.22745)
...
### [63] [High-Q Magneto-Optical Microdisk Resonators Based on Monocrystalline Bismuth-substituted Yttrium Iron Garnets](https://arxiv.org/abs/2609.22841)
...
### [64] [$f$-2$f$ self-referencing for silicon nitride photonics via a heterogeneously integrated lithium niobate layer](https://arxiv.org/abs/2609.23328)
...
### [65] [Cryogenic thermo-optic response of low-loss phase change material for non-volatile photonic phase shifter](https://arxiv.org/abs/2609.23599)
...
### [66] [Laser-Driven Electron Emission Carrying Orbital Angular Momentum from Carbon Nanotubes](https://arxiv.org/abs/2609.23654)
...
### [67] [Extended three dimensional optical tweezers with a Single Gaussian Beam in a stratified medium](https://arxiv.org/abs/2609.23757)
...
### [68] [Nonlinear susceptibility for stimulated light scattering in plasmas](https://arxiv.org/abs/2609.23912)
*Aleksei Zheltikov*
...
### [69] [Square-Root Higher-Order Exceptional Points with Symmetry-Induced Multiple Spectral Responses](https://arxiv.org/abs/2609.24017)
...
### [70] [Sustained Orbital Motion Driven by Circularly Polarized Light in Nanoscale Stator-Rotor Architectures](https://arxiv.org/abs/2609.24029)
...
### [71] [Synthetic-Aperture Super-Resolution Imaging via Spatial-Frequency Shift in Near-Field Diffraction](https://arxiv.org/abs/2609.24039)
...
### [72] [Adaptive Solitons](https://arxiv.org/abs/2609.24050)
...
### [73] [Hypervectors from Optical Disorder: Programmable Encoding and Optical Inference for Hyperdimensional Computing](https://arxiv.org/abs/2609.24108)
...
### [74] [Dual-layer large-numerical-aperture metalenses with rotational zoom capability](https://arxiv.org/abs/2609.24171)
...
### [75] [Non-Hermitian photonic time quasicrystal](https://arxiv.org/abs/2609.24327)
...
### [76] [Ultralow-power, high-speed programmable Si photonic circuits with InGaAsP membrane](https://arxiv.org/abs/2609.24611)
...
### [77] [Replica Symmetry Breaking in the Quasi Mode Locked Regime of Titanium Sapphire Lasers](https://arxiv.org/abs/2609.24643)
...
### [78] [Real-Time Doppler-Frequency Measurement and Frequency-Pulling Suppression in Arm-locking](https://arxiv.org/abs/2609.24686)
...
### [79] [Observation of Replica Symmetry Breaking in Filamentation and Multifilamentation](https://arxiv.org/abs/2609.24712)
...
### [80] [Phase fields in momentum space of photonic crystal slabs](https://arxiv.org/abs/2609.24728)
...
### [81] [Broadband Single-Particle Absorption Circular Dichroism Reveals Chiroptical Heterogeneity in Gold Helicoids](https://arxiv.org/abs/2609.24772)
...
### [82] [Non-Hermitian mode locking in an L-band monolithic InP dual-ring laser](https://arxiv.org/abs/2609.24798)
...
### [83] [Collective cavity quantum electrodynamics in solid-state optical clocks](https://arxiv.org/abs/2609.24800)
...
### [84] [Fisher-information training of optical sensing front ends from natural fluctuations](https://arxiv.org/abs/2609.24915)
