...
### [3] [Quantum echo-enabled high harmonic generation using ultrafast electrons](https://arxiv.org/abs/2604.23569)
...
### [7] [Quantitative Pulse Shape-Instability Analysis Using 2D-Runs FROG](https://arxiv.org/abs/2604.24359)
...
### [8] [Pulsed Vertical Electric Dipole Over a Lossy Halfspace: On the Time-Domain Zenneck Wave](https://arxiv.org/abs/2604.23254)
*Giampiero Lovat*
...
### [9] [Role of ultrafast electron-optical-phonon interactions in high harmonic generation from graphene](https://arxiv.org/abs/2604.23294)
...
### [10] [All-Optical High-Resolution Real-Time Temperature Estimation Method Based on Fiber-Optic Interferometry](https://arxiv.org/abs/2604.23363)
...
### [24] [Noise in analog programmable-photonic computation](https://arxiv.org/abs/2604.24541)
...
### [25] [Efficient terahertz optical filtering with large-area all-metal and polymer-metal woven wire meshes](https://arxiv.org/abs/2604.24581)
...
### [26] [Overview of X-ray Thomson scattering measurements of extreme states of matter](https://arxiv.org/abs/2604.23687)
...
### [27] [Efficient Generation of Neutrons Based on Ultrashort Laser-driven Direct Acceleration in Microwire-Array Targets](https://arxiv.org/abs/2604.23913)
...
### [28] [Controlling and Measuring the Degree of Coherence at CLS using X-ray Interferometry](https://arxiv.org/abs/2604.22950)
...
### [29] [FACET2-S2E: Start-to-end simulations of the FACET-II beamline](https://arxiv.org/abs/2604.23479)
...
### [30] [High Harmonic Radiation from a Low-K Biharmonic Planar Undulator](https://arxiv.org/abs/2604.23919)
...
### [32] [Updated Design for LEP3](https://arxiv.org/abs/2604.24427)
...
### [33] [On mathematical characterization of a Bessel functions-based passive element in electronic circuits](https://arxiv.org/abs/2604.22798)
...
### [34] [Learning subgrid interfacial area in two-phase flows with regime-dependent inductive biases](https://arxiv.org/abs/2604.23946)
...
### [35] [An axion framework for Particle-in-Cell codes with Monte-Carlo sampling: emission, absorption, and detailed balance in plasmas](https://arxiv.org/abs/2604.24627)
...
### [36] [Microstructure engineering of Ti-6Al-4V in laser powder bed fusion via 1D thermal modeling and supporting experiments](https://arxiv.org/abs/2604.24669)
...
### [37] [On Fin Based Propulsion and Maneuvering for Uncrewed Underwater Vehicles](https://arxiv.org/abs/2604.22962)
*Parker Thomas Grobe*
...
### [38] [Renormalized flow theory of wave turbulence: Kolmogorov-Zakharov spectra as emergent asymptotic states](https://arxiv.org/abs/2604.22963)
...
### [39] [Impact of the formation angle on the drag of bio-inspired $\pmb \vee$-formations](https://arxiv.org/abs/2604.23052)
...
### [40] [Quantitative Evaluation of Forward and Backward Scattering in Isotropic Turbulence via Hänggi--Klimontovich and Itô Stochastic Processes](https://arxiv.org/abs/2604.23092)
*Nicola de Divitiis*
...
### [41] [Lift and leading-edge suction parameter of separated flows over an NACA0012 at high angles of attack](https://arxiv.org/abs/2604.23120)
...
### [42] [Revisit viscous shock tube at low Reynolds number](https://arxiv.org/abs/2604.23319)
*Yue Zhang,Kun Xu*
...
### [43] [How modeling assumptions shape predictions of convective mixing of carbon dioxide](https://arxiv.org/abs/2604.23199)
...
### [44] [An LES model with finite-rate phase change and subgrid spray based on a thermodynamically consistent four-equation multiphase model](https://arxiv.org/abs/2604.23846)
...
### [45] [Minimal seeds in the Stokes boundary layer](https://arxiv.org/abs/2604.23213)
*Tom Eaves*
...
### [46] [Deep Learning of Solver-Aware Turbulence Closures from Nudged LES Dynamics](https://arxiv.org/abs/2604.23874)
...
### [47] [Bayesian neural network correction of RANS turbulence models with uncertainty quantification in separated flows](https://arxiv.org/abs/2604.23300)
...
### [48] [Flapping Wings Amplify Pitch Stability: Insights from a Robotic Bird](https://arxiv.org/abs/2604.23359)
...
### [49] [Stable fluid-rigid body interaction algorithm using the direct-forcing immersed boundary method (DF-IBM)](https://arxiv.org/abs/2604.24439)
...
### [50] [Physics-Informed Temporal U-Net for High-Fidelity Fluid Interpolation](https://arxiv.org/abs/2604.23372)
...
### [51] [Capillary effects on preferential orientation of floaters in gravity waves](https://arxiv.org/abs/2604.23630)
...
### [52] [Reduced-order modelling of parametrized unsteady Navier-Stokes equations and application to flow around cylinders with periodic changing boundary conditions](https://arxiv.org/abs/2604.23710)
...
### [53] [Compressible fluids with distinct mass and linear-momentum transport](https://arxiv.org/abs/2604.23722)
...
### [54] [Relation between the Nusselt and Bejan numbers in natural convection](https://arxiv.org/abs/2604.23736)
...
### [55] [Linear feedback control of liquid film on moving substrate via free-surface stresses](https://arxiv.org/abs/2604.23746)
...
### [56] [On the stability of large-amplitude gravity-capillary surface waves](https://arxiv.org/abs/2604.23762)
...
### [57] [Dissipative Vortex Binaries in Compact Fluid Domains with Geometric Corrections](https://arxiv.org/abs/2604.23857)
...
### [58] [Improved global stability bounds for two-dimensional plane Poiseuille flow](https://arxiv.org/abs/2604.23915)
...
### [59] [Multi-scale Dynamic Wake Modeling of Floating Offshore Wind Turbines via Fourier Neural Operators and Physics-Informed Neural Networks](https://arxiv.org/abs/2604.23937)
...
### [60] [Intermittency-Driven Turbulence Cascade Memory Extends the Markov-Einstein Coherence Length Beyond the Canonical Estimate](https://arxiv.org/abs/2604.23962)
*Y. Sungtaek Ju*
...
### [61] [Beyond Stokes drift -- Lagrangian transport in evolving gravity waves](https://arxiv.org/abs/2604.24069)
...
### [62] [Numerical Investigation of Elastically-Mounted tandem Cylinders using an ALE Runge-Kutta Discontinuous Galerkin method](https://arxiv.org/abs/2604.24342)
...
### [63] [Exact dispersion relation for linear surface waves on arbitrary vertical shear](https://arxiv.org/abs/2604.24484)
...
### [64] [Mass-Transfer Control With Microbubbles in Highly Turbulent Decaying Flows](https://arxiv.org/abs/2604.24520)
...
### [65] [Enhanced Atom Capture via Multi-Frequency Magneto-Optical Trapping](https://arxiv.org/abs/2604.23221)
...
### [66] [On bound state spectra of the one-electron diatomic ions](https://arxiv.org/abs/2604.23411)
*Alexei M. Frolov*
...
### [67] [Disentangling the Effect of Ionic Coupling and Multiple Interfering Terms in Attosecond Molecular Interferometry](https://arxiv.org/abs/2604.23441)
...
### [68] [Wichmann-Kroll vacuum polarization correction to lithium-like systems in a Gaussian basis set](https://arxiv.org/abs/2604.23660)
...
### [69] [Collective Strong Coupling of Thermal Atoms to Integrated Microring Resonators](https://arxiv.org/abs/2604.24509)
