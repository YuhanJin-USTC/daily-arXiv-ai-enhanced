...
### [1] [Exact solution of the Gaunt-modified Landau-Lifshitz equation in a plane wave](https://arxiv.org/abs/2606.05205)
...
### [2] [Behavior of kinetic instabilities in a dynamically forming resonant distribution](https://arxiv.org/abs/2606.05341)
...
### [3] [Implementation and Verification of Toroidal Resistive Wall Boundary Conditions in the PIXIE3D MHD code using a Boundary Integral Method](https://arxiv.org/abs/2606.05446)
...
### [4] [Coupled simulation of plasma-surface interactions during early stages of vacuum arcing](https://arxiv.org/abs/2606.05893)
...
### [5] [Optimization of EUV output by experimentally validated radiation-hydrodynamic simulations across a broad laser parameter space](https://arxiv.org/abs/2606.05948)
...
### [6] [Plasma wakefield dynamics of self-generated electron bunch trains](https://arxiv.org/abs/2606.06232)
...
### [9] [Time-frequency analysis of nonlinear Compton scattering via joint probability distributions](https://arxiv.org/abs/2606.05203)
...
### [10] [Laser fractional frequency instability at $\mathbf{4\times 10^{-17}}$ with a room temperature optical reference cavity](https://arxiv.org/abs/2606.05987)
...
### [11] [Spatial resolution of X-ray beam-tracking microscopy](https://arxiv.org/abs/2606.05269)
...
### [12] [Push-Pull acousto-optic modulator based on non-suspended thin-film lithium niobate on silicon substrate](https://arxiv.org/abs/2606.05337)
...
### [13] [Passively synchronized dual-color mode-locked fiber lasers based on nonlinear amplifying loop mirrors](https://arxiv.org/abs/2606.05595)
...
### [14] [Observation of spectral mode splitting in a pump-enhanced ring cavity for mid-infrared generation](https://arxiv.org/abs/2606.05598)
...
### [15] [Controlled generation of ultrafast vector vortex beams from a mode-locked fiber laser](https://arxiv.org/abs/2606.05612)
...
### [16] [Broadband Chromatic Dispersion of Thermo-refractive Coefficients and its Impact in Silicon Nitride Nonlinear Photonics](https://arxiv.org/abs/2606.05673)
...
### [17] [Aberration-Free Optical Spectrometer](https://arxiv.org/abs/2606.05686)
...
### [18] [Optical chirality of membrane metasurfaces with broken in-plane symmetry](https://arxiv.org/abs/2606.05775)
...
### [19] [Design of an efficient Tunable Dual narrow-band MEMS Mid and Far IR emitter with Me-NTA for Industrial and Biomedical applications](https://arxiv.org/abs/2606.05838)
...
### [20] [Inverse Design of Realizable Metasurface based Absorbers using Improved Conditioning and Diversity Enhanced Progressively Growing GANs](https://arxiv.org/abs/2606.05849)
...
### [21] [Single-Frequency Symmetry-Empowered Through-Barrier Sensing in Reconfigurable Complex Media](https://arxiv.org/abs/2606.05877)
...
### [22] [Tunable Mid-Infrared Chiral Selective Absorber Based on Asymmetric V-Shaped Metasurfaces Driven by Chiral quasi-Bound State in the Continum](https://arxiv.org/abs/2606.06084)
...
### [34] [Wall Shear Stress Reconstruction from Concentration: Differentiable Physics and Physics-Informed Neural Networks](https://arxiv.org/abs/2606.06313)
...
### [35] [Deep reinforcement learning with spatial and temporal awareness for active boundary control of buoyancy-driven convection](https://arxiv.org/abs/2606.06191)
...
### [36] [Flapping instability of elastic disks in Stokes flows](https://arxiv.org/abs/2606.06215)
...
### [37] [Drag reduction or reward hacking? Recurrent multi-agent reinforcement learning that earns its reward](https://arxiv.org/abs/2606.06227)
*Giorgio Maria Cavallazzi,Miguel Pérez-Cuadrado,Alfredo Pinelli*
