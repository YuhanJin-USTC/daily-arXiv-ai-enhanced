...
### [1] [Quantitative Fabrication-Error Reduction in Optomechanical Crystal using Proximity Error Correction](https://arxiv.org/abs/2609.10741)
...
### [2] [New Method for Path-length Equalization of Long Single-mode Fibers for Interferometry](https://arxiv.org/abs/2609.10771)
...
### [3] [Quantum eraser enables single-shot quantum holography with undetected photons](https://arxiv.org/abs/2609.10907)
...
### [4] [Two-step high-accuracy microwave frequency measurement and time-frequency analysis based on optical frequency combs](https://arxiv.org/abs/2609.11204)
...
### [6] [Antimony for broadband nanophotonics across the ultraviolet, visible and infrared](https://arxiv.org/abs/2609.11501)
...
### [7] [Temporal Localisation of Waves from Imaginary Line-Gap Topology](https://arxiv.org/abs/2609.11577)
...
### [8] [Heterogeneously Integrated Efficient and Widely Tunable Lasers at 795 nm for Rubidium-Based Quantum Technologies](https://arxiv.org/abs/2609.11585)
...
### [9] [Designing metallo-dielectric antennas for cryogenic applications](https://arxiv.org/abs/2609.11809)
...
### [10] [An exposition on some viscosity dependent issues in refined potential flow theory](https://arxiv.org/abs/2609.10649)
...
### [11] [A Robust All-Mach Six-Equation Diffuse-Interface Method for Multiphase Flows with Surface Tension](https://arxiv.org/abs/2609.10727)
...
### [12] [Mixing dynamics and transport mechanisms during laminar stirring flows](https://arxiv.org/abs/2609.10773)
...
### [13] [Long interfacial internal waves with currents: current profiles with quadratic depth-dependence](https://arxiv.org/abs/2609.10820)
...
### [14] [Giesekus Stick-Slip Singularity: Asymptotic Theory in the Log-Conformation Formulation](https://arxiv.org/abs/2609.10836)
...
### [15] [Correlative effects of induced magnetic field-buoyancy on reactive solute dispersion dynamics in couple-stress fluids](https://arxiv.org/abs/2609.11099)
...
### [16] [A Novel Multi-fidelity Surrogate for Turbomachinery Design Optimization](https://arxiv.org/abs/2609.11111)
...
### [17] [A Novel Multi-fidelity Surrogate for Efficient Turbine Design Optimization](https://arxiv.org/abs/2609.11112)
*Qineng Wang,Liming Song,Zhendong Guo,Jun Li,Zhenping Feng*
...
### [18] [DiffSWE2d: a differentiable Shallow Water Equations solver for end-to-end flood and tsunami modelling](https://arxiv.org/abs/2609.11426)
*Zhonghou Xu*
...
### [19] [Low inertia limit of elasto-inertial turbulence](https://arxiv.org/abs/2609.11581)
...
### [20] [Surface gravity wave-mean flow interaction with comparable spatial scales. Part I: reduced wave equations](https://arxiv.org/abs/2609.11587)
...
### [21] [Surface gravity wave-mean flow interaction with comparable spatial scales. Part II: two-way coupling and wave-wave interactions](https://arxiv.org/abs/2609.11631)
*Basile Gallet*
...
### [22] [A Conservative Hybrid Eulerian-Lagrangian Method with Persistent Structure Tracking for Multiscale Cavitation](https://arxiv.org/abs/2609.11776)
...
### [23] [Turn-by-turn Tune Analysis Using Adaptive BPM Ensembles in the Fermilab Mu2e Delivery Ring*](https://arxiv.org/abs/2609.10848)
*D. Steinkamp*
...
### [24] [Coupling periodic-cell and finite-bunch dynamics for structured photocathodes](https://arxiv.org/abs/2609.11844)
...
### [25] [Physics-Informed Drift Diagnosis for Laser-Plasma Accelerator Operations](https://arxiv.org/abs/2609.11874)
...
### [26] [Particle-resolved pathways to energetic-ion formation in a fluctuating low-current hollow-cathode plume](https://arxiv.org/abs/2609.10958)
...
### [27] [Modeling of plasma transport during edge-localized mode in tokamak using a kinetic Vlasov-Poisson code](https://arxiv.org/abs/2609.11389)
...
### [28] [kobra: a new Vlasov code intended for plasma-wall modeling](https://arxiv.org/abs/2609.11563)
...
### [29] [Physics-Informed Neural Networks to Infer the Perpendicular Energy Conductivity in the Scrape-Off Layer of Stellarator Devices](https://arxiv.org/abs/2609.11628)
...
### [30] [Experimental Plasma Density Profiles Determined Through Measurements of the Magnetosonic Wave Speed](https://arxiv.org/abs/2609.11743)
...
### [31] [A new generation of effective core potentials: Selected heavy 5d and 6p elements](https://arxiv.org/abs/2609.10853)
...
### [32] [A Geometrically Parameterized Quasi-Stationary 3D Model for High-Frequency Induction Tube Welding](https://arxiv.org/abs/2609.11250)
...
### [33] [Stress-Testing Dynamical and Generative Downscaling Using Subseasonal Extreme Precipitation Forecasts](https://arxiv.org/abs/2609.11696)
