...
### [1] [A Protocol for Shielding-Enhanced Loading of Single Polar Molecules into Optical Tweezers](https://arxiv.org/abs/2608.20332)
...
### [2] [Broadband hard X-ray attosecond pulses from extremely chirped electron beams](https://arxiv.org/abs/2604.09969)
...
### [3] [Mutually phase-stable tunable attosecond soft X-ray attosecond pulses from a free-electron laser](https://arxiv.org/abs/2608.20022)
...
### [4] [Black-Box Coherence Matrix Eigen-Spectroscopy with Programmable Photonics](https://arxiv.org/abs/2608.19353)
...
### [5] [Measurement and Optimal Targeting of a Hidden Scatterer in a Complex Environment Utilizing Fisher Information](https://arxiv.org/abs/2608.19442)
...
### [6] [In-situ Time-domain Physical Adjoint Optimization of Complex Wave Dynamics](https://arxiv.org/abs/2608.19456)
...
### [7] [Which pulse maximizes resonant nonlinear conversion?](https://arxiv.org/abs/2608.19464)
*Alex Krasnok*
...
### [8] [Geometry-Encoded Multireceiver Fluorometry Enables Full-Range Nonlinear Quantification under the Inner Filter Effect](https://arxiv.org/abs/2608.19477)
...
### [9] [Symmetry-guided modal control in elliptical femtosecond-laser-written photonic waveguides](https://arxiv.org/abs/2608.20124)
...
### [10] [Fisher-information limits of detector-bandwidth-efficient 3D light-field microscopy](https://arxiv.org/abs/2608.19498)
*Liang Gao*
...
### [11] [Cavity-Enhanced Activation of Radiatively Suppressed Light-Hole Exciton Emission in Colloidal Nanoplatelets](https://arxiv.org/abs/2608.19681)
...
### [12] [Wavefront shaping of terahertz radiation using two-color flying-focus pulses with time-dependent focal velocities](https://arxiv.org/abs/2608.20142)
...
### [17] [Geometric Control of Cat States in High Harmonic Generation](https://arxiv.org/abs/2608.20119)
...
### [18] [Intensity-based scattering correction enables in vivo two-photon imaging beyond 1 mm](https://arxiv.org/abs/2608.20224)
...
### [19] [Point Spread Function Engineering Using Implicit Neural Representations](https://arxiv.org/abs/2608.20277)
...
### [20] [Computational Methods of Wave Propagation for Semiclassical Models of High Harmonic Generation in Bulk Solids](https://arxiv.org/abs/2608.20306)
...
### [22] [Diagonalization of the Landau Hamiltonian with a Periodic Potential via a Galerkin Projection Method and Applications to Topological Band Properties](https://arxiv.org/abs/2608.19940)
...
### [23] [Resonant state expansion for acoustic resonators. Part I. Eigenvalue problem](https://arxiv.org/abs/2608.19979)
...
### [24] [Resonant state expansion for acoustic resonators. Part II. Scattering problem](https://arxiv.org/abs/2608.19992)
*Egor Domoratskii,Vladimir Igoshin,Nikolay Solodovchenko,Mingzhao Song,Yong Li,Mihail Petrov,Andrey Bogdanov*
...
### [25] [Real-time feedback control of ELM frequency using divertor gas puffing and its effects on tungsten-induced radiation and plasma performance in KSTAR](https://arxiv.org/abs/2608.19259)
...
### [26] [Informing spectral models for dense plasmas with K-edge absorption measurements of warm dense copper](https://arxiv.org/abs/2608.19382)
...
### [27] [Determining neutral fueling response to RMPs in MAST using a multi-reservoir particle balance model and EMC3 EIRENE](https://arxiv.org/abs/2608.19446)
...
### [28] [Characterizing the temporal evolution of Biermann-battery-driven magnetic reconnection in laser-ablated plasmas](https://arxiv.org/abs/2608.19591)
...
### [29] [Collisionless Resonances Set the Size of a Weyl Exceptional Ring](https://arxiv.org/abs/2608.19624)
...
### [30] [Revisiting the Growth Rate of the Relativistic Tearing Instability: The Role of the Non-ideal MHD Structure](https://arxiv.org/abs/2608.19645)
...
### [31] [Simulation of trapped non-neutral plasma dynamics with rotating wall compression](https://arxiv.org/abs/2608.19841)
...
### [32] [Effect of ion temperature on lunar photoelectron sheath](https://arxiv.org/abs/2608.19926)
...
### [33] [Symmetry-agnostic stellarators for collisionless confinement](https://arxiv.org/abs/2608.20042)
...
### [34] [Excitation of the lower-hybrid drift instability in the outflow of electron-only magnetic reconnection](https://arxiv.org/abs/2608.20299)
...
### [35] [The near-wall cycle for skin-friction generation revealed through explainable deep learning](https://arxiv.org/abs/2608.19213)
...
### [36] [Generalised Perturbed Convective Wave Theory](https://arxiv.org/abs/2608.19236)
...
### [37] [Weakly nonlinear internal waves by tidal flow over a ridge in a shear current](https://arxiv.org/abs/2608.19237)
*Xun Huang*
...
### [38] [Modeling the compressible flow field of an impulsively started circular cylinder with refined potential flow theory](https://arxiv.org/abs/2608.19246)
...
### [39] [A Sharp and Conservative VOF Method for Multicomponent Liquid--Gas Mass Transfer: Bubble Dissolution and Droplet Evaporation](https://arxiv.org/abs/2608.19254)
...
### [40] [Effect of Microscale Turbulent Structures Dynamics on Forced Convection in Turbulent Porous Media Flow](https://arxiv.org/abs/2608.19342)
...
### [41] [Stability and nonlinear dynamics of three-layer viscous films inside a vertical cylindrical tube](https://arxiv.org/abs/2608.19417)
