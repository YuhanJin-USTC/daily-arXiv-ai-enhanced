...
### [1] [Probing topological edge states in a molecular synthetic dimension](https://arxiv.org/abs/2604.00745)
...
### [2] [Stern-Gerlach interferometry in three dimensions: the role of transverse fields](https://arxiv.org/abs/2604.00807)
...
### [3] [Extending the fundamental limit of atomic clock stability](https://arxiv.org/abs/2604.01099)
...
### [19] [An explicit multiscale pseudo orbit-averaging time integration algorithm](https://arxiv.org/abs/2604.00121)
...
### [20] [Generalized multi-dimensional conservation laws for stimulated Raman and Brillouin scattering in a density gradient](https://arxiv.org/abs/2604.00295)
...
### [21] [A machine learning framework for developing quasilinear saturation rules of turbulent transport from linear gyrokinetic data](https://arxiv.org/abs/2604.00462)
...
### [22] [Generating intense attosecond pulses and vectorizing polarization states from laser-plasma interactions](https://arxiv.org/abs/2604.00622)
...
### [23] [Cyclic reformation of subcritical perpendicular fast magnetosonic shocks due to oblique Whistler waves](https://arxiv.org/abs/2604.00633)
...
### [24] [Real-time virtual circuits for plasma shape control via neural network surrogates: dynamic validation in closed-loop simulations](https://arxiv.org/abs/2604.00781)
...
### [25] [Ultrafast Kilowatt-Range Microwave Pulsing for Enhanced CO2 Conversion in Atmospheric-Pressure Plasmas](https://arxiv.org/abs/2604.01136)
...
### [26] [Distinct transverse-response signatures of retained-spin, eliminated-spin, and polynomial Burnett-type surrogate closures](https://arxiv.org/abs/2604.00177)
*Satori Tsuzuki*
...
### [27] [Predictor-Driven Diffusion for Spatiotemporal Generation](https://arxiv.org/abs/2604.00327)
...
### [28] [Optimization-Based Discovery of A Non-Attracting Flow State in An Oscillating-Cylinder Wake](https://arxiv.org/abs/2604.00441)
...
### [29] [Turbulent heat transfer enhancement by compliant walls](https://arxiv.org/abs/2604.00484)
...
### [30] [Numerical Bow Shock Instabilities in Inert Polyatomic Gases](https://arxiv.org/abs/2604.00577)
...
### [31] [Two-stage dispersion mechanism of clean spherical bubbles rising in a chain](https://arxiv.org/abs/2604.00612)
...
### [32] [Spatio-Temporal Uncertainty-Modulated Physics-Informed Neural Networks for Solving Hyperbolic Conservation Laws with Strong Shocks](https://arxiv.org/abs/2604.00029)
...
### [33] [Towards Verifiable and Self-Correcting AI Physicists for Quantum Many-Body Simulations](https://arxiv.org/abs/2604.00149)
...
### [34] [Geometry-informed neural atlas for boundary value problems of complex 3D geometries](https://arxiv.org/abs/2604.00285)
*WaiChing Sun*
...
### [35] [Discovery of Symbolic Hamiltonian Expressions with Buckingham-Symplectic Networks](https://arxiv.org/abs/2604.00576)
...
### [36] [Moment-preserving particle merging via non-negative least squares](https://arxiv.org/abs/2604.00668)
...
### [37] [Procela: Epistemic Governance in Mechanistic Simulations Under Structural Uncertainty](https://arxiv.org/abs/2604.00675)
*Kinson Vernet*
...
### [38] [A P-Adaptive Hybridizable Discontinuous Galerkin Spectral Element Method for Electrostatic Particle-in-Cell Simulations](https://arxiv.org/abs/2604.00782)
...
### [39] [Stable Determinant Monte Carlo Simulations at Large Inverse Temperature $β$](https://arxiv.org/abs/2604.00815)
...
### [40] [A multiphysics model for triboelectric nanogenerator design with explicit surface roughness representation](https://arxiv.org/abs/2604.01119)
