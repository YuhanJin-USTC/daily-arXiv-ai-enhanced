...
### [7] [Ultimate Performance of Thin-Film Lithium Niobate Mach-Zehnder Modulators](https://arxiv.org/abs/2609.16379)
...
### [8] [A Programmable Optics Cloud Laboratory](https://arxiv.org/abs/2609.16413)
...
### [9] [Deterministic Ground-State Search in a Spatial Photonic Ising Machine by Phase Retrieval](https://arxiv.org/abs/2609.16474)
...
### [10] [Simulating multimode nonlinearities at very high mode count via parallel factor decomposition](https://arxiv.org/abs/2609.16502)
*Nicholas Rivera*
...
### [11] [Learning Transferable Self-Supervised Priors for Super-Resolution Reconstruction in Structured Illumination Microscopy](https://arxiv.org/abs/2609.16538)
...
### [12] [Integrated Photonic Devices in Thin-Film Barium Titanate: Opportunities and Challenges](https://arxiv.org/abs/2609.16616)
...
### [13] [Terahertz two-dimensional coherent spectroscopy: unlocking coherent quantum intraband nonlinear dynamics](https://arxiv.org/abs/2609.16623)
...
### [14] [In-Situ Quantum Optical Measurement for Colloidal Quantum Dots Confined in an Optical Trap](https://arxiv.org/abs/2609.16692)
...
### [15] [Singly resonant InGaP microresonators for efficient, low-threshold second-order nonlinear optics](https://arxiv.org/abs/2609.16718)
...
### [16] [High-intensity wave vortices in the beamoptics domain: 3D spatial structure, singleplane models, and their propagation properties](https://arxiv.org/abs/2609.16820)
...
### [17] [Quantifying structural nonlinearity in a disordered Fabry-Pérot cavity](https://arxiv.org/abs/2609.17030)
...
### [18] [Field Angular Momentum Transformation as a Resolution Criterion for Microsphere-assisted microscopy](https://arxiv.org/abs/2609.17214)
*Bekirov Arlen*
...
### [19] [Bound-State Engineered Quantum Batteries Against Decoherence](https://arxiv.org/abs/2609.17367)
...
### [20] [Bridging high-Q and Kerr-nonlinear photonics using modal phase matching](https://arxiv.org/abs/2609.17444)
...
### [21] [Stitch-Free, Diamond-Scribed Silicon Nitride Photonic Integrated Circuits for the Visible Band](https://arxiv.org/abs/2609.17480)
...
### [22] [Hysteresis and trap emission in dc-biased integrated lithium niobate electro-optic modulators](https://arxiv.org/abs/2609.17489)
...
### [23] [A deep dive into Tollmien-Schlichting wave control via passive wall deformations: The battle between local and downstream stabilization, lessons learned, and implications for phononic subsurfaces](https://arxiv.org/abs/2609.16144)
...
### [24] [Computer-assisted global regularity across nonlinear families of three-dimensional periodic Navier-Stokes flows](https://arxiv.org/abs/2609.16157)
...
### [25] [Improving Reduced-Order Rotating Detonation Engine Models with Data Assimilation and Machine Learning](https://arxiv.org/abs/2609.16237)
...
### [26] [Stratified jet with wall effects](https://arxiv.org/abs/2609.16418)
...
### [27] [Extensible membranes in inviscid flow: aerodynamics and singular limits](https://arxiv.org/abs/2609.16484)
...
### [28] [Inertialess turbulence in viscoelastic pipe flow](https://arxiv.org/abs/2609.16492)
...
### [29] [Does the Boussinesq approximation correctly describe statistically stationary states of Rayleigh-Bénard convection?](https://arxiv.org/abs/2609.16634)
*Erik Lindborg*
...
### [30] [Turbulence at an aerofoil leading edge: the linearity boundary and its generation mechanism](https://arxiv.org/abs/2609.16709)
...
### [31] [Rotation Collision based Quantum Lattice Boltzmann Methods](https://arxiv.org/abs/2609.16721)
...
### [32] [Direct Trajectory Reconstruction for Fast 3D X-ray Particle Tracking Velocimetry in Porous Media](https://arxiv.org/abs/2609.16838)
...
### [33] [Comparative Evaluation of Carotid Artery Hemodynamics: Patient-Specific CFD Simulations vs. 4D flow MRI](https://arxiv.org/abs/2609.17295)
...
### [34] [A derivative-free framework for capturing macroscopic behavior of incompressible turbulent flows](https://arxiv.org/abs/2609.17323)
...
### [35] [A Gradient-Reconstruction Lattice Boltzmann Method for Compressible Navier--Stokes--Fourier Equations](https://arxiv.org/abs/2609.16361)
...
### [36] [Highly Parallel Real-Space Random Phase Approximation Using Lanczos Quadrature and Interpolation](https://arxiv.org/abs/2609.16408)
...
### [37] [Implicit Lagrangian Hydrodynamics with High-Order Finite Elements](https://arxiv.org/abs/2609.16424)
...
### [38] [An energy stable and accuracy-preserving finite volume scheme based on the SAV method with application to wall-distance computation](https://arxiv.org/abs/2609.16885)
...
### [39] [Adding slow magnetoacoustic mode to the HLL-type multi-state approximate Riemann solution](https://arxiv.org/abs/2609.17049)
...
### [40] [Ionization Profile Monitors for the IOTA Storage Ring at Fermilab](https://arxiv.org/abs/2609.17022)
...
### [41] [A 20kA $\pm$0.12% Pulsed Power Supply for the PIP-II ORBUMP Injection Dipole Magnets](https://arxiv.org/abs/2609.17105)
...
### [42] [Implementation of a 300 kA Pulsed Power Supply](https://arxiv.org/abs/2609.17126)
...
### [43] [PIP-II Project Progress and Challenges](https://arxiv.org/abs/2609.17155)
*O. Napoly*
...
### [44] [Characteristic Mapping Method for Vlasov-Poisson with BGK-collisions](https://arxiv.org/abs/2609.16328)
...
### [45] [KEMPIC-3D: A transparent and extensible electromagnetic Particle-in-Cell framework for kinetic plasma simulations](https://arxiv.org/abs/2609.16575)
...
### [46] [JC-PIC: kinetic (PIC-MCC) simulation of lowtemperature plasmas with a documented library of one hundred test cases](https://arxiv.org/abs/2609.17151)
*Jean-Pierre Boeuf*
...
### [47] [Strong Nonlinear Alfvén Wave Interactions in a Laboratory Plasma](https://arxiv.org/abs/2609.17162)
...
### [48] [Nonlinear kinetic closures for linear instabilities](https://arxiv.org/abs/2609.17209)
...
### [49] [Spatially-resolved methane decomposition in a short glow discharge: insights into suprathermal hydrogen and radical chemistry](https://arxiv.org/abs/2609.17345)
*Shurik Yatom*
...
### [50] [Electrons quench ion tails during evaporative cooling in hot ion mode plasmas](https://arxiv.org/abs/2609.17402)
...
### [51] [On energy conservation laws in the drift-reduced Braginskii model](https://arxiv.org/abs/2609.17425)
