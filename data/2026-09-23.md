...
### [1] [Spin-multiplexed terahertz image edge detection based on extrinsic chirality in all-dielectric metasurface](https://arxiv.org/abs/2609.25147)
...
### [2] [Topological Edge States Enable Step-like Power Transfer for Robust Arbitrary-Ratio Power Splitting](https://arxiv.org/abs/2609.25493)
...
### [3] [Resonant multi-harmonic acousto-optics for programmable frequency control of visible light in a CMOS platform](https://arxiv.org/abs/2609.25593)
...
### [4] [Photonic half-semimetals with dual semimetal-insulator topology](https://arxiv.org/abs/2609.25596)
...
### [5] [Momentum-Space Planar Optics for Long-Range Spin Hamiltonians](https://arxiv.org/abs/2609.25613)
...
### [6] [Orbital Optical Chirality as the Origin of Vortex Dichroism](https://arxiv.org/abs/2609.25629)
...
### [7] [Intra-bandgap Bound-State Magnonics in a Photonic Crystal Waveguide](https://arxiv.org/abs/2609.25744)
...
### [8] [Meta-Optics-Based Diffractive Learning Machine for Angle-Multiplexed Multi-Task Processing](https://arxiv.org/abs/2609.25792)
...
### [9] [Orthogonal Flatbands-Enabled Robust Fano Resonances through Brillouin-Zone Folding](https://arxiv.org/abs/2609.25902)
...
### [10] [Optical-Memory Transport Imaging: Extension to Stochastic Diffusion](https://arxiv.org/abs/2609.25946)
...
### [11] [Resolution-matched gain in Multi-beam ptychography](https://arxiv.org/abs/2609.26291)
...
### [12] [Reducing ringing artifacts in Wiener deconvolution using implicit physical priors](https://arxiv.org/abs/2609.26320)
...
### [13] [Channeling defect emission through topological Jackiw-Rebbi states in hBN](https://arxiv.org/abs/2609.26446)
...
### [14] [Structured detection beyond spatial imaging](https://arxiv.org/abs/2609.26690)
...
### [15] [Stable 50 MeV Beams from a 100 Hz Laser-Wakefield Accelerator Driven by an OPCPA Laser](https://arxiv.org/abs/2609.26390)
...
### [16] [Thermomechanical rf breakdown from magnetically focused field emission in high-gradient normal-conducting cavities](https://arxiv.org/abs/2609.26614)
...
### [17] [Learning continuous reaction paths for transition-state prediction](https://arxiv.org/abs/2609.25523)
...
### [18] [Electromagnetic analysis of low dropout regulator circuit small-signal stability characterization for inductive LC filters and transformers](https://arxiv.org/abs/2609.26221)
...
### [19] [Propagation electrodynamics differential conduction of action potentials in geometrically branched squid giant axons](https://arxiv.org/abs/2609.26224)
*Xi Liu,Wenxi Fang,Ken Perlin*
...
### [20] [Silk-templated Nanostrips as Superprotonic Fibre Sensors](https://arxiv.org/abs/2609.25293)
...
### [21] [Physics-constrained identification of near-flutter aeroelastic damping from finite records](https://arxiv.org/abs/2609.25440)
...
### [22] [Kolmogorov scale in turbulence of surface gravity waves](https://arxiv.org/abs/2609.25600)
...
### [23] [Structural identifiability and stress reconstruction from incomplete optical maps with velocimetry](https://arxiv.org/abs/2609.25663)
...
### [24] [A unified multirate lattice Boltzmann framework for thermosolutal dendritic solidification](https://arxiv.org/abs/2609.25670)
...
### [25] [CFD-Machine Learning Driven Pod Optimization and Staged Pressure-Area Management for Supersonic Evacuated Tube Transport](https://arxiv.org/abs/2609.25713)
...
### [26] [Intrinsic dynamical shadowing of point vortices and finite time singularities](https://arxiv.org/abs/2609.25989)
...
### [27] [Exact linearisation of the nonlinear shallow-water equations over a moving bottom: classification, wave generation and run-up](https://arxiv.org/abs/2609.26253)
*Yong Sung Park*
...
### [28] [A thermodynamically consistent and conservative phase-field model for surfactant contact line dynamics with solid adsorption](https://arxiv.org/abs/2609.26332)
...
### [29] [Wind farm global blockage as an adverse pressure gradient problem: turbulence amplification and spectral modification in the induction region of a model wind farm](https://arxiv.org/abs/2609.26415)
...
### [30] [Experimental observations of sub-threshold triadic resonances in internal wave beams](https://arxiv.org/abs/2609.26689)
...
### [31] [Inferring Thermal Dissociation Kinetics of Ion Clusters from Molecular Dynamics](https://arxiv.org/abs/2609.25070)
...
### [32] [Reactive Trace Species Modeling with the Simulation Tool PICLas](https://arxiv.org/abs/2609.25073)
...
### [33] [Why MHD turbulence forms sheets: energy conversion and cascade geometry](https://arxiv.org/abs/2609.25407)
...
### [34] [Scalable Terbium-149 Production from Highly Enriched Gadolinium-150 Targets](https://arxiv.org/abs/2609.25554)
...
### [35] [Experimental and Theoretical Study of Flow Dynamics of Expanding Hydrogen Plasma from an ECR Plasma Source](https://arxiv.org/abs/2609.26070)
...
### [36] [Analytic toroidal 3D MHD equilibria and steady Euler flows with invariant surfaces](https://arxiv.org/abs/2609.26742)
*Matt Landreman*
...
### [37] [The use of coherent states in the excitation and ionization of atoms by a short symmetric pulse](https://arxiv.org/abs/2609.25099)
*Jorge E. Miraglia*
...
### [38] [A low-cost modular FPGA-based control system for neutral atom tweezer arrays](https://arxiv.org/abs/2609.25456)
...
### [39] [$LS/LSJ$ Hybrid Coupling Framework for Auger Angular Distributions of Experimentally Unresolved Multiplets with Isolated Fine-Structure](https://arxiv.org/abs/2609.25865)
*Theo J. M. Zouros*
...
### [40] [Optical Ion Clock with Engineered Immunity to Motion-Induced Frequency Shifts](https://arxiv.org/abs/2609.26775)
