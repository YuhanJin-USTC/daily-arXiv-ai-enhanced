...
### [5] [Stabilization of Rydberg Dissipative Time Crystals Using a Scanning Fabry Perot Interferometer Transfer Lock](https://arxiv.org/abs/2602.22498)
...
### [6] [Full Single-Quantum Control of Particles in Penning Traps for Symmetry Tests at the Quantum Limit](https://arxiv.org/abs/2602.22802)
...
### [7] [Kelvin wave and soliton propagation in classical viscous vortex filaments](https://arxiv.org/abs/2602.22439)
...
### [8] [Acoustic Signatures of Pinch-Off Cavities During Water-Entry](https://arxiv.org/abs/2602.22761)
...
### [9] [On the spatial structure and intermittency of soot in a lab-scale gas turbine combustor: Insights from large-eddy simulations](https://arxiv.org/abs/2602.23155)
...
### [10] [From synthetic turbulence to true solutions: A deep diffusion model for discovering periodic orbits in the Navier-Stokes equations](https://arxiv.org/abs/2602.23181)
...
### [11] [Photonic Neuromorphic Computing enabled by a BIC Metasurface](https://arxiv.org/abs/2602.22528)
...
### [12] [Anomalous High-Energy Second Plateau in High Harmonic Generation from Fullerenes](https://arxiv.org/abs/2602.22599)
...
### [13] [Emerging Multidimensional Real-Space Topological Structures at Chiral Bound States in the Continuum](https://arxiv.org/abs/2602.22634)
...
### [14] [Quantum squeezing in an all-resonant periodically poled lithium niobate microresonator](https://arxiv.org/abs/2602.22693)
...
### [15] [Experimental investigation of the effect of dispersion on squeezing generation in a synchronously pumped optical parametric oscillator](https://arxiv.org/abs/2602.22806)
...
### [16] [HELIOS: A surface integral equation software for light scattering in homogeneous, periodic, and stratified environments](https://arxiv.org/abs/2602.23097)
...
### [17] [Kerr-induced Spectral Interferometry for Direct Ultra-sensitive Phase Recovery](https://arxiv.org/abs/2602.22845)
...
### [18] [Hard X-Ray Zernike-Type Phase-Contrast Imaging with a Two-Block Crystal System](https://arxiv.org/abs/2602.22992)
*Levon Haroutunyan*
...
### [19] [Versatile CMOS modulation-free self-isolating stabilized precision lasers on a chip](https://arxiv.org/abs/2602.23160)
...
### [20] [Enhanced Interband Optical Nonlinearities from Coupled Quantum Wells](https://arxiv.org/abs/2602.23246)
...
### [21] [Coherent Virtual Absorption in Dielectric Metasurfaces](https://arxiv.org/abs/2602.23328)
...
### [22] [Temporal metamaterials with passive switching as impedance-matched absorbers](https://arxiv.org/abs/2602.23347)
