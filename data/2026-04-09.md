...
### [1] [Strong-field ionization of atoms with bright squeezed vacuum light](https://arxiv.org/abs/2604.06703)
...
### [2] [Recoil corrections to $μ$H hyperfine splitting](https://arxiv.org/abs/2604.06930)
...
### [3] [Defect-free arrays at the thousand-atom scale in a 4-K cryogenic environment](https://arxiv.org/abs/2604.07205)
...
### [4] [Two-dimensional shelving spectroscopy of ultraviolet ground state transitions in dysprosium](https://arxiv.org/abs/2604.07283)
...
### [5] [Operator Learning for Surrogate Modeling of Wave-Induced Forces from Sea Surface Waves](https://arxiv.org/abs/2604.06433)
...
### [6] [A Massively Scalable Ligand-Protein Dissociation Dynamic Database Derived from Atomistic Molecular Modelling](https://arxiv.org/abs/2604.06761)
...
### [7] [Granular mixing and flow dynamics in horizontal stirred bed reactors](https://arxiv.org/abs/2604.07082)
...
### [8] [Plasma GraphRAG: Physics-Grounded Parameter Selection for Gyrokinetic Simulations](https://arxiv.org/abs/2604.06279)
...
### [9] [Forecasting the first Edge Localized Mode (ELM) after LH-transition with a neural network trained on Doppler Backscattering data from DIII-D](https://arxiv.org/abs/2604.06508)
...
### [10] [Development of a Simple Stellarator using Tilted Circular Toroidal Field Coils](https://arxiv.org/abs/2604.06677)
...
### [11] [Monte Carlo Simulations of Suprathermal Enhancement in Advanced Nuclear Fusion Fuels](https://arxiv.org/abs/2604.06769)
...
### [12] [Phase-Selective Excitation of Betatron Oscillations by Nonadiabatic Magnetic-Field Switching](https://arxiv.org/abs/2604.07305)
...
### [13] [Complex plasma with Janus particles as a model active-matter system](https://arxiv.org/abs/2604.06850)
*Volodymyr Nosenko*
...
### [14] [Too Big, Too Small, Too $O_2$: The Pandoro Effect from Oxygen Gradients in Tomographic Volumetric Additive Manufacturing](https://arxiv.org/abs/2604.06313)
...
### [15] [Inverse design of waveguide grating mode converters using artificial neural networks](https://arxiv.org/abs/2604.06328)
...
### [16] [Aperiodic metalenses: intrinsically near-achromatic visible focusing with identical nanocylinders](https://arxiv.org/abs/2604.06512)
...
### [17] [UV-enhanced SEM: towards orientation and electron work function imaging](https://arxiv.org/abs/2604.06634)
...
### [18] [Ultra-wideband electrically-tuned mid-infrared on-chip parametric oscillator](https://arxiv.org/abs/2604.06673)
...
### [19] [Steady-State Statistical Modeling of Digitally Stabilized Laser Frequency with Markov-State Feedback](https://arxiv.org/abs/2604.06676)
...
### [20] [Attosecond quantum spectroscopy with entangled photon pairs](https://arxiv.org/abs/2604.06707)
...
### [21] [Enhanced Self-Supervised Multi-Image Super-Resolution for Camera Array Images](https://arxiv.org/abs/2604.06816)
...
### [22] [Phase-locked phonon laser enhanced ultra-weak force measurement](https://arxiv.org/abs/2604.06923)
...
### [23] [Nanobeam Laser Cavities with High Quality-factor and Near-Unity Outcoupling Efficiency](https://arxiv.org/abs/2604.06953)
...
### [24] [Microresonators induced at the optical fiber intersections](https://arxiv.org/abs/2604.06960)
*M. Sumetsky*
...
### [25] [A Simple and Robust Balanced Homodyne Detector for High-Repetition-Rate Pulsed Sources](https://arxiv.org/abs/2604.06994)
...
### [26] [Orbital and spin current density backflow in unidirectional monochromatic electromagnetic fields in vacuum](https://arxiv.org/abs/2604.07089)
...
### [27] [Photon density of states engineering with generative inverse design for scalable 3D photonic metamaterials](https://arxiv.org/abs/2604.07111)
...
### [28] [Symmetry-Engineered Magnetic Dipole Emission in Plasmonic Core-Satellite Resonators](https://arxiv.org/abs/2604.07140)
...
### [29] [TurPy: a physics-based and differentiable optical turbulence simulator for algorithmic development and system optimization](https://arxiv.org/abs/2604.07248)
...
### [30] [Transonic flow past the complex cavity-sub-cavity configurations](https://arxiv.org/abs/2604.06397)
...
### [31] [Modeling Ostwald Ripening Dynamics in Porous Microstructures](https://arxiv.org/abs/2604.06581)
...
### [32] [Wall heat transfer and flow field configuration of shock wave-turbulent boundary layer interactions on cryogenically cooled wall](https://arxiv.org/abs/2604.06797)
...
### [33] [Quantifying Flow separation for ellipse and von-Kármán Airfoil: A dataset of surface pressure and skin friction](https://arxiv.org/abs/2604.06913)
...
### [34] [Solitary wave structure of transitional flow in the wake of a sphere](https://arxiv.org/abs/2604.06965)
...
### [35] [Space-time correlations of passive scalars in colored-noise flows](https://arxiv.org/abs/2604.07052)
*Long Wang,Guowei He*
...
### [36] [Estimating bottom topography in shallow water flows](https://arxiv.org/abs/2604.07075)
...
### [37] [A solver-in-the-loop framework for end-to-end differentiable coastal hydrodynamics](https://arxiv.org/abs/2604.07129)
...
### [38] [Viscous Bending Mitigates the Spontaneous Meandering of Rivulets in Hele-Shaw Cells](https://arxiv.org/abs/2604.07222)
