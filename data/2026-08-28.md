...
### [1] [Moving forward with multilayer metastructures - simple design of complex optics](https://arxiv.org/abs/2608.26298)
*David A. B. Miller*
...
### [2] [Loss-tolerant hybrid metasurface mirror for reducing coating Brownian noise in precision optical cavities](https://arxiv.org/abs/2608.26370)
...
### [3] [Optically Induced Thermal Runaway in Phase-Change VO2 Nanostructures](https://arxiv.org/abs/2608.26401)
...
### [4] [Towards a universal meta-optics solver via large language models](https://arxiv.org/abs/2608.26417)
...
### [5] [Phase retrieval based on intensity-only spatiotemporal wavefront shaping](https://arxiv.org/abs/2608.26445)
...
### [6] [HoloCMA: A Holographic Eye on Coarse-Mode Aerosols](https://arxiv.org/abs/2608.26466)
...
### [7] [Beyond geometric symmetry: Broadband linear relations in wave scattering](https://arxiv.org/abs/2608.26562)
...
### [8] [Dual-Symmetrized Construction of Electromagnetic Beams Beyond the Paraxial Approximation with an Explicit Separation of Scalar and Vectorial Corrections](https://arxiv.org/abs/2608.26776)
...
### [9] [Lower bound on the thickness of broadband dielectric mirrors](https://arxiv.org/abs/2608.26633)
*Mikhail A. Kats*
...
### [10] [Widely Tunable, Etch-free Multi-dielectric Fano Metasurfaces in the Visible](https://arxiv.org/abs/2608.26677)
...
### [11] [Visible Dielectric Metastructure for Generating Ultranarrow-band Perfect Absorption and Bound States in the Continuum](https://arxiv.org/abs/2608.26679)
*Md Rumon Miah,Hilmi Volkan Demir*
...
### [12] [Directional Emission From High-Q Asymmetric Hollow Whispering Gallery Resonators](https://arxiv.org/abs/2608.26691)
...
### [13] [Circular Dichroism Spectroscopy of Single Objects: Problems, Artifacts, and Corrections](https://arxiv.org/abs/2608.26717)
...
### [14] [Ultra-broadband transient absorption down to 200 nm enabled by soliton dynamics in gas-filled hollow capillary fibers](https://arxiv.org/abs/2608.26910)
...
### [15] [Cavity Solitons](https://arxiv.org/abs/2608.26985)
...
### [16] [Field-driven attosecond deflection of electron beams at the position of planar foils](https://arxiv.org/abs/2608.27015)
...
### [17] [Self-starting Dynamics in All-fibre All-Normal-Dispersion Thulium Mamyshev oscillator](https://arxiv.org/abs/2608.27050)
...
### [18] [Ultra-Low-Loss Silicon Nitride on Sapphire for Broad-Transparency Nonlinear and Quantum Photonics](https://arxiv.org/abs/2608.27335)
...
### [19] [The mass ejected by a bubble bursting from a free drop](https://arxiv.org/abs/2608.26296)
...
### [20] [Variational Acoustics](https://arxiv.org/abs/2608.26340)
...
### [21] [Quantifying the effect of resonant amplitude and frequency of phononic material vibrations on the coupled fluid-structure interaction dynamics in separated aerodynamic flows](https://arxiv.org/abs/2608.26381)
...
### [22] [Unpinning of trapped oil droplets via non-resonant acoustic streaming in capillary tubes](https://arxiv.org/abs/2606.27331)
*D. Tsiklauri*
...
### [23] [Direct numerical simulation of NOx formation in turbulent lean premixed hydrogen-air flames under engine-relevant conditions](https://arxiv.org/abs/2608.26435)
...
### [24] [SnapPINN: Pressure and Energy Dissipation Reconstruction from a Sparse and Noisy Velocity Snapshot](https://arxiv.org/abs/2608.26711)
...
### [25] [The ultimate state of elastic turbulence](https://arxiv.org/abs/2608.26479)
...
### [26] [Resolvent analysis to inform viscoelastic coatings for turbulent drag reduction](https://arxiv.org/abs/2608.26611)
...
### [27] [Z-Fold Wing Aeroelasticity: Compositional Modeling, 1:2 Double-Hopf Dynamics, and Nonlinear Stiffness Effects](https://arxiv.org/abs/2608.26637)
...
### [28] [Gravity current fronts advancing along a heated wall](https://arxiv.org/abs/2608.26769)
...
### [29] [Linear and Nonlinear Latent-Space Reduced-Order Models for the Rayleigh--Taylor Instability](https://arxiv.org/abs/2608.26783)
...
### [30] [Density Field of Dilute Particle Flow in Two-Fluid Model with Incompressible Carrier Flow](https://arxiv.org/abs/2608.26835)
*Kazuhiro Tsuboi*
...
### [31] [Turbulent diffusivity and effective rise velocity of buoyant particles in a free-surface boundary layer](https://arxiv.org/abs/2608.26967)
...
### [32] [Quantum-Inspired Computational Fluid Dynamics for Transient Turbulent Compressible Flows](https://arxiv.org/abs/2608.26995)
...
### [33] [High-resolution in situ analysis of biomass pyrolysis by combining quantitative synchrotron $μ$CT and 3D particle-resolved simulations](https://arxiv.org/abs/2608.27042)
...
### [34] [Stochastic Transport and Wave Interactions for Multiscale Surface Gravity Waves: Part II: Kinetic Theory and Ocean-Wave Applications](https://arxiv.org/abs/2608.27105)
...
### [35] [Energy transfer and scale organisation in dense canopy turbulence](https://arxiv.org/abs/2608.27272)
...
### [36] [Dynamical slowdown, bottlenecks, and multiscaling in Voigt-regularised turbulence](https://arxiv.org/abs/2608.27355)
...
### [37] [How well can Diffusion Models learn Lagrangian-Tracer Statistics in Non-reciprocal Turbulence?](https://arxiv.org/abs/2608.27378)
...
### [38] [High-order stabilized matrix-free simulation of rotating mixing devices using the Mortar Element Method](https://arxiv.org/abs/2608.27423)
...
### [39] [Measuring the Sr$^+$ 5s$_{1/2}$ Landé $g$-factor Using Singlet-Triplet Oscillations in a Circular Rydberg State of Strontium](https://arxiv.org/abs/2608.26784)
...
### [40] [Beyond-EUV spectrum of highly-charged gadolinium](https://arxiv.org/abs/2608.27097)
...
### [41] [Influence of Many-Body Dipole-Dipole Interactions on Excitation Transfer in a Dense Gas](https://arxiv.org/abs/2608.27250)
...
### [42] [Real-time virtual circuits for plasma shape control via neural network emulators: integration and testing in the MAST-U PCS](https://arxiv.org/abs/2608.26216)
...
### [43] [Apokamp-type Gas Discharge Phenomenon: Experimental and Theoretical Backgrounds](https://arxiv.org/abs/2608.26356)
...
### [44] [A European high-energy heavy-ion facility for electronics irradiation based at CERN: Concept Design Report](https://arxiv.org/abs/2608.26369)
...
### [45] [Digital Signal Processing for Beam Instrumentation](https://arxiv.org/abs/2608.26793)
*Andrea Boccardi*
...
### [46] [Machine Learning Based ROI Segmentation for Beam Imaging Diagnostics at Accelerators](https://arxiv.org/abs/2608.26826)
...
### [47] [Muon acceleration at J-PARC](https://arxiv.org/abs/2608.26841)
...
### [48] [Large Magnet Structures for Fusion Technology: Lessons from ITER](https://arxiv.org/abs/2608.27230)
*Neil Mitchell*
