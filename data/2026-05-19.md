...
### [2] [Dispersion-Engineered Terahertz Silicon Interconnects Enabling Terabit-Scale Data Links](https://arxiv.org/abs/2605.16841)
...
### [3] [Supercollimating photonic crystal scintillators](https://arxiv.org/abs/2605.17006)
...
### [4] [Diptera vision and zebra stripes](https://arxiv.org/abs/2605.17049)
*Krispin M. Dettlaff*
...
### [5] [Project RAINBOW: An all-integrated all-optical ultrafast dual-comb chip](https://arxiv.org/abs/2605.17092)
*Tushar Malica*
...
### [6] [Passive Cross-Basis Mode Transitions Along a Single Freely Propagating Bessel Beam](https://arxiv.org/abs/2605.17200)
...
### [7] [Unified Topological Dynamics of Merging Bound States in the Continuum for High-Order Topological Charges](https://arxiv.org/abs/2605.17479)
...
### [8] [Overcoming noise-agility trade-off in integrated lasers for precision sensing](https://arxiv.org/abs/2605.17491)
...
### [9] [Semi-analytical Model of Multi-tile Rectangular Waveguide-fed Metasurfaces using Coupled Dipole Modeling Framework](https://arxiv.org/abs/2605.17541)
...
### [10] [Dual-Polarization Quasi-BIC Refractive Index Sensing via Dielectric Symmetry Breaking in TiO$_2$-BeS Metasurfaces](https://arxiv.org/abs/2605.17549)
...
### [11] [Giant nonlinear optical chirality in twisted heterobilayers](https://arxiv.org/abs/2605.17695)
...
### [12] [Crosstalk-free Chiral Anomaly Bulk States in Photonic Crystals](https://arxiv.org/abs/2605.17717)
...
### [13] [A Wafer-Scale Heterogeneous III-V-on-Silicon Nitride Quantum Photonic Platform](https://arxiv.org/abs/2605.17738)
...
### [14] [Amplification of Weak Forces via Parametric Interactions and Non-Markovian Effects in Cavity Optomechanics](https://arxiv.org/abs/2605.17810)
...
### [15] [Optoelectronic Chromatic Dispersion in a Single Photodiode for Machine-Learning-Based Computational Spectroscopy](https://arxiv.org/abs/2605.18014)
...
### [16] [The thin line for optical neural networks towards broad practical relevance](https://arxiv.org/abs/2605.18178)
...
### [17] [Energy-Resolved Eigenmode Spectroscopy of 1-D and 2-D Non-Hermitian Skin Effects](https://arxiv.org/abs/2605.18272)
...
### [18] [Self-healing of the Montgomery pattern](https://arxiv.org/abs/2605.18318)
...
### [19] [Comparative study of second harmonic generation at 1030 nm in BiBO and LBO crystals using a 100 W-class picosecond laser](https://arxiv.org/abs/2605.18527)
...
### [22] [Undulator Radiation from a Single Electron: A Temporal Double-Slit Experiment](https://arxiv.org/abs/2605.18244)
...
### [23] [Alternative Lattice Design for the STCF Collider Rings](https://arxiv.org/abs/2605.18435)
...
### [24] [Matching and Power Coupling](https://arxiv.org/abs/2605.18526)
*Graeme Burt*
...
### [25] [Basis-free neural-network geminal and Jastrow factors for variational Monte Carlo](https://arxiv.org/abs/2605.17083)
...
### [26] [Breakdown of Gradient-Flow Dynamics in Oscillator Ising Machines from Harmonic Misalignment](https://arxiv.org/abs/2605.17243)
...
### [27] [Physics Informed Neural Network-based Computational Method for Accelerating Time-Periodic Unsteady CFD Simulations](https://arxiv.org/abs/2605.18340)
...
### [28] [SPARC-atomSFE: Spectral finite-element package for atomic structure calculations in density functional theory](https://arxiv.org/abs/2605.18488)
...
### [29] [Simulation of S-parameters of general multilayer boxed PCBs with the method of moments and the scattering matrix algorithm](https://arxiv.org/abs/2605.18492)
...
### [30] [High-Order ADER-DG Hydrodynamics with ExaHyPE: Implementation, Validation, and Astrophysical Benchmarking](https://arxiv.org/abs/2605.17132)
...
### [31] [Elastic wave propagation governs impulse enhancement in pulsed jets through flexible nozzles](https://arxiv.org/abs/2605.17319)
...
### [32] [Designing single-layer PDMS devices for micron to millimeter-scale deformations](https://arxiv.org/abs/2605.17402)
...
### [33] [Solutocapillary instability in slipping falling films](https://arxiv.org/abs/2605.17519)
...
### [34] [Spatio-Temporal Signatures of Intermittency in Helically Rotating Turbulence through Topological Data Analysis](https://arxiv.org/abs/2605.17560)
...
### [35] [Self-focusing of helicity drives finite-time singularities in inviscid flows](https://arxiv.org/abs/2605.17569)
...
### [36] [Shear alignment and tensorial Taylor--Aris dispersion of Brownian rods in a circular tube](https://arxiv.org/abs/2605.17614)
*Jingsen Feng,Xu Chu*
...
### [37] [Ray-Column IPRM: Restoring Radial Spectral Scale to Structure-Based Turbulence Modeling](https://arxiv.org/abs/2605.17644)
*Stavros C. Kassinos*
...
### [38] [Long-horizon prediction of three-dimensional wall-bounded turbulence with CTA-Swin-UNet and resolvent analysis](https://arxiv.org/abs/2605.17888)
...
### [39] [Electrolyte flows under magnetic fields: Manning-like counterion condensation in one dimension](https://arxiv.org/abs/2605.18076)
...
### [40] [A discrete Boltzmann model with state-dependent power-law relaxation time for nonequilibrium transport in compressible flows](https://arxiv.org/abs/2605.18216)
...
### [41] [Dynamic Evolution of Pore-scale Heterogeneity and Transport Conditions Control Mineral Dissolution Regimes](https://arxiv.org/abs/2605.18223)
...
### [42] [Faraday waves covered by a viscoelastic sheet](https://arxiv.org/abs/2605.18273)
...
### [43] [Mapping the Turn: An Eulerian Binormal-Axis Diagnostic for Recirculating 3D Flows](https://arxiv.org/abs/2605.18439)
...
### [44] [FIRM3D: Fast ion reduced models in 3D](https://arxiv.org/abs/2605.16734)
...
### [45] [Critical velocity-space mode scalings in linear and nonlinear Landau damping for the Vlasov--Poisson system](https://arxiv.org/abs/2605.16814)
...
### [46] [Shafranov shift and finite $β$ effects on Alfvén Eigenmodes and microinstabilities in global electromagnetic gyrokinetic simulations](https://arxiv.org/abs/2605.17138)
...
### [47] [Role of Magnetic Field in the Redistribution of Turbulence from Large-Scale Structures to Small-Scale Fluctuations](https://arxiv.org/abs/2605.17321)
...
### [48] [Comparison of Tomographic Reconstruction Algorithms for Infrared Imaging Video Bolometer Diagnostic in Plasma Devices](https://arxiv.org/abs/2605.17459)
...
### [49] [Localization of a quantum particle in a classical one-component plasma. Fluctuation-induced random potential and the Coulomb logarithm](https://arxiv.org/abs/2605.18187)
*Yury A. Budkov*
...
### [50] [3D CO-TALIF distribution above a micro cavity discharge: A systematic approach for plasma catalysis](https://arxiv.org/abs/2605.18217)
...
### [51] [Topology of Plasma Wakefields Driven by Two Color Laguerre Gaussian Laser Pulses](https://arxiv.org/abs/2605.18336)
...
### [52] [Time Series Extrinsic Regression of Ion Cyclotron Emission Spectra Trained on Particle-In-Cell Simulations](https://arxiv.org/abs/2605.18268)
...
### [53] [An explicit, energy-conserving particle-in-cell scheme for relativistic plasmas](https://arxiv.org/abs/2605.18542)
...
### [54] [Bright, directional electron emission from nanowire coated targets under petawatt, femtosecond irradiation](https://arxiv.org/abs/2605.18668)
...
### [55] [Production of Intense Spin-Polarized Beams of Hydrogen Isotopes by Charge Transfer with High Density Raman-Pumped Alkali-Metal Vapors](https://arxiv.org/abs/2605.16663)
...
### [56] [Photon-Atom Granularity Noise Thermometry](https://arxiv.org/abs/2605.17797)
...
### [57] [Enhanced detection of electric field signals via squeezing-induced stochastic resonance](https://arxiv.org/abs/2605.18452)
...
### [58] [Switching Rydberg interactions by three orders of magnitude using a terahertz field](https://arxiv.org/abs/2605.18664)
