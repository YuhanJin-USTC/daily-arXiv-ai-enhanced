...
### [8] [Anisotropy and intermittency in drift-wave turbulence with zonal flows: a two-dimensional continuous wavelet analysis](https://arxiv.org/abs/2607.10136)
...
### [9] [Non-thermal Atmospheric Pressure Plasma Combined with Benzoyl Peroxide to Enhance the Inhibition of Bacteria](https://arxiv.org/abs/2607.10185)
...
### [10] [Divergence Without Transition in Adiabatic Theory: Exact Cancellation in Reflectionless Potentials](https://arxiv.org/abs/2607.10475)
...
### [11] [Electrohydrodynamic wind generation in planar DBDs: role of electrode symmetry and geometry](https://arxiv.org/abs/2607.10670)
...
### [12] [Ultrashort pulsed laser atmospheric filament properties and microwave radiation inferred from S-band guided wave interaction and self-emission](https://arxiv.org/abs/2607.10852)
...
### [13] [Efficient hot electron generation via low-coherence lasers](https://arxiv.org/abs/2607.11045)
...
### [14] [Development and validation of a local neoclassical transport module in NLT with applications to EAST-relevant impurity transport and trapped-electron-mode stability](https://arxiv.org/abs/2607.11103)
...
### [15] [VSC: A Zero-Dimensional Fusion Design Platform for Multiple Magnetic Configurations](https://arxiv.org/abs/2607.11208)
...
### [16] [Collisionless whistler heat-flux instability in ultra-high-$β$ plasmas](https://arxiv.org/abs/2607.11761)
...
### [17] [Destabilization of temperature-gradient-driven plasma turbulence by equilibrium $\vec{E}\times \vec{B}$ flow shear](https://arxiv.org/abs/2607.11784)
...
### [18] [Zonal-flow generation and saturation of electromagnetic ion-scale turbulence in tokamaks](https://arxiv.org/abs/2607.11789)
...
### [19] [Collimated QED Cascades with Curved Plasma Mirror](https://arxiv.org/abs/2508.00417)
...
### [20] [Exact Semiclassical Phase Shifts for Relativistic Atom Interferometers in Flat Spacetime](https://arxiv.org/abs/2607.10042)
...
### [21] [On the measurability of Wigner time delays at shape resonances in photodetachment of polyatomic anions](https://arxiv.org/abs/2607.10397)
...
### [22] [Investigation of transverse instability in efficient plasma-based accelerators](https://arxiv.org/abs/2607.10497)
...
### [23] [Beam based undulator trajectory alignment at European XFEL](https://arxiv.org/abs/2607.11407)
...
### [24] [Dark Optical Trapping of Resonant Transition-Metal Dichalcogenide Particles](https://arxiv.org/abs/2607.09896)
...
### [25] [Photonic Theta Cavity: Engineering Bound States in the Continuum in Topological Resonators Beyond the Limitations of Near Field Coupling](https://arxiv.org/abs/2607.09915)
...
### [26] [Differentiable Fast Far-Field Transform in Cylindrical Coordinates for Large-Area Cascaded Metalens Optics](https://arxiv.org/abs/2607.10005)
...
### [27] [Fourth-order Optoelectronic Response from Cascaded Circular Photogalvanic and Nonlinear Hall Effects](https://arxiv.org/abs/2607.10012)
...
### [28] [Photonic-Crystal Microresonator Frequency Combs in the O-band](https://arxiv.org/abs/2607.10025)
...
### [29] [Lumerical-Based SiN Half-Band FIR Maximally Flat-Top Optical Filter with Low Insertion Loss and High Extinction Ratio at 193 THz](https://arxiv.org/abs/2607.10031)
...
### [30] [Plasmon Gun: high-power mid-IR emission at a temporal interface](https://arxiv.org/abs/2607.10117)
*Evgenii E. Narimanov*
...
### [31] [Program-Synthesis-Driven Autodesign of Universal Unitary Operators](https://arxiv.org/abs/2607.10295)
...
### [32] [Gain-controlled directional scattering in core-shell nanoparticles mediated by magnetic toroidal dipoles](https://arxiv.org/abs/2607.10330)
*Tiago J. Arruda*
...
### [33] [Train-Resolved Statistical Recovery of Weak SAXS Signals in Liquids at the European XFEL](https://arxiv.org/abs/2607.10349)
...
### [34] [Phase-controlled transport of Floquet-driven compact topological photonic states](https://arxiv.org/abs/2607.10415)
...
### [35] [Mid-Infrared Single-Photon Detection via Enhanced Cross-Phase Modulation in Topology-Optimized Epsilon-Near-Zero Dual-Wavelength Nanocavities](https://arxiv.org/abs/2607.10472)
...
### [36] [Spacer-Mediated Gold Nanocube Arrays for Edge-Localized Excitonic Enhancement in Monolayer MoS2](https://arxiv.org/abs/2607.11768)
...
### [37] [The Temporal Evolution of Blackbody Radiation in a One-Dimensional Photonic Time-Crystal](https://arxiv.org/abs/2607.10577)
...
### [38] [Sub-Hz Stability and Correlation in Pair-Generated Primary Kerr Comb Tones](https://arxiv.org/abs/2607.10622)
...
### [39] [Optical Kerr nonlinearity enhancement in high-index metasurfaces via Mie void lattices](https://arxiv.org/abs/2607.10719)
*Andrey V. Panov*
...
### [40] [Three-dimensional excitonic dipole anisotropy enables ultrabroadband polarization photodetection in CrCl3](https://arxiv.org/abs/2607.10752)
...
### [41] [Vernier-assisted mode-selective PT symmetry in optoelectronic oscillators](https://arxiv.org/abs/2607.10882)
...
### [42] [Non-Abelian holonomic transformations in digitally coupled acoustic waveguides guided by the global adiabatic criterion](https://arxiv.org/abs/2607.11000)
...
### [43] [Abnormal motions of optical vortex-antivortex-coupled wavepackets in the parabolic potential](https://arxiv.org/abs/2607.11181)
...
### [44] [Leveraging Raman response in X-cut thin-film lithium tantalate for ultrabroadband combs and polychromatic visible light](https://arxiv.org/abs/2607.11186)
...
### [45] [Chiral lasing via broken parity-time symmetry in bound-state-in-the-continuum metasurfaces](https://arxiv.org/abs/2607.11235)
...
### [46] [Geometry-Optimized Complex-Domain error-diffusion encoding for Fourier Single-Pixel Imaging](https://arxiv.org/abs/2607.11264)
...
### [47] [Twist tunable resonances in photonic bilayer for second harmonic generation](https://arxiv.org/abs/2607.11300)
...
### [48] [Heterogeneous-Gradient Phase--Polarization Alignment and Maximal-Ratio Weight Allocation for Multi-Aperture Coherent FSO Reception](https://arxiv.org/abs/2607.11458)
...
### [49] [NaBiF$_4$: Er$^{3+}$, Yb$^{3+}$ upconversion particle as a multi-functional bio-marker](https://arxiv.org/abs/2607.11522)
...
### [50] [Drill-bit-inspired dynamic focal fields for augmented laser materials processing](https://arxiv.org/abs/2607.11553)
...
### [51] [Axion Generation in a Three-Dimensional Optical Trap](https://arxiv.org/abs/2607.11589)
...
### [52] [The Dielectric Bowtie Effect: Classical Electromagnetic Edge Singularities in Subwavelength Cavities](https://arxiv.org/abs/2607.11613)
...
### [53] [Analytical Theory of Photon Tunneling and Near-Field Heat Transfer Between Dissimilar Materials](https://arxiv.org/abs/2607.11671)
...
### [54] [Phase synchronization dynamics of two mutually coupled InP lasers in a quantum entropy source](https://arxiv.org/abs/2607.11806)
...
### [55] [Flow and Heat Transfer Characteristics of Forced Convection Past an Isoflux Circular Cylinder in Galinstan for Reynolds Numbers up to 600](https://arxiv.org/abs/2607.09922)
*Dipjyoti Nath*
...
### [56] [A Multispecies ESBGK Model for Gas Mixtures with Variable Hard Sphere Transport: Theory and Verification](https://arxiv.org/abs/2607.09934)
...
### [57] [Batchelor's formula and infrared renormalization for sedimentation](https://arxiv.org/abs/2607.09995)
...
### [58] [Scale interactions and energy transfer in the turbulent wake of a bluff body](https://arxiv.org/abs/2607.10028)
...
### [59] [An integral surface tension scheme for three-dimensional front tracking frameworks](https://arxiv.org/abs/2607.10164)
...
### [60] [Modeling Equations in Wave-Particle Turbulence Simulation](https://arxiv.org/abs/2607.10176)
...
### [61] [Direct Numerical Simulation of Fully Developed Turbulent Channel Flow Based on the Corrected Navier-Stokes Equations](https://arxiv.org/abs/2607.10224)
...
### [62] [Relative dispersion and eddy diffusivity in laboratory experiments of $β$-plane turbulence](https://arxiv.org/abs/2607.10225)
...
### [63] [NeuroForge: A Self-Correcting, Geometry-Native Neural CFD Engine with Calibrated Physics-Residual Trust](https://arxiv.org/abs/2607.10333)
...
### [64] [The critical radius of compressible capillary drops: viscosity, thermodynamics, and diffuse-interface scales](https://arxiv.org/abs/2607.10609)
*Umpei Miyamoto*
...
### [65] [Secondary Flows and Near-Wall Turbulence in Channel Flow with Longitudinal Ribs](https://arxiv.org/abs/2607.10699)
...
### [66] [Spreading and rupture dynamics of soluble surfactant-laden thin film flow down a slippery incline in presence of external shear](https://arxiv.org/abs/2607.10875)
...
### [67] [Understanding the Theory--Experiment Discrepancy in Pressure Drop of Dilute Polymer Solutions in Channel Flows](https://arxiv.org/abs/2607.10973)
...
### [68] [Wall-scaled eddies and embedded shear layers in high-Reynolds-number moderate adverse-pressure-gradient boundary layers](https://arxiv.org/abs/2607.11024)
...
### [69] [Feature-based manifold model of actuated wakes](https://arxiv.org/abs/2607.11463)
...
### [70] [Why gas-focused microjets are so fast: kinetically resolved, shear-driven flow focusing in vacuum](https://arxiv.org/abs/2607.11802)
...
### [71] [Coherence as Thermodynamic Organization: Toward a Non-Equilibrium Turbulence Theory](https://arxiv.org/abs/2607.11817)
*Sharath S. Girimaji*
