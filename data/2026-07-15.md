...
### [8] [Long baseline optical interferometric imaging with active phase stabilization](https://arxiv.org/abs/2607.12167)
...
### [9] [Selective avoidance of multiple line-of-sight obstacles at 130~m using locally bending space-time wave packets](https://arxiv.org/abs/2607.12311)
...
### [10] [Peak-Decomposition-Free Inverse Metrology of Hyperspectral Moiré Photoluminescence](https://arxiv.org/abs/2607.12325)
...
### [11] [Direct Observation of Nanoscale Chiral Light-Matter Interactions Governed by Optical Chirality](https://arxiv.org/abs/2607.12435)
...
### [12] [Nanoparticle Arrays for Efficient Organic Light-Emitting Diode Emission Management](https://arxiv.org/abs/2607.12635)
...
### [13] [Collective-State Preparation in a Subwavelength Triangular Trimer Using SUPER Excitation](https://arxiv.org/abs/2607.12665)
...
### [14] [Twist Engineering for Reconfigurable Optical and Optoelectronic Devices](https://arxiv.org/abs/2607.12754)
...
### [15] [Symmetry-Informed Deep Learning for Electromagnetic Scattering](https://arxiv.org/abs/2607.12810)
...
### [16] [Phase Angle and Effective Second-Harmonic Generation Coefficient in Uniaxial Crystal](https://arxiv.org/abs/2607.12851)
*Yisheng Song*
...
### [17] [Wichmann-Kroll Correction to the Interelectronic Interaction in He- and Li-Like Ions](https://arxiv.org/abs/2607.12168)
...
### [18] [Defect assignment of the clock site in $^{229}\text{Th:CaF}_2$](https://arxiv.org/abs/2607.12202)
...
### [19] [Coherence enhancement of Rydberg polaritons](https://arxiv.org/abs/2607.12513)
...
### [20] [Optically Derived Radio-Frequency Benchmark in Methanol: A Sub-kHz Reference for Astrophysical Tests of Fundamental Physics](https://arxiv.org/abs/2607.12533)
...
### [21] [A cryogenic neutral-atom platform with full optical access and 2-hour trap lifetime](https://arxiv.org/abs/2607.12988)
...
### [22] [High-fidelity entanglement of polar molecules by dynamic geometric control](https://arxiv.org/abs/2607.13008)
...
### [23] [A Collocated Boris Integrator in Flux Coordinates: Balancing Accuracy, Conservation, Cost and Robustness](https://arxiv.org/abs/2607.12272)
...
### [24] [Single-Shot High-Energy Muon and Particle Radiography with a Multi-GeV Laser-Wakefield-Accelerator-Driven Source](https://arxiv.org/abs/2607.12984)
...
### [25] [Integrated 3D fully kinetic simulation of field-reversed-configuration formation with embedded coils](https://arxiv.org/abs/2607.11908)
*Bowen Zhu,Jian Wu*
...
### [26] [Benchmarking Sensor Robustness in Plasma Diagnostic Models: A Systematic Evaluation on TokaMark](https://arxiv.org/abs/2607.11915)
*Neerav Gupta*
...
### [27] [Exact Solution of the Direct and Inverse Dynamo Problem in the Expanding Plasma Ball](https://arxiv.org/abs/2607.12194)
*Yurii V. Dumin*
...
### [28] [Nonlinear Tearing Modes in Current-Vortex Sheets](https://arxiv.org/abs/2607.12291)
...
### [29] [Full-Path Nonlinear Modeling of Microwave Power Transmission Through Ionospheric Plasma for Space Solar Power Station](https://arxiv.org/abs/2607.12294)
...
### [30] [Radiation reaction measurements via single-shot energy-loss determination in high-intensity laser-electron collisions](https://arxiv.org/abs/2607.12439)
...
### [31] [Impact of Residual Angular Chirp in a Petawatt-class Laser System on Laser-driven Proton Acceleration](https://arxiv.org/abs/2607.12451)
...
### [32] [First reduced model for integrated computations of helicon wave heating and current drive in magnetic fusion plasmas](https://arxiv.org/abs/2607.12512)
...
### [33] [On the transition to large fluxes and access to second stability in gyrokinetic simulations of electromagnetic turbulence in STEP](https://arxiv.org/abs/2607.12682)
...
### [34] [A new model for runaway electron transport based on chaotic Hamiltonian systems](https://arxiv.org/abs/2607.12905)
...
### [35] [A Shortcut to Statistically Steady-State Turbulence with Flow Matching](https://arxiv.org/abs/2607.13022)
