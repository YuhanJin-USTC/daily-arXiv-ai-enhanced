...
### [1] [Perturbation Theory for Translating Oblate-Spheroidal Droplets with Internal Circulation](https://arxiv.org/abs/2609.19193)
*William A. Sirignano*
...
### [2] [The Level Set Ensemble Kalman Filter: Sequential Data Assimilation for Flows With Shocks](https://arxiv.org/abs/2609.19314)
...
### [3] [Fredholm Backstepping with Heymann Pre-Feedback for Linearized Navier--Stokes 2D Channel](https://arxiv.org/abs/2609.19331)
*Miroslav Krstic*
...
### [4] [How universal are warm turbulent cascades?](https://arxiv.org/abs/2609.19432)
...
### [5] [Wake interactions drive synchronized vortex merging in a hovering quadcopter](https://arxiv.org/abs/2609.19507)
...
### [6] [Well-posedness of neural turbulence closures and tangent dissipation](https://arxiv.org/abs/2609.19647)
...
### [7] [Experimental study of the impact dynamics of polymeric hollow droplets](https://arxiv.org/abs/2609.19667)
...
### [8] [Mixed-precision GPU algorithms for efficient turbulent flow simulations with Raviart-Thomas finite elements](https://arxiv.org/abs/2609.19828)
...
### [9] [Mean flow scaling in stably stratified temporally developing turbulent boundary layers](https://arxiv.org/abs/2609.19935)
...
### [10] [Universal mapping of drop impact spreading from wetting to Leidenfrost regimes](https://arxiv.org/abs/2609.20259)
...
### [11] [Three-dimensional shock-weak-discontinuity interactions: curvature deposition and post-shock flow response](https://arxiv.org/abs/2609.20289)
...
### [12] [Solutions of the Navier-Stokes Equation Through Affine Transformations: The Triad Triplet](https://arxiv.org/abs/2609.20710)
...
### [13] [Scalable Production of Lead-212 and Actinium-225 Generators with Fusion Neutrons](https://arxiv.org/abs/2609.19166)
...
### [14] [Efficient laser ion acceleration in near-critical density plasmas in the picosecond pulse regime](https://arxiv.org/abs/2609.19571)
...
### [15] [Indirect-Drive Fusion Target Design for Commercial Fusion Energy](https://arxiv.org/abs/2609.19752)
...
### [16] [Gradient-Based Construction of Collisionless Steady-State Guiding-Center Distributions in Tokamaks and Stellarators](https://arxiv.org/abs/2609.19953)
*Jingyi Yu,Chang Liu*
...
### [17] [Experimental setup for testing nanocalorimeter sensors as a plasma diagnostics tool](https://arxiv.org/abs/2609.20328)
...
### [18] [Time-resolved topology of aperiodically driven systems](https://arxiv.org/abs/2609.19348)
...
### [19] [Automatic Optical Alignment Using Projective Geometry](https://arxiv.org/abs/2609.19565)
...
### [20] [Rapidity-Coupled Spin Dynamics in Pulsed Laser Fields from Physics-Informed Neural Networks](https://arxiv.org/abs/2609.19756)
...
### [21] [Limits on the free-space group velocity of optical wave packets incorporating angular dispersion. Part~I, conventional angular dispersion: tutorial](https://arxiv.org/abs/2609.19576)
...
### [22] [Limits on the free-space group velocity of optical wave packets incorporating angular dispersion. Part~II, non-differentiable angular dispersion: tutorial](https://arxiv.org/abs/2609.19580)
*Layton A. Hall,Ayman F. Abouraddy*
...
### [23] [Voltage-Current-Emission Framework of Time-Resolved Electroluminescence](https://arxiv.org/abs/2609.19723)
...
### [24] [Aberration sensing in fluorescence microscopy using quantum correlations](https://arxiv.org/abs/2609.19806)
...
### [25] [Mo2TiC2Tx MXene Saturable Absorption for Neural Networks on a Chip](https://arxiv.org/abs/2609.19849)
...
### [26] [Broadband transverse mode directional couplers using partial Euler bends](https://arxiv.org/abs/2609.19933)
...
### [27] [Power-Bandwidth Scaling of Resonantly Coupled Soliton Microcombs](https://arxiv.org/abs/2609.19941)
...
### [28] [High-capacity computing with self-rectification nonlinear optical neural processor](https://arxiv.org/abs/2609.19981)
...
### [29] [Transient High-Harmonic Generation from Solids: From Spectroscopy and Control to Programmable Emission](https://arxiv.org/abs/2609.20085)
...
### [30] [Frequency Attraction and Repulsion in Lasers with Complex Mutual Coupling](https://arxiv.org/abs/2609.20132)
...
### [31] [Characterization of spatially inhomogeneous chirp in ultrashort multielectron beams via femtosecond hole burning](https://arxiv.org/abs/2609.20141)
...
### [32] [Path-Integrated Polarization Rotation Signatures in Subsea Networks: Cable Geometry Effects in 2023 Turkey Earthquakes](https://arxiv.org/abs/2609.20527)
...
### [33] [High-order correlations and ultrafast Wigner negativities in bright-squeezed-vacuum-driven high-harmonic generation](https://arxiv.org/abs/2609.20559)
...
### [34] [Quantum Battery Enhancement via Degenerate Optical Parametric Amplifier and Common Reservoirs](https://arxiv.org/abs/2609.20613)
...
### [35] [A Simplified Model for Linear Mode Coupling in Multimode Fibers with Experimental Assessment](https://arxiv.org/abs/2609.20617)
...
### [36] [Volumetric Evanescent Edge Coupling for Fiber-to-Chip Optical I/O](https://arxiv.org/abs/2609.20686)
...
### [37] [Mollified-sharp decomposition: a probabilistic regularization of parametric POD for shock-bearing flows](https://arxiv.org/abs/2609.19532)
*Oliver T. Schmidt*
...
### [38] [Exergy-Anergy Representation of Turbomachine Performance Characteristics](https://arxiv.org/abs/2609.19816)
...
### [39] [Correlation-Free Transition Path Sampling through Shooting Point Generation Guided by Committor Learning](https://arxiv.org/abs/2609.20461)
...
### [40] [How durable are high-performance racing shoes?](https://arxiv.org/abs/2609.20485)
...
### [41] [How Does Distribution Shift Shape Pretraining Gains in Neural PDE Surrogates?](https://arxiv.org/abs/2609.20814)
...
### [42] [Observation of multiphoton entanglement in resonance fluoresce](https://arxiv.org/abs/2609.19808)
...
### [43] [Small-Angle Differential Cross Sections for Symmetrical Resonant Charge Exchange in Molecular Hydrogen](https://arxiv.org/abs/2609.20381)
...
### [44] [Effective Conservation and Bistability of Atomic Alignment under Strong Spin~Exchange](https://arxiv.org/abs/2609.20741)
*Anton K. Vershovskii*
