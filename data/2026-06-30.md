...
### [1] [Data-driven linear analysis of turbulent flows](https://arxiv.org/abs/2606.28569)
...
### [2] [A transition to elasto-viscoplastic turbulence in inertialess channel flow?](https://arxiv.org/abs/2606.28580)
...
### [3] [Confinement-Induced Suppression of Jet Drop Size by Bubble Bursting in Shallow Liquids](https://arxiv.org/abs/2606.28609)
...
### [4] [Quadruple decomposition of boundary vorticity flux](https://arxiv.org/abs/2606.28761)
...
### [5] [The intrinsic decomposition of vorticity dynamics on an arbitrarily moving and deforming boundary](https://arxiv.org/abs/2606.28763)
*Tao Chen*
...
### [6] [Premixed flames in a stagnation point flow under Darcy's law](https://arxiv.org/abs/2606.28909)
...
### [7] [Single-point statistical moments of the nonhomogeneous stochastic advection equation in the small correlation length limit](https://arxiv.org/abs/2606.29479)
...
### [8] [Monolithic kinetic algorithm for heterogeneous porous media systems using a continuous one-domain approach](https://arxiv.org/abs/2606.29619)
...
### [9] [A second-order unified gas-kinetic wave-particle method with enhanced mesh independence for hypersonic flows](https://arxiv.org/abs/2606.29853)
...
### [10] [Kriging and neural network models for pressure losses across perforated plates](https://arxiv.org/abs/2606.29628)
*Shuai Li*
...
### [11] [Gappy Reconstruction of Bubbly Flows by Guided Diffusion Models](https://arxiv.org/abs/2606.29843)
...
### [12] [Exact analytical solutions for the piston effect in supercritical fluids under post-acoustic approximation -- Short-time asymptotics, thermal penetration depth and comparison with the Spacelab D-2 experiments](https://arxiv.org/abs/2606.30006)
*Mátyás Szücs*
...
### [13] [Efficient Wall-Modeled High-Order Compact Gas-Kinetic Scheme for Compressible Turbulent Flows](https://arxiv.org/abs/2606.30061)
...
### [14] [Sudden expansion stability thresholds modified by lateral flows](https://arxiv.org/abs/2606.30269)
...
### [15] [Offline accuracy is not enough: closed-loop instability and stabilisation of a wall-sensor neural estimator in opposition control](https://arxiv.org/abs/2606.30484)
...
### [16] [Electrophoretic motion of a liquid droplet with Brinkman-screened internal hydrodynamics](https://arxiv.org/abs/2606.30515)
...
### [17] [Constructor-Theoretic Optical Time: Delay, Phase, and Fisher Distinguishability as Physical Tasks](https://arxiv.org/abs/2606.28586)
...
### [18] [PT-symmetric time delay oscillator modelling beyond the weak coupling limit via a scattering matrix formulation](https://arxiv.org/abs/2606.28595)
...
### [19] [Automated Vector-Scanning Spectroscopy for Large-Scale Characterization of Single Quantum Emitters](https://arxiv.org/abs/2606.28624)
...
### [20] [Reflection and Refraction at Nonlinear Temporal Boundaries in Synthetic Lattices](https://arxiv.org/abs/2606.28748)
...
### [21] [Continuous modal spectrum in nonreciprocal cavities](https://arxiv.org/abs/2606.28979)
...
### [22] [Optically dense nanowire metamaterials are transparent to polarization](https://arxiv.org/abs/2606.29019)
...
### [23] [$4π$ Combination of Gaussian Laser Beams](https://arxiv.org/abs/2606.29096)
*Hocine. Djellout*
...
### [24] [Peculiarities Of High-Speed Dynamics Of Two-Photon Absorption In Si Nanowire Waveguides](https://arxiv.org/abs/2606.29127)
...
### [25] [Coupling Efficiency and Laser-Induced Damage Threshold Characterization of an End-Capped Optical Fiber with a Sub-Nanosecond Pulsed Laser](https://arxiv.org/abs/2606.29383)
...
### [26] [Nanometric voids as optical antennas for rewritable momentum-engineered photonics in silicon](https://arxiv.org/abs/2606.29551)
...
### [27] [All-optical Synchronization of Breather Solitons in a Kerr Microresonator](https://arxiv.org/abs/2606.29736)
...
### [28] [Hessian sparsity-constrained self-supervised network for near-infrared single-photon single-pixel imaging](https://arxiv.org/abs/2606.29849)
...
### [29] [Ultrasensitive infrared-to-visible artificial vision via self-evolving projection guided by single-pixel detection](https://arxiv.org/abs/2606.29870)
...
### [30] [Broadband gain characterization of Co:MgF$_2$ for mid-infrared femtosecond pulse amplification](https://arxiv.org/abs/2606.29877)
...
### [31] [Bifurcation structure of soliton self-injection locking in microresonators](https://arxiv.org/abs/2606.29921)
...
### [32] [Dynamic Topological Light Control in Reconfigurable Non-Hermitian Metastacks](https://arxiv.org/abs/2606.29996)
...
### [33] [Arduino based interferometer stabilizer equipped with a digital lock-in amplifier](https://arxiv.org/abs/2606.30199)
...
### [34] [Comb-enabled spectral-domain image transport through perturbation-prone multimode fibers](https://arxiv.org/abs/2606.30203)
...
### [35] [Exact Helicity-Orbital Coupled Dynamics in Chiral Media: An Optical Dirac Framework for Photonic Rabi Oscillations](https://arxiv.org/abs/2606.30295)
...
### [36] [Quantization and Biphoton Statistics of k-Gap Solitons in Nonlinear Photonic Time Crystals](https://arxiv.org/abs/2606.30508)
...
### [37] [High-Performance Resilient Multi-GPU Hybrid Particle-in-Cell Monte Carlo Simulations at Scale](https://arxiv.org/abs/2606.28534)
...
### [38] [Semi-Implicit Stellarator Magnetohydrodynamics with Nodal Spectral Elements](https://arxiv.org/abs/2606.28613)
...
### [39] [Simulation Study of Coupling Effects Between a Hall Thruster and a Power Processing Unit](https://arxiv.org/abs/2606.28743)
...
### [40] [Detecting Quantum Stochastic Effects in Radiation Reaction via Laser-Produced Surface QED Plasmas](https://arxiv.org/abs/2606.29214)
...
### [41] [Harnessing Toroidal Neutral Flows to Enhance Divertor Particle Exhaust](https://arxiv.org/abs/2606.29800)
...
### [42] [Kinetic energy from the cubic sum rule of the dynamic structure factor](https://arxiv.org/abs/2606.30123)
...
### [43] [Fusion-power amplification by compressive hydrodynamic fluctuations](https://arxiv.org/abs/2606.30155)
...
### [44] [Low-energy positron scattering from metastable helium](https://arxiv.org/abs/2606.29253)
...
### [45] [Low-lying $D$ states in yttrium and actinium ions highly sensitive to variation of the fine structure constant](https://arxiv.org/abs/2606.29676)
*Akio Kawasaki*
...
### [46] [All-Optical Control of Birefringence in a Cold Atomic Ensemble](https://arxiv.org/abs/2606.30216)
...
### [47] [Modulation theory formulation of atomic light-matter interaction](https://arxiv.org/abs/2606.30427)
