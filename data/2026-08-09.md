...
### [14] [Millisecond-Scale Neural Operator Surrogates for Double-Null Free-Boundary Grad-Shafranov Equilibria](https://arxiv.org/abs/2608.05555)
*Plamen G. Krastev*
...
### [15] [BORAY-3D: A ray tracing code for three-dimensional magnetized plasma configurations](https://arxiv.org/abs/2608.05667)
...
### [16] [SafeDivertor: Faithful Divertor Heat Flux Reconstruction from Macroscopic Plasma State Signals via Time-Frequency Prior Exploitation](https://arxiv.org/abs/2608.05669)
...
### [17] [Polarization-Conditioned Fourier-enhanced DeepONet for Electric Field Reconstruction from EFISH Measurements](https://arxiv.org/abs/2608.05937)
...
### [18] [Wien-Filter Hamiltonian and Transfer Matrix](https://arxiv.org/abs/2608.06052)
*Volker Ziemann*
...
### [19] [Conceptual design of a mid-energy spin rotator for continuous-wave operation based on a compact multi-pi rosetta magnet](https://arxiv.org/abs/2608.06080)
*Volker Ziemann*
...
### [20] [The prediction of extreme uncertainty-production events in three-dimensional Navier-Stokes turbulence](https://arxiv.org/abs/2608.05208)
...
### [21] [Confinement-induced evolution and breakup of viscoelastic filaments in microfluidic coflows](https://arxiv.org/abs/2608.05343)
...
### [22] [Effect of Discharge on the Nonlinear Bar Growth: A Flume Experiment](https://arxiv.org/abs/2608.05593)
...
### [23] [Area and Perimeter Rules of Velocity Circulation in Two-Dimensional Turbulence with Large-scale Absolute Equilibrium](https://arxiv.org/abs/2608.05617)
...
### [24] [Onsager-variational-principle-based Lattice Boltzmann Model For Three-phase Dielectric Fluid Flows](https://arxiv.org/abs/2608.05787)
...
### [25] [Drop Spray Electrification](https://arxiv.org/abs/2608.05828)
...
### [26] [Magnetic Dynamo Driven by Inertial Waves](https://arxiv.org/abs/2608.06086)
...
### [27] [Wave scattering around a submerged vertical permeable breakwater](https://arxiv.org/abs/2608.06089)
...
### [28] [From expansion to collapse: Bubble and continuum multiscale modeling in open-system magmas](https://arxiv.org/abs/2608.06181)
...
### [29] [VENUSS: a unified finite-element model of solidifying lava](https://arxiv.org/abs/2608.06199)
...
### [30] [Three-layer water flows: Dirichlet-Neumann operators and approximations](https://arxiv.org/abs/2608.06314)
...
### [31] [Large anomalous shifts of potassium-39 Feshbach resonances](https://arxiv.org/abs/2608.05512)
...
### [32] [A platform for nuclear symmetry-violation searches with laser-coolable molecules carrying spinful nuclei](https://arxiv.org/abs/2608.06138)
...
### [33] [Simulation of positronium laser cooling using the Lindblad master equation](https://arxiv.org/abs/2608.06160)
...
### [34] [Dual-Faraday-laser-pumped cesium beam clock with $7.7\times 10^{-13}/\sqrtτ$ frequency stability](https://arxiv.org/abs/2608.06169)
...
### [35] [Multiphysics tritium transport modelling of the ARC breeding blanket with FESTIM](https://arxiv.org/abs/2608.05398)
...
### [36] [Data-driven reconstruction of dynamical systems using Takens' Theorem, manifold learning, and universal function approximators](https://arxiv.org/abs/2608.05477)
