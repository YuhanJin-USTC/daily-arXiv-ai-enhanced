...
### [15] [Coupled simulation of plasma-surface interactions during early stages of vacuum arcing](https://arxiv.org/abs/2606.05893)
...
### [16] [Plasma wakefield dynamics of self-generated electron bunch trains](https://arxiv.org/abs/2606.06232)
...
### [17] [Exact solution of the Gaunt-modified Landau-Lifshitz equation in a plane wave](https://arxiv.org/abs/2606.05205)
...
### [18] [Behavior of kinetic instabilities in a dynamically forming resonant distribution](https://arxiv.org/abs/2606.05341)
...
### [19] [Implementation and Verification of Toroidal Resistive Wall Boundary Conditions in the PIXIE3D MHD code using a Boundary Integral Method](https://arxiv.org/abs/2606.05446)
...
### [20] [Optimization of EUV output by experimentally validated radiation-hydrodynamic simulations across a broad laser parameter space](https://arxiv.org/abs/2606.05948)
...
### [23] [Role of boundary conditions on dam-break flow across an obstacle and controlling damage of structures](https://arxiv.org/abs/2606.05580)
...
### [24] [Topographic shielding of coastal zones and infrastructure against high tide](https://arxiv.org/abs/2606.05585)
*P. C. Harisankar,Tapas Sil*
...
### [25] [Stochastic Multiscale Reconstruction of Lagrangian Turbulence via Guided Diffusion Models](https://arxiv.org/abs/2606.05783)
...
### [26] [Sub-Kolmogorov Intermittency and Multifractal Dissipation in Multiphase Turbulence](https://arxiv.org/abs/2606.05788)
...
### [27] [High-order thermodynamic nonequilibrium in three-dimensional compressible flows: Kinetic moment closure and multigradient coupling](https://arxiv.org/abs/2606.05938)
...
### [28] [Multiple critical Froude numbers for the centrifugal effects on heat transport in rotating Rayleigh-Bénard convection](https://arxiv.org/abs/2606.06116)
...
### [29] [Wall Shear Stress Reconstruction from Concentration: Differentiable Physics and Physics-Informed Neural Networks](https://arxiv.org/abs/2606.06313)
...
### [30] [Deep reinforcement learning with spatial and temporal awareness for active boundary control of buoyancy-driven convection](https://arxiv.org/abs/2606.06191)
...
### [31] [Flapping instability of elastic disks in Stokes flows](https://arxiv.org/abs/2606.06215)
...
### [32] [Drag reduction or reward hacking? Recurrent multi-agent reinforcement learning that earns its reward](https://arxiv.org/abs/2606.06227)
*Giorgio Maria Cavallazzi,Miguel Pérez-Cuadrado,Alfredo Pinelli*
...
### [33] [A high-order Fourier Continuation (FC)-based spectral incompressible Smoothed Particle Hydrodynamics (ISPH) scheme for general boundary conditions in wall-bounded domains](https://arxiv.org/abs/2606.06247)
...
### [34] [Turbulence-based parametrization of animal flight](https://arxiv.org/abs/2606.06269)
...
### [35] [An experimental study on the heat transport in porous media convection](https://arxiv.org/abs/2606.06331)
...
### [36] [Statistical orientation and distribution of columnar ice crystals in turbulent flows](https://arxiv.org/abs/2606.06374)
...
### [37] [Finite Element-Based Material Learning via Automatic Differentiation: Learning constitutive neural network models from full-field deformation data](https://arxiv.org/abs/2606.05199)
...
### [38] [A differentiable machine learning small-angle X-ray scattering analysis framework for structure elucidation of lipid nanoparticles](https://arxiv.org/abs/2606.05200)
...
### [39] [Multi-Fidelity Learning with Shallow Recurrent Decoders for Reactor Physics](https://arxiv.org/abs/2606.05202)
...
### [40] [Newton's Identity in Finite-Bead Fermionic Partition Function](https://arxiv.org/abs/2606.05442)
...
### [41] [Towards stable and accurate electron dynamics via neural network based time-dependent variational Monte Carlo](https://arxiv.org/abs/2606.05850)
