...
### [3] [Wavefront Sensor for Laser Beams Based on Reweighted Amplitude Flow Algorithm](https://arxiv.org/abs/2602.10998)
...
### [4] [Coherent Virtual Absorption in Dielectric Slabs: A Temporal Analysis of Symmetric and Asymmetric Geometries](https://arxiv.org/abs/2602.11067)
...
### [5] [TokaMark: A Comprehensive Benchmark for MAST Tokamak Plasma Models](https://arxiv.org/abs/2602.10132)
...
### [6] [Bridging the Kinetic-Fluid Gap: Ion-Driven Magnetogenesis to Prime Cosmic Dynamos](https://arxiv.org/abs/2602.10447)
*X. Liu,D. Wu,J. Zhang*
...
### [7] [Fully nonlinear phenomenology of the bump-on-tail (BOT) instability with drag, diffusion and Krook relaxation](https://arxiv.org/abs/2602.10642)
...
### [8] [Generation and control of Doppler harmonics approaching $10^{22}\textrm{W/cm}^2$ on plasma mirrors](https://arxiv.org/abs/2602.10709)
...
### [9] [Collisionless relaxation as the origin of the anisotropic, non-thermal, and multi-temperature momentum distributions observed in space plasmas](https://arxiv.org/abs/2602.11053)
...
### [10] [Electron-impact cross sections for dissociation processes of vibrationally excited CH radical](https://arxiv.org/abs/2602.10649)
...
### [11] [High-voltage generation system for a traveling-wave Stark decelerator](https://arxiv.org/abs/2602.10681)
...
### [12] [Noise-balanced multilevel on-the-fly sparse grid surrogates for coupling Monte Carlo models into continuum models with application to heterogeneous catalysis](https://arxiv.org/abs/2602.11006)
...
### [13] [Comparison of the potential energy for different equilibrium configurations of symmetric and asymmetric floating drops](https://arxiv.org/abs/2602.10120)
...
### [14] [Validation and extension of an analytic momentum availability model for the two-scale momentum theory of wind farm flows](https://arxiv.org/abs/2602.10126)
...
### [15] [PEST: Physics-Enhanced Swin Transformer for 3D Turbulence Simulation](https://arxiv.org/abs/2602.10150)
...
### [16] [Comparing surface and deep horizontal distributions of depth-keeping particles in shallow fluid layers](https://arxiv.org/abs/2602.10318)
...
### [17] [Towards a full-scale version of Yakhot's model of strong turbulence](https://arxiv.org/abs/2602.10327)
*Christoph Renner*
...
### [18] [Transonic Buffet Modeling via Invariant Manifolds](https://arxiv.org/abs/2602.10363)
...
### [19] [Accurate simulation of pulled and pushed fronts in the nonautonomous Fisher-KPP equation](https://arxiv.org/abs/2602.10475)
...
### [20] [Effect of Reynolds number on triboelectric particle charging in turbulent channel flow](https://arxiv.org/abs/2602.10761)
...
### [21] [Critical Reynolds Number as a Topological Phase Transition in Adaptive Fractional Hydrodynamics](https://arxiv.org/abs/2602.10912)
*Jose I. H. Lopez*
...
### [22] [The search for the gust-wing interaction \emph{textbook}](https://arxiv.org/abs/2602.10968)
