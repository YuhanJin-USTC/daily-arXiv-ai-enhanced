...
### [1] [Continuous-wave nuclear laser absorption spectroscopy of Thorium-229](https://arxiv.org/abs/2604.16640)
...
### [2] [Observation of intrastate and interstate facilitation between Rydberg S, P and D levels](https://arxiv.org/abs/2604.17404)
...
### [3] [Coherent terahertz field tomographic imaging in warm Rydberg vapors](https://arxiv.org/abs/2604.18440)
...
### [4] [Physics-Informed Latent Space Dynamics Identification for Time-Dependent NLTE Atomic Kinetics](https://arxiv.org/abs/2604.16664)
...
### [5] [Thermal Effects on Buneman Instability: A Vlasov-Poisson Study](https://arxiv.org/abs/2604.17113)
...
### [6] [Research on mode transition of micro-newton-level cusped field Hall thruster](https://arxiv.org/abs/2604.17903)
...
### [7] [Autoregressive prediction of 2D MHD dynamics inferred from deep learning modeling](https://arxiv.org/abs/2604.18221)
...
### [9] [Gaussian Field Representations for Turbulent Flow: Compression, Scale Separation, and Physical Fidelity](https://arxiv.org/abs/2604.16449)
...
### [10] [Velocity field within a vortex ring with a large elliptical cross section](https://arxiv.org/abs/2604.16494)
*T. S. Morton*
...
### [11] [Effect of gap width on turbulent transition in Taylor-Couette flow](https://arxiv.org/abs/2604.16495)
...
### [12] [Design Optimization of eVTOL Propellers using a Viscous-Extension Discrete Vortex Method](https://arxiv.org/abs/2604.16501)
...
### [13] [On the hydrodynamic behaviour of the immersed boundary -- lattice Boltzmann method for wetting problems](https://arxiv.org/abs/2604.17463)
...
### [14] [The inviscid Euler limit as a critical boundary for moment-based aerodynamic system identification](https://arxiv.org/abs/2604.16633)
*Sarasija Sudharsan*
...
### [15] [Directed droplet motion -- Its versatile nature and anticipated applications](https://arxiv.org/abs/2604.16974)
...
### [16] [FlowRefiner: Flow Matching-Based Iterative Refinement for 3D Turbulent Flow Simulation](https://arxiv.org/abs/2604.17149)
...
### [17] [Assessment of RANS Modeling of Jet Interaction in Fan-Array Wind Generator Flows](https://arxiv.org/abs/2604.17352)
...
### [18] [Drag reduction regimes in air lubrication](https://arxiv.org/abs/2604.17636)
...
### [19] [Tangential and normal partial slip at the liquid-fluid interfaces: application to a small liquid droplet, gas bubble, and aerosol](https://arxiv.org/abs/2604.17793)
...
### [20] [Coherent structures in axis-switching elliptical jets](https://arxiv.org/abs/2604.17851)
...
### [21] [Information decomposition for disentangled and interpretable manifold learning of fluid flows via variational autoencoders](https://arxiv.org/abs/2604.18059)
...
### [22] [Simultaneous Dual-Plane Multi-Write-Spot Two-Photon Polymerization Using a Single Diffractive Optical Element](https://arxiv.org/abs/2604.16569)
...
### [23] [Revealing full molecular orientation distributions in organic thin films by nonlinear polarimetry](https://arxiv.org/abs/2604.16692)
...
### [24] [Flat optics for analog computing: from fundamental mechanisms to advanced meta-processors](https://arxiv.org/abs/2604.16849)
...
### [25] [High precision micro-optical elements on fiber facets via focused-ion beam machining](https://arxiv.org/abs/2604.18426)
...
### [26] [Subwavelength Coherent Scaling of High-Order Nonlinear Light Generation in Bulk Monolayer MoS2 Thin Films](https://arxiv.org/abs/2604.17088)
...
### [27] [Line-scanning Brillouin microscopy with multiplexed two-stage VIPA spectrometer](https://arxiv.org/abs/2604.17101)
...
### [28] [A Digital Optical Switch Based on a Thermally Tuned Multimode Waveguide Grating Filter](https://arxiv.org/abs/2604.17263)
...
### [29] [Observation of full momentum bandgap in photonic time crystals](https://arxiv.org/abs/2604.17408)
...
### [30] [Leaky-Wave Antenna Analysis using Multi-Modal Network Theory with Open Periodic Boundaries](https://arxiv.org/abs/2604.17571)
...
### [31] [Universal compression of wave fields in weakly scattering media](https://arxiv.org/abs/2604.17617)
...
### [32] [From Flat-Optics Concept to Qualified Hardware: Skills Map for the Meta-Optics and Diffractive Optics Workforce](https://arxiv.org/abs/2604.17618)
...
### [33] [Pulsed Optical Injection Steering in Multistable Semiconductor Laser Arrays under Correlated Noise](https://arxiv.org/abs/2604.17678)
...
### [34] [Poling-free Spontaneous Parametric Down Conversion without for Silicon Carbide and Lithium Niobate photonics](https://arxiv.org/abs/2604.17723)
...
### [35] [Unidirectional Inter-Axial Coupling and Spontaneous Cooling in a~Non-Hermitian Dynamics of a~Levitated Particle](https://arxiv.org/abs/2604.17985)
...
### [36] [A Slow-Time Receiver Interface for Turbulent Free-Space Quantum Polarization Links](https://arxiv.org/abs/2604.18127)
...
### [37] [Enhanced Mid-Infrared Single-Photon Detection with Antenna-Coupled Superconducting Nanowires](https://arxiv.org/abs/2604.18155)
...
### [38] [Programmable recirculating bricks mesh architecture for photonic neural networks](https://arxiv.org/abs/2604.18160)
*Jacek Gosciniak*
...
### [39] [Notes on Images and Communication](https://arxiv.org/abs/2604.18308)
*Denis Martynov*
...
### [40] [Fast dynamic wavefront correction for multi-photon microscopy with a high resolution MEMS phase-only modulator](https://arxiv.org/abs/2604.18342)
...
### [41] [NEMO: Neural Electro-Mechano-Optic Sensors for Multiplexed Neural Interfaces](https://arxiv.org/abs/2604.18384)
...
### [42] [Multiscale phase dynamics and $2π$ phase kinks in injection-locked optoelectronic oscillators with large delay](https://arxiv.org/abs/2604.18499)
...
### [43] [Continuous Wave Second Harmonic Generation from an Etchless Lithium Niobate Resonant Metasurface](https://arxiv.org/abs/2604.18501)
...
### [44] [Tunable Optical Torque by Asymmetry-Induced Spin-Hall Effect in Tightly Focused Spinless Gaussian Beams](https://arxiv.org/abs/2604.18514)
...
### [45] [Two-Dimensional Tomography and Fourier Analysis](https://arxiv.org/abs/2604.18541)
...
### [46] [Modelling Gas-Phase Reaction Kinetics with Guided Particle Diffusion Sampling](https://arxiv.org/abs/2604.16461)
...
### [47] [Coarse-Grained Dynamics with Spatial Disorder and Non-Markovian Memory](https://arxiv.org/abs/2604.16825)
...
### [48] [Consistent control of energy dissipation in non-spherical particle contact via a structure-preserving formulation](https://arxiv.org/abs/2604.18494)
*Y. T. Feng*
...
### [49] [Comment on "Angular momentum dynamics of vortex particles in accelerators''](https://arxiv.org/abs/2604.16544)
*S. S. Baturin*
...
### [50] [Achromatic optics using nonlinear plasma lenses for beam-quality preservation between plasma-accelerator stages](https://arxiv.org/abs/2604.17605)
...
### [51] [Bridging Metal Additive Manufacturing and RF Accelerator Design: Development of a 704.4 MHz Crossbar H-Mode Linac for Efficient Beam Acceleration](https://arxiv.org/abs/2604.18154)
...
### [52] [High-power attosecond X-ray free-electron lasers: physics and design strategy](https://arxiv.org/abs/2604.18447)
...
### [53] [pyTRAIN -- a modern TRAIN implementation](https://arxiv.org/abs/2604.18466)
