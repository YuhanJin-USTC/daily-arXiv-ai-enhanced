...
### [5] [Frugal Effective Models for Nanophotonic Scattering: Optimizing Global Polarizability Matrices for Metasurface Design](https://arxiv.org/abs/2609.04863)
...
### [6] [Ultrafast Control of Lifetime in High Q Anisotropic Plasmon Polaritons](https://arxiv.org/abs/2609.04403)
...
### [7] [Nonlinear Photoemission for Bright Beams in X-Band Photoinjectors](https://arxiv.org/abs/2609.04571)
...
### [8] [Band Gaps and Localization of Surface Waves at Hyperbolic Material and Topological Insulator Interfaces](https://arxiv.org/abs/2609.04587)
...
### [9] [High-Performance Photonic Crystal Biosensors using Sub-wavelength Nanopillars](https://arxiv.org/abs/2609.04656)
...
### [10] [Research and simulation of analytical polarization control enabled by optical computing on an integrated photonics chip](https://arxiv.org/abs/2609.04666)
...
### [11] [Modulation-Frequency Dependence of Spatial Resolution in Optical Correlation-Domain Reflectometry](https://arxiv.org/abs/2609.04818)
...
### [12] [Relaxing Coherence Requirements on Laser Sources for Nanoscopy through Optical Fiber Technique](https://arxiv.org/abs/2609.04924)
...
### [13] [Sub-2-Cycle, Terawatt Pulses via Double-Stage Multi-Pass Cell Compression of an Yb Laser](https://arxiv.org/abs/2609.04989)
...
### [14] [Fisher-information retention under local driving in non-Hermitian feed-forward chains](https://arxiv.org/abs/2609.04996)
...
### [15] [Fabrication-Aware Design of a Hybrid Metasurface-Bragg Mirror for Low-Noise Precision Optics](https://arxiv.org/abs/2609.05001)
...
### [16] [Bounds on Propagation Constants in Dielectric Gratings](https://arxiv.org/abs/2609.05052)
*Ehsan Faghihifar*
...
### [17] [Screening bolt loosening in a four-bolt plate with global FRF correlation and local FRAC maps from full-field laser Doppler vibrometry](https://arxiv.org/abs/2609.05218)
...
### [18] [Analytical model for polarization transfer during gas-phase collision events in spin-exchange optical pumping: Spin-$\frac{1}{2}$ $^{129}$Xe versus spin-$\frac{3}{2}$ $^{131}$Xe](https://arxiv.org/abs/2609.04743)
...
### [19] [Dead-zone-free free-induction-decay alkali-metal atomic magnetometer](https://arxiv.org/abs/2609.04847)
...
### [20] [Reduced Precision Diffusion Synthetic Acceleration for S$_N$ Neutron Transport in LLNL's ARDRA using Hypre](https://arxiv.org/abs/2609.04451)
...
### [21] [An Aeroelastic Solver Integrating Reformulated-Vortex-Particle and Finite-Element Methods across Non-Conforming Interfaces](https://arxiv.org/abs/2609.05243)
...
### [24] [Coherent-structure dynamics in wall turbulence from state-space trajectories](https://arxiv.org/abs/2609.04515)
...
### [25] [Quasi-Two-Dimensional Simulation of a Rotating Detonation Engine Combustor and Injector](https://arxiv.org/abs/2609.04519)
...
### [26] [Lagrangian dynamics unveil polymer conformation in viscoelastic flows](https://arxiv.org/abs/2609.04538)
...
### [27] [Transport fidelity and domain of validity of compact Gaussian kinetic representations for rarefied flows](https://arxiv.org/abs/2609.04606)
*Ehsan Roohi*
...
### [28] [Elastic turbulence in straight confined geometries](https://arxiv.org/abs/2609.04617)
...
### [29] [Homoclinic-shedding in the steady forced water-wave problem](https://arxiv.org/abs/2609.04888)
...
### [30] [Unveiling wing turbulence dynamics through explainable deep learning](https://arxiv.org/abs/2609.05015)
...
### [31] [Fisher Information Dynamics: A Kinematic Framework for Phase Space Ordering with Applications to Shock Layers and Turbulence](https://arxiv.org/abs/2609.05021)
*Yingchuan Wu*
...
### [32] [Design optimization, commissioning, and uncertainty analysis of the quadrupole resonator system at Jefferson Lab for SRF material characterization](https://arxiv.org/abs/2609.04293)
...
### [33] [HELIX: a hybrid envelope-multiparticle linac code with differentiable space-charge optimization](https://arxiv.org/abs/2609.04421)
*Abhishek Pathak*
...
### [34] [Indirect Integration of Longitudinal and Transverse Wake Potentials for Unequal Beam Pipes and Arbitrary Beam Velocity](https://arxiv.org/abs/2609.05196)
