...
### [8] [Magic-wavelength matter-wave interferometry with optical clock states](https://arxiv.org/abs/2608.17576)
...
### [9] [Optically Writable Atomic Vapor Memory as a Substrate for Optical Reservoir Computing](https://arxiv.org/abs/2608.17807)
...
### [10] [Ultrafast and high resolution spatial light modulation for cold atoms](https://arxiv.org/abs/2608.18071)
...
### [11] [Validating direct solvers for Newton's gravitational N-body problem, and the systematic comparison between IEEE floating point and Posits](https://arxiv.org/abs/2608.17032)
...
### [12] [Agentic Porting, Construction and Initial Verification and Validation of Libraries within the Open Source Unified TRAnsient Multi-Phase Advanced Reactor simulation Kit (Outram Park) Part I: Thermal Hydraulics](https://arxiv.org/abs/2608.17504)
...
### [13] [Probabilistic Inverse Modeling of Contaminant Transport via a Conditioned-on-Design Bayesian Physics Informed Neural Network](https://arxiv.org/abs/2608.17591)
...
### [14] [Investigation of the Asymptotic Properties of Active Impedance in Large Finite Array Antennas](https://arxiv.org/abs/2608.17844)
...
### [15] [Bayesian Optimization of Molybdenum-99 Production by Laser Wakefield Acceleration Using Coupled PIC and Monte Carlo Simulations](https://arxiv.org/abs/2608.17119)
...
### [16] [Field deployment of a laser wakefield accelerator for on-site application](https://arxiv.org/abs/2608.17554)
...
### [17] [Turbulent Microscale Flow Field Prediction In Porous Media Using Convolutional Neural Networks](https://arxiv.org/abs/2608.17062)
...
### [18] [Autonomous route to the strange attractor: the many life stages of the chaotic bubblewheel](https://arxiv.org/abs/2608.17169)
...
### [19] [Noise-separated evidence for a slow collective displacement in a rarefied hypersonic bow-shock layer](https://arxiv.org/abs/2608.17285)
...
### [20] [Optimal control of a swimming robot based on Purcell's microswimmer model](https://arxiv.org/abs/2608.17455)
...
### [21] [Steady transport of active particles under continuous release in confined shear flow](https://arxiv.org/abs/2608.17494)
...
### [22] [Roughness-controlled layer in oscillatory turbulent boundary layers over densely packed uniform roughness](https://arxiv.org/abs/2608.17543)
...
### [23] [Modelling flow-driven pore closure of weakening poroelastic media](https://arxiv.org/abs/2608.17581)
...
### [24] [Towards Rapid Prototyping of Spray Injectors: A Regime-Agnostic Neural Operator Surrogate for Gas-Liquid Interface Evolution](https://arxiv.org/abs/2608.17825)
...
### [25] [A Residual Learning Approach for Unsteady Aerodynamic Load Prediction](https://arxiv.org/abs/2608.17894)
...
### [26] [Erbium-implanted tellurite waveguides with low-temperature post-implantation activation and signal enhancement](https://arxiv.org/abs/2608.17028)
...
### [27] [Nanophotonic dispersion engineering in tantala-based microresonators with ultralow-loss claddings](https://arxiv.org/abs/2608.17277)
...
### [28] [Inductively Scalable, Single-Step Neural Surrogates for Wave-Scattering Inverse Problems](https://arxiv.org/abs/2608.17344)
...
### [29] [Spectral design of confining optical structures by supersymmetry techniques](https://arxiv.org/abs/2608.17346)
...
### [30] [Machine Learning-Assisted Analysis and Inverse Design of Prism-Based Surface Plasmon Resonance Sensors](https://arxiv.org/abs/2608.17368)
...
### [31] [Fiber Nonlinearity Compensation of Coherent Signals Using Deep Photonic Reservoir Computer](https://arxiv.org/abs/2608.17419)
...
### [32] [The vanishing distance: a practical range boundary for dynamic wavefront shaping](https://arxiv.org/abs/2608.17551)
...
### [33] [Parallel single-pixel imaging based on modulation region expansion and overlapping reconstruction](https://arxiv.org/abs/2608.17579)
...
### [34] [Body-of-Revolution Finite-Element Model of Plasmon-Enhanced Fluorescence](https://arxiv.org/abs/2608.17655)
...
### [35] [Real-time estimation of the transmission matrix of an atmospheric channel](https://arxiv.org/abs/2608.17696)
...
### [36] [Neutron Interferometers from Stacked Holographic Photopolymer Gratings](https://arxiv.org/abs/2608.17708)
...
### [37] [Robust Orbital Angular Momentum Transfer Using low-cost Diffractive Optics](https://arxiv.org/abs/2608.17816)
...
### [38] [Conservation of Pseudoangular Momentum in the Radiative Emission and Optical Excitation of Valley-Polarized Surface Lattice Resonances](https://arxiv.org/abs/2608.18005)
