...
### [1] [Laser stabilized to a room temperature cavity with AlGaAs coatings reaching $4.2 \times 10^{-17}$ fractional frequency instability](https://arxiv.org/abs/2607.01406)
...
### [2] [Influence of the Radial Index on the Stability of Laguerre-Gaussian Vortex Beams in Turbulent Media](https://arxiv.org/abs/2607.01397)
...
### [12] [Identical-Particle Symmetry-Enabled Complete Coherent Control of Ultracold Atomic and Molecular Collisions](https://arxiv.org/abs/2607.01620)
...
### [13] [Microwave shielding of ultracold polar molecules on the transition $\boldsymbol{n=1 \rightarrow 2}$](https://arxiv.org/abs/2607.02470)
...
### [14] [Verification and Performance Assessment of NuDEAL, a GPU-Accelerated Deterministic Transport Framework on Unstructured Meshes](https://arxiv.org/abs/2607.01591)
...
### [16] [A second-order diffusive-interface immersed boundary method for incompressible flow with phase change and moving interfaces](https://arxiv.org/abs/2607.01575)
...
### [17] [Comparative analysis of resistive immersed surface and immersed boundary methods for aortic valve simulation](https://arxiv.org/abs/2607.01662)
...
### [18] [Energy transfer, Intermittency and Mixing in Shear-Driven Stratified Turbulence](https://arxiv.org/abs/2607.01981)
...
### [19] [Patagium and tail morphology shape aerodynamic performance and control authority in gliding-mammal-inspired wings](https://arxiv.org/abs/2607.02246)
...
### [20] [Effect of surfactant kinetics on the wetting following the drop impact onto rough surfaces](https://arxiv.org/abs/2607.02309)
...
### [21] [Pressure-drop localization and momentum insulation in liquid-gas coexistence Poiseuille flow](https://arxiv.org/abs/2607.02310)
...
### [22] [An Inner-Scaled Linear Contribution to Wall-Pressure Variance at High Reynolds Number](https://arxiv.org/abs/2607.02395)
...
### [23] [Direct numerical simulations of turbulent drag reduction via piezoelectric actuation](https://arxiv.org/abs/2607.02398)
...
### [24] [Understanding Non-Gaussian Chorus Wave Statistics via the Benjamin-Feir Index](https://arxiv.org/abs/2607.01475)
...
### [25] [Development of a thin-target hard X-ray bremsstrahlung detection system to study confined runaway electrons in Aditya-U Tokamak](https://arxiv.org/abs/2607.01488)
...
### [26] [Brilliant multi-GeV Compton gamma-ray source seeded by a photon accelerator](https://arxiv.org/abs/2607.02373)
