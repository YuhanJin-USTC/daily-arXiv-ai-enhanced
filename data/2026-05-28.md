...
### [1] [Longitudinal beam dynamics with active cavity systems](https://arxiv.org/abs/2605.27613)
...
### [2] [Beam Sources for 10 TeV Wakefield Collider](https://arxiv.org/abs/2605.27702)
...
### [3] [Fully coherent short wavelength free-electron laser driven by a single sub-microjoule seed](https://arxiv.org/abs/2605.27821)
...
### [4] [A Method for Passive Streaker LPS Reconstruction](https://arxiv.org/abs/2605.28541)
...
### [5] [Application of Reinforcement Learning for Multigroup Energy Grid Optimization for Neutron Transport Criticality Problems](https://arxiv.org/abs/2605.27895)
...
### [6] [Surface Contact Approximation for Magneto-Thermal Finite Element Analysis of No-Insulation HTS Coils](https://arxiv.org/abs/2605.28574)
...
### [7] [Compact Experimental Negative TriAngUlarity Reactor (CENTAUR): A design study for a compact, affordable breakeven tokamak](https://arxiv.org/abs/2605.27549)
...
### [8] [Analytical theory of coherent radiation and radiation friction in laser-plasma collisions](https://arxiv.org/abs/2605.28370)
...
### [9] [A cavity-less architecture for high-power integrated frequency combs](https://arxiv.org/abs/2605.27528)
...
### [10] [Exceptional points in diamond optomechanics](https://arxiv.org/abs/2605.27536)
...
### [11] [18-dB on-chip vacuum squeezing in an adaptively poled lithium niobate waveguide](https://arxiv.org/abs/2605.27607)
...
### [12] [Raman spectroscopy at metal interfaces: A numerical study of the strong coupling regime](https://arxiv.org/abs/2605.27609)
...
### [13] [Exciton-Tunable Phase Control and Superstrong Coupling Through Multimode Polariton Engineering in Planar Waveguides](https://arxiv.org/abs/2605.27714)
...
### [14] [High-speed mid-infrared imaging via nonlinear multiplexed detection](https://arxiv.org/abs/2605.27847)
...
### [15] [Mid-infrared edge-enhanced imaging via angle-selective nonlinear filtering](https://arxiv.org/abs/2605.27855)
...
### [16] [Mid-Infrared Single-Photon Compressive Spectroscopy](https://arxiv.org/abs/2605.27890)
...
### [17] [Omnidirectional wave impedance matching and Goos-Hanchen shifts in non-Hermitian balanced positive-negative index metamaterials](https://arxiv.org/abs/2605.28031)
...
### [18] [Symmetry breaking by quantum light in solid-state high-harmonic generation](https://arxiv.org/abs/2605.28236)
...
### [19] [Universal zero-crosstalk photonic integration via slab-engineered mode hybridization](https://arxiv.org/abs/2605.28281)
...
### [20] [Polarimetric Backscattering Setup for Quantitative Scattering Parameters Retrieval](https://arxiv.org/abs/2605.28322)
...
### [21] [Simultaneous Measurement of Circular Dichroism and Circular Differential Scattering](https://arxiv.org/abs/2605.28458)
...
### [22] [Toward Micro-Endoscopy: Distal-Free, Configuration-Agnostic Focusing Through Multimode Fiber](https://arxiv.org/abs/2605.28506)
...
### [23] [Orbital Altermagnetic Photonic Crystal](https://arxiv.org/abs/2605.28656)
...
### [24] [Isotropic fabrication of centimeter-scale, low propagation-loss periodically poled lithium niobate nanophotonic waveguides for efficient second harmonic generation](https://arxiv.org/abs/2605.28689)
...
### [25] [A variability-aware simulation and design workflow for wafer-scale, heterogeneously integrated lithium niobate modulators](https://arxiv.org/abs/2605.28765)
...
### [26] [Radiative Response of Atomic Systems Illuminated with Approximate Spherical Vector Waves](https://arxiv.org/abs/2605.27558)
...
### [27] [Strong-field Photoionization: Analysis of Overlapping Above-Threshold Ionization and Laser-Assisted Photoemission Structures](https://arxiv.org/abs/2605.27603)
...
### [28] [Electron spectra from strong-field enhanced ionization in heavy water](https://arxiv.org/abs/2605.27612)
...
### [29] [Optical cycling on thorium monoxide (ThO) for an improved test of fundamental symmetries](https://arxiv.org/abs/2605.28509)
...
### [30] [Role of Metastable Dicationic Intermediates in the Breakup of CH$_4^{2+}$](https://arxiv.org/abs/2605.28628)
...
### [31] [A hybrid Volume of Fluid Phase-Field method for Direct Numerical Simulations of soluble surfactant-laden interfacial flows](https://arxiv.org/abs/2605.27534)
...
### [32] [Lagrangian Ellipsoid Diagnostics for Stochastic Hydrodynamics: Source--Sink Modeling of Deforming Particle Clouds](https://arxiv.org/abs/2605.27606)
*Michael Chertkov*
...
### [33] [Triggering of extreme events and coherent-structure modulation in wall-turbulence under cyclostationary forces](https://arxiv.org/abs/2605.27792)
...
### [34] [Direct Numerical Simulation of Vertical-Axis Wind Turbine Near-Wake Dynamics](https://arxiv.org/abs/2605.27626)
...
### [35] [Bow-shock instability in entry, descent, and landing vehicles under high-enthalpy conditions](https://arxiv.org/abs/2605.28357)
...
### [36] [CFDTwin: An open-source GUI and Python toolkit for POD-NN surrogate modeling of ANSYS Fluent simulations](https://arxiv.org/abs/2605.27725)
*Daniel Curl,Han Hu*
...
### [37] [Polymer extension at stagnation points governs flow thickening of polymer solutions in ordered porous media](https://arxiv.org/abs/2605.27731)
...
### [38] [Sparse POD Mode Selection and Manifold Dimensionality Reduction with Neural Networks](https://arxiv.org/abs/2605.27756)
...
### [39] [Liquid-fueled Oblique Detonation Stabilized by a Transverse Jet](https://arxiv.org/abs/2605.27871)
...
### [40] [Data-efficient semi-supervised learning for flow estimation using unlabelled probe data](https://arxiv.org/abs/2605.28245)
...
### [41] [Peristaltic pumping in short annular geometries: An experimental approach for studying Glymphatic flow](https://arxiv.org/abs/2605.28350)
...
### [42] [Parametric Subharmonic Instability in the Ocean Bottom Boundary Layer](https://arxiv.org/abs/2605.28555)
...
### [43] [An Architecture-Agnostic High-Order Discontinuous Galerkin Framework for Compressible Flows](https://arxiv.org/abs/2605.28627)
