...
### [1] [Shielded inner-shell transitions in atomic samarium for tests of fundamental physics](https://arxiv.org/abs/2605.22318)
...
### [2] [Inelastic collisions of fast charged particles with atoms. Relativistic plane-wave Born approximation](https://arxiv.org/abs/2605.22442)
*Francesc Salvat*
...
### [3] [Simulation of Rydberg Ionization in Atomic Beams for FIB Optimization](https://arxiv.org/abs/2605.22548)
...
### [4] [X-ray and extreme-ultraviolet spectra from collisions of Ar$^{18+}$ and O$^{8+}$ ions with neutrals](https://arxiv.org/abs/2605.22689)
...
### [5] [Solving forward and inverse wave scattering via boundary integral equations and deep learning. Applications to cloaking design](https://arxiv.org/abs/2605.21830)
...
### [6] [A path-finding algorithm for computing minimal-weight-matching centrosymmetry parameter](https://arxiv.org/abs/2605.22094)
*Vasily V. Pisarev*
...
### [7] [Conditional Neural Field based Reduced Order Model for Dynamic Ditching Load Prediction](https://arxiv.org/abs/2605.21499)
...
### [8] [Tracking water vapor homogeneous nucleation and droplet growth with spectroscopy and holography in a free expansion cloud chamber](https://arxiv.org/abs/2605.21509)
...
### [9] [Cilia-driven transport in confined ducts: an active porous media model](https://arxiv.org/abs/2605.21567)
...
### [10] [Study of flutter instability using the actuator line method for wind energy harvesting devices](https://arxiv.org/abs/2605.21596)
...
### [11] [On the wake region of high-Reynolds-number turbulent boundary layers subject to adverse pressure gradients](https://arxiv.org/abs/2605.21872)
...
### [12] [Vertical motion of a periodically driven floating disc](https://arxiv.org/abs/2605.21940)
...
### [13] [Modelling hydroelastic flexure of arbitrarily shaped ice shelves forced by long ocean waves](https://arxiv.org/abs/2605.22042)
...
### [14] [Full Turbulence Simulation of Channel Flow at $Re_τ \approx 1000$](https://arxiv.org/abs/2605.22107)
...
### [15] [N-Component Free Energy Lattice Boltzmann Method with Reduction Consistency and Global Momentum Conservation](https://arxiv.org/abs/2605.22214)
...
### [16] [Lagrangian single-particle, multi-particle and topological analyses in turbulent Rayleigh-Bénard convection](https://arxiv.org/abs/2605.22326)
...
### [17] [Perpendicular rod-airfoil aeroacoustics: experiments and modelling of interaction noise](https://arxiv.org/abs/2605.22546)
...
### [18] [Experimental investigation of twin pulsed jets in a hemispheric elastic cavity](https://arxiv.org/abs/2605.22648)
...
### [19] [Phase-edge imaging using q-plate shifts for faster and simpler microscopy](https://arxiv.org/abs/2605.21839)
...
### [20] [Color2Struct: efficient and accurate deep-learning inverse design of structural color with controllable inference](https://arxiv.org/abs/2510.00767)
...
### [21] [Robust Broadband Infrared Unidirectional Absorption Enabled by a Non-Hermitian Multilayer](https://arxiv.org/abs/2605.21926)
...
### [22] [Cathodoluminescence Wavefront Retrieval](https://arxiv.org/abs/2605.21944)
...
### [23] [Klein tunneling of the laser coherence](https://arxiv.org/abs/2605.22033)
...
### [24] [Electron modulation and ultrafast near-field imaging with vectorial laser fields](https://arxiv.org/abs/2605.22152)
...
### [25] [A Residual-Subspace Constraint Framework for Fourier Ptychographic Microscopy](https://arxiv.org/abs/2605.22197)
...
### [26] [OAM Light Demultiplexing from an Intensity Profile using Orthogonality Renormalization of Pair Modes](https://arxiv.org/abs/2605.22220)
...
### [27] [Single-pump hybrid nonlinearities in transparent conductors](https://arxiv.org/abs/2605.22246)
...
### [28] [Refractive index retrieval of 3D printed materials for photonic applications](https://arxiv.org/abs/2605.22270)
...
### [29] [Mid-infrared temporal ghost imaging via two-photon structured encoding](https://arxiv.org/abs/2605.22298)
...
### [30] [Hyperdoped silicon photodetectors enable room-temperature computational SWIR imaging at 1550 nm](https://arxiv.org/abs/2605.22470)
...
### [31] [Scattering correction for infrared spectra of biological cells using computational infrared microspectroscopy and deep learning](https://arxiv.org/abs/2605.22503)
...
### [32] [A Non-Volatile Heterogeneous Quantum Dot III-V/Si DFB Laser with Optical Memristive Behavior](https://arxiv.org/abs/2605.22577)
...
### [33] [Agentic metasurface design with self-correcting language-model systems](https://arxiv.org/abs/2605.22647)
...
### [34] [All-band photonic integrated optical parametric amplification](https://arxiv.org/abs/2605.22704)
...
### [35] [Magnon-mediated microwave to optical time dynamics](https://arxiv.org/abs/2605.22772)
...
### [36] [Extreme Optical Field Confinement and Enhancement in a Plasmonic Picopatch within a Nanoparticle-on-Mirror Resonator](https://arxiv.org/abs/2605.22780)
...
### [37] [Pfirsch-Schlüter Current](https://arxiv.org/abs/2605.21637)
*Allen H Boozer*
...
### [38] [Numerical simulations of shock-driven, supersonic turbulence in colliding three-temperature laboratory plasmas](https://arxiv.org/abs/2605.21672)
...
### [39] [Optical analogy for stellarators: Ridges as caustics and coils as singularities](https://arxiv.org/abs/2605.21814)
...
### [40] [Fast ion effects on the threshold conditions of ion temperature gradient mode and electron temperature gradient mode](https://arxiv.org/abs/2605.21953)
...
### [41] [PIC simulations of nonrelativistic high-Mach-number oblique shocks propagating in a turbulent medium](https://arxiv.org/abs/2605.21986)
...
### [42] [On the Shafranov shift in stellarators](https://arxiv.org/abs/2605.22105)
...
### [43] [Second stability region for gyrokinetics and the L-H transition](https://arxiv.org/abs/2605.22680)
...
### [44] [Dynamics of fast magnetosonic wave turbulence](https://arxiv.org/abs/2605.22710)
