...
### [1] [Very sensitive vapor-cell quasi-DC atomic E-field sensor](https://arxiv.org/abs/2603.23751)
...
### [2] [Molecular effects in low-energy muon transfer from muonic hydrogen to oxygen](https://arxiv.org/abs/2603.24339)
...
### [3] [Self-organised structures in mixed active-passive suspensions due to hydrodynamic interactions](https://arxiv.org/abs/2603.23555)
...
### [4] [Suppression of Rayleigh-Bénard convection and restratification by horizontal convection](https://arxiv.org/abs/2603.23770)
...
### [5] [DMR effect on drag reduction of a streamlined body measured by Magnetic Suspension and Balance System](https://arxiv.org/abs/2603.23843)
...
### [6] [High-Reynolds-number turbulent boundary layers under adverse pressure gradients. Part 2. A composite mean velocity profile](https://arxiv.org/abs/2603.23912)
...
### [7] [Early warning signals for primary and secondary bifurcation to oscillatory instabilities](https://arxiv.org/abs/2603.24068)
...
### [8] [Jet-edge interaction: linear and non-linear frequency-selection mechanisms](https://arxiv.org/abs/2603.24135)
...
### [9] [Characterisation of rough-wall drag in compressible turbulent boundary layers](https://arxiv.org/abs/2603.24288)
...
### [10] [aPriori: a Python package to process direct numerical simulations](https://arxiv.org/abs/2603.24363)
...
### [11] [Evaporative cooling and deposition patterns of evaporating $Al_2O_3$ nanofluid droplets](https://arxiv.org/abs/2603.24367)
...
### [12] [Geometric Memory Generates Irreversible Transport in Time-Periodic Irrotational Flows](https://arxiv.org/abs/2603.24455)
*Mounir Kassmi*
...
### [13] [Convexity of the longitudinal variation of third-order resonance driving terms and its application in dynamic aperture optimization](https://arxiv.org/abs/2603.23836)
...
### [14] [A generalization of the Froissart-Stora formula to piecewise-linear spin-orbit resonance crossings](https://arxiv.org/abs/2603.24510)
...
### [15] [Numerical field optimization for enhanced efficiency in time-reversible gradient computation of open-source GPU-accelerated FDTD simulations](https://arxiv.org/abs/2603.24027)
...
### [16] [Conserved quantities and ensemble measure for Martyna--Tobias--Klein barostats with restricted cell degrees of freedom](https://arxiv.org/abs/2603.24061)
*Kohei Shinohara*
...
### [17] [Aluminum solidification and nanopolycrystal deformation via a Graph Neural Network Potential and Million-Atom Simulations](https://arxiv.org/abs/2603.24360)
...
### [18] [Magneto-optic perturbation theory for near-complete violation of Kirchhoff's law of thermal emission at low magnetic fields](https://arxiv.org/abs/2603.23538)
...
### [19] [Dichroic Dual-Angle Refractor: Multi-Cell Huygens' Metasurface-Based Circuit Approximation](https://arxiv.org/abs/2603.23542)
...
### [20] [On Sub-Sevenfold Symmetries in LH2 Stacked Ring Scaffolds: A Quantum Optical Perspective](https://arxiv.org/abs/2603.23743)
*Arpita Pal*
...
### [21] [Visible Spectral-Domain Optical Coherence Tomography for Photonic Integrated Circuits Characterization](https://arxiv.org/abs/2603.23815)
...
### [22] [Inverse-Designed Metasurfaces for Compact Optical Skyrmion Generation with High Topological Fidelity](https://arxiv.org/abs/2603.23922)
...
### [23] [Ultrawide Bandwidth Optomechanical Magnetometry Using Flux Concentration](https://arxiv.org/abs/2603.23944)
...
### [24] [Machine vision with small numbers of detected photons per inference](https://arxiv.org/abs/2603.23974)
...
### [25] [Reconfigurable topological valley-Hall interfaces: Asymptotics of arrays of Dirichlet and Neumann inclusions for multiple scattering in metamaterials](https://arxiv.org/abs/2603.24297)
...
### [26] [The Spectral Domain Snell Law in Diffusion-Wave Fields](https://arxiv.org/abs/2603.24094)
...
### [27] [Free-electron laser-based extended wide-field mid-infrared photothermal imaging for biomedical and microplastic analysis](https://arxiv.org/abs/2603.24103)
...
### [28] [Cordierite-based optical resonators with extremely low thermal expansion](https://arxiv.org/abs/2603.24247)
...
### [29] [Colloidal Nanocrystals Regrowth-Assisted Synthesis of Perovskite Microwire Lasers for Integrated Optoelectronics](https://arxiv.org/abs/2603.24285)
...
### [30] [Shape-Dependent, Deep-Learning-Assisted Metamaterial Solid Immersion Lens (mSIL) Super-Resolution Imaging](https://arxiv.org/abs/2603.24371)
...
### [31] [Raman phonon dynamics and its control for enhanced optical frequency conversion](https://arxiv.org/abs/2603.24386)
...
### [32] [Microtearing Thresholds and Second-Stable Ballooning in the DIII-D Pedestal: Reduced Modeling and Core-Edge Implications](https://arxiv.org/abs/2603.23782)
...
### [33] [Laser ion acceleration from concave targets by subpicosecond pulses](https://arxiv.org/abs/2603.23795)
...
### [34] [Clumps in the Resistive-Drift-Wave turbulence](https://arxiv.org/abs/2603.23807)
...
### [35] [Self-Consistent Numerical Framework for Multiscale Circuit-Plasma Coupling with Secondary Electron Emission](https://arxiv.org/abs/2603.24010)
...
### [36] [Study of Low-Frequency Core-Edge Coupling in a Tokamak: II. Spatial Channeling & Focusing In Antenna-Driven MHD](https://arxiv.org/abs/2603.24463)
...
### [37] [Multi-GPU Hybrid Particle-in-Cell Monte Carlo Simulations for Exascale Computing Systems](https://arxiv.org/abs/2603.24508)
...
### [38] [Experimental Evidence for Increased Particle Fluxes Due to a Change in Transport at the Separatrix near Density Limits on Alcator C-Mod](https://arxiv.org/abs/2603.24512)
...
### [39] [Study of Low-Frequency Core-Edge Coupling in a Tokamak: I. Experimental Observation in KSTAR](https://arxiv.org/abs/2603.24525)
