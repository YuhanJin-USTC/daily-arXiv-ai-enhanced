...
### [1] [Assessment of 0-D L-H Power Threshold Scaling and Regression Stability in DIII-D with Applied 3D Magnetic Fields](https://arxiv.org/abs/2607.16509)
...
### [2] [Dynamics of phase space vortices in Vlasov plasmas with ion scale inhomogeneity : I Constant frequency drive study](https://arxiv.org/abs/2607.16779)
...
### [3] [Dynamics of phase space vortices in Vlasov plasmas with ion scale inhomogeneity : II Chirped frequency drive study](https://arxiv.org/abs/2607.16786)
*Sanjeev Kumar Pandey,Amudon Chingangbam,Rajaraman Ganesh*
...
### [4] [ORB5X v1.0: a performance-portable global electromagnetic gyrokinetic PIC code in C++/Kokkos built using Agentic AI](https://arxiv.org/abs/2607.17363)
...
### [5] [Nonlinear Dynamics of Current-Carrying ELM Filaments: Spiral Vorticity, Rotation, and Velocity Suppression](https://arxiv.org/abs/2607.17888)
...
### [6] [An Implicit Time-Domain Harmonic Balance Method for Radio-Frequency Capacitively Coupled Plasma Simulations](https://arxiv.org/abs/2607.18103)
...
### [7] [Equilibrium of a Rapidly Rotating Axisymmetric Magnetic Mirror Machine](https://arxiv.org/abs/2607.18203)
*Richard Fitzpatrick*
...
### [8] [Absolute charge calibration of DRZ phosphor screens for relativistic electron bunches](https://arxiv.org/abs/2607.17059)
...
### [9] [Modeling rare-earth and energy materials supply chains under theoretical China-outer-Mongolia political reunification scenarios](https://arxiv.org/abs/2607.18019)
*Xi Liu,Wenxi Fang*
...
### [10] [anyakrakusuma: A Python Library for Entropic Schrödinger Bridges on Idealized Geometries](https://arxiv.org/abs/2607.18184)
...
### [11] [Effects of anisotropic confinement on droplet rebound from superhydrophobic surfaces](https://arxiv.org/abs/2607.16367)
...
### [12] [From Triadic Interactions to Kolmogorov Scaling: A Deterministic, Scale-Resolved Formulation of Energy Flux](https://arxiv.org/abs/2607.16381)
*Erik Bertram*
...
### [13] [On the collapse of three point vortices on surfaces](https://arxiv.org/abs/2607.16490)
...
### [14] [Experimental and numerical investigation on preferential alignment of Kolmogorov-size fibers in turbulent channel flow](https://arxiv.org/abs/2607.16654)
...
### [15] [An SPH model with physically prescribed parameters for droplet dynamics on complex surfaces](https://arxiv.org/abs/2607.16670)
...
### [16] [Large Eddy Simulation of Plunging Flows in Laboratory-Scale Bedrock Rivers](https://arxiv.org/abs/2607.16908)
...
### [17] [Solver-in-the-loop training of deep learning closures for large-eddy simulation of turbulent premixed jet flames](https://arxiv.org/abs/2607.17376)
...
### [18] [Electric modification of mode competition in viscous films with insoluble surfactants on vertical fibers](https://arxiv.org/abs/2607.17057)
...
### [19] [Multi-Granularity Conformal Prediction for Reliable Neural-Operator Automotive Aerodynamic Surrogates](https://arxiv.org/abs/2607.17297)
...
### [20] [Differentiable Hybrid Neural-CFD Modelling of Wall-Bounded Turbulence: Coupled Learning of Subgrid-Scale and Wall Closures](https://arxiv.org/abs/2607.17357)
...
### [21] [Generalized Reynolds Analogy for Compressible Turbulent Boundary Layers: Unified Velocity-Temperature Relations from Mean to Fluctuating Field](https://arxiv.org/abs/2607.17702)
*You-sheng Zhang*
...
### [22] [A coupled Eulerian Lagrangian approach for fluid and particle dynamics](https://arxiv.org/abs/2607.17836)
...
### [23] [Physically Consistent Outflow Boundary Conditions for Global Stability Analysis of Bluff Body Wakes](https://arxiv.org/abs/2607.17864)
...
### [24] [Transition to chaos in two-dimensional Rayleigh-Bénard convection: the role of the magnetic field](https://arxiv.org/abs/2607.17918)
...
### [25] [A machine-learned probability distribution in the phase space of turbulent channel flow for synthetic turbulence and flow reconstruction](https://arxiv.org/abs/2607.18058)
...
### [26] [A Low-Storage Implicit Dual-Time Finite-Volume Framework for Radio-Frequency Capacitively Coupled Plasma Fluid Simulations](https://arxiv.org/abs/2607.18123)
...
### [27] [Two-color solitons in Kerr third harmonic generation model](https://arxiv.org/abs/2607.16435)
...
### [28] [Measuring the dipole phase of Bloch-trajectory harmonics using a monolithic interferometer](https://arxiv.org/abs/2607.16477)
...
### [29] [Bridging Relativistic Twisted Fermion Beams and Photonic OAM Flux in Gauged Hopf Lattices: Emergent Topological Analogs](https://arxiv.org/abs/2607.16520)
...
### [30] [Robust Fano-like Antiresonances in Large-Area Au-coated Ag-Nanoisland Ensembles](https://arxiv.org/abs/2607.16525)
...
### [31] [80 Channel Photon Pair Source from a Thin-Film Lithium Niobate Racetrack Microresonator](https://arxiv.org/abs/2607.16575)
...
### [32] [Quantitative Benchmarking of a Split-Field PML FDTD Solver: Slit Diffraction, and Scattering from PEC and Dielectric Cylinders](https://arxiv.org/abs/2607.17360)
...
### [33] [Edge of Stability in Nonlinear Photonic Reservoirs: Universal Design Principle for Exciton-Polariton Computing](https://arxiv.org/abs/2607.16706)
...
### [34] [Topological-Charge-Enabled Photonic Doping in ENZ Media](https://arxiv.org/abs/2607.16751)
...
### [35] [Physics-Informed Neural Networks for Optimal Beam Shaping in Flat Optics](https://arxiv.org/abs/2607.18012)
...
### [36] [Permittivity Characterization of 3D-Printed Materials at Millimeter Waves](https://arxiv.org/abs/2607.16937)
...
### [37] [Perfect Absorption in the Critically Damped Regime](https://arxiv.org/abs/2607.17172)
...
### [38] [Broadband suspended lithium tantalate Mach-Zehnder modulator achieving a 460 Gbit/s net data rate](https://arxiv.org/abs/2607.17436)
...
### [39] [Super-resolution imaging enabled by higher-order Bessel Gaussian beams in nanoscale optical structures](https://arxiv.org/abs/2607.17458)
...
### [40] [Nonlinearity-induced chirality in resonant metasurfaces](https://arxiv.org/abs/2607.17600)
...
### [41] [Ghost-wave momentum bandgaps in anisotropic Floquet lattices](https://arxiv.org/abs/2607.17636)
...
### [42] [Numerical Investigation of a 3D End-Firing Antenna Array Based on Two-Photon Polymerization on Thin-Film Lithium Niobate for Optical Beam Steering](https://arxiv.org/abs/2607.17698)
...
### [43] [Multiple soliton regimes enabled by parametric down-conversion in $χ^{(2)}+χ^{(3)}$ microresonators](https://arxiv.org/abs/2607.17706)
...
### [44] [Real-time THz ptychography using an optically modulated aperture](https://arxiv.org/abs/2607.17796)
...
### [45] [Photonic Memory as a Dynamical Phase for Neuromorphic Computing: A Unified Framework with Experimental Realization](https://arxiv.org/abs/2607.17817)
*Isaac Yorke*
...
### [46] [Femtosecond-to-millisecond holographic imaging of laser ablation dynamics](https://arxiv.org/abs/2607.17919)
...
### [47] [Scanless quantum Fourier-transform mid-infrared spectroscopy for rapid high-sensitivity hyperspectral mapping](https://arxiv.org/abs/2607.17964)
...
### [48] [Fiber-Optic Communication and Torsion Sensing via a BB84-Inspired Polarization Scheme](https://arxiv.org/abs/2607.18053)
...
### [49] [Programmable photonics enabled by ferroionic two-dimensional materials](https://arxiv.org/abs/2607.18061)
