...
### [1] [Stabilization of Rydberg Dissipative Time Crystals Using a Scanning Fabry Perot Interferometer Transfer Lock](https://arxiv.org/abs/2602.22498)
...
### [2] [Full Single-Quantum Control of Particles in Penning Traps for Symmetry Tests at the Quantum Limit](https://arxiv.org/abs/2602.22802)
...
### [3] [Kelvin wave and soliton propagation in classical viscous vortex filaments](https://arxiv.org/abs/2602.22439)
...
### [4] [Acoustic Signatures of Pinch-Off Cavities During Water-Entry](https://arxiv.org/abs/2602.22761)
...
### [5] [On the spatial structure and intermittency of soot in a lab-scale gas turbine combustor: Insights from large-eddy simulations](https://arxiv.org/abs/2602.23155)
...
### [6] [From synthetic turbulence to true solutions: A deep diffusion model for discovering periodic orbits in the Navier-Stokes equations](https://arxiv.org/abs/2602.23181)
...
### [7] [Photonic Neuromorphic Computing enabled by a BIC Metasurface](https://arxiv.org/abs/2602.22528)
...
### [8] [Anomalous High-Energy Second Plateau in High Harmonic Generation from Fullerenes](https://arxiv.org/abs/2602.22599)
...
### [9] [Emerging Multidimensional Real-Space Topological Structures at Chiral Bound States in the Continuum](https://arxiv.org/abs/2602.22634)
...
### [10] [Quantum squeezing in an all-resonant periodically poled lithium niobate microresonator](https://arxiv.org/abs/2602.22693)
...
### [11] [Experimental investigation of the effect of dispersion on squeezing generation in a synchronously pumped optical parametric oscillator](https://arxiv.org/abs/2602.22806)
...
### [12] [HELIOS: A surface integral equation software for light scattering in homogeneous, periodic, and stratified environments](https://arxiv.org/abs/2602.23097)
...
### [13] [Kerr-induced Spectral Interferometry for Direct Ultra-sensitive Phase Recovery](https://arxiv.org/abs/2602.22845)
...
### [14] [Hard X-Ray Zernike-Type Phase-Contrast Imaging with a Two-Block Crystal System](https://arxiv.org/abs/2602.22992)
*Levon Haroutunyan*
...
### [15] [Versatile CMOS modulation-free self-isolating stabilized precision lasers on a chip](https://arxiv.org/abs/2602.23160)
...
### [16] [Enhanced Interband Optical Nonlinearities from Coupled Quantum Wells](https://arxiv.org/abs/2602.23246)
...
### [17] [Coherent Virtual Absorption in Dielectric Metasurfaces](https://arxiv.org/abs/2602.23328)
...
### [18] [Temporal metamaterials with passive switching as impedance-matched absorbers](https://arxiv.org/abs/2602.23347)
...
### [19] [Adaptive Patching for Tensor Train Computations](https://arxiv.org/abs/2602.22372)
...
### [20] [Discovery of Interpretable Physical Laws in Materials via Language-Model-Guided Symbolic Regression](https://arxiv.org/abs/2602.22967)
...
### [21] [Ceci n'est pas un committor, yet it samples like one: efficient sampling via approximated committor functions](https://arxiv.org/abs/2602.23236)
...
### [22] [mrfmsim: a modular, extendable, and readable simulation platform for magnetic resonance force microscopy experiments](https://arxiv.org/abs/2602.23337)
...
### [23] [The Effect of Magnetization on Electron Heating in Low-Density Ultracold Neutral Plasmas](https://arxiv.org/abs/2602.22370)
...
### [24] [Nonlinear entropy transfer via zonal flows in gyrokinetic plasma turbulence](https://arxiv.org/abs/2602.22653)
...
### [25] [Isotope Effects on TEM-driven Turbulence and Zonal Flows in Helical and Tokamak Plasmas](https://arxiv.org/abs/2602.22655)
...
### [26] [Gyrokinetic turbulent transport simulations on steady burning condition in D-T-He plasmas](https://arxiv.org/abs/2602.22656)
...
### [27] [Experimental Demonstration of Beam-Driven Wakefield Acceleration in Laser-Plasma Filament](https://arxiv.org/abs/2602.22841)
...
### [28] [Merging of zonal flows in gyrofluid resistive drift-wave turbulence](https://arxiv.org/abs/2602.23007)
