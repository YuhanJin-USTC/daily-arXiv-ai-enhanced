...
### [5] [AI-interpreted Optical Scattering for Robust and Focal Depth-Aware Imaging](https://arxiv.org/abs/2607.22867)
...
### [6] [Clarifying the energy storage capabilities of virtual critical coupling under realistic excitation constraints](https://arxiv.org/abs/2607.22897)
...
### [7] [Combined Cavity Alignment and Mode-Mismatch Sensing using RF-QPD Sensors](https://arxiv.org/abs/2607.22907)
...
### [8] [Phonon heat transport with squeezing-based symmetry breaking](https://arxiv.org/abs/2607.22990)
...
### [9] [Investigating planar Proca metamaterials in nonlinear (2+1)-Electrodynamics](https://arxiv.org/abs/2607.23013)
...
### [10] [Non-volatile integrated photonics on lithium tantalate-on-insulator](https://arxiv.org/abs/2607.23247)
...
### [11] [Three-dimensional confinement of light in photonic crystals without bandgaps](https://arxiv.org/abs/2607.23281)
...
### [12] [Photonic reservoir computing with complex networks](https://arxiv.org/abs/2607.23285)
...
### [13] [Approximate reservoir computing with a semiconductor laser for reducing energy consumption](https://arxiv.org/abs/2607.23288)
...
### [14] [Can Second-Order Nonlinearity in Metal-Dielectric Metamaterials Pave a Way Toward Elusive Photonic Time Crystals?](https://arxiv.org/abs/2607.23363)
*Jacob B Khurgin*
...
### [15] [When Every Simulation Counts: Value-Based Reinforcement Learning for Accelerated Photonics Inverse Design](https://arxiv.org/abs/2607.23469)
...
### [16] [Scaling Limits of Multichannel Spectral Routers for Snapshot Imaging](https://arxiv.org/abs/2607.23508)
...
### [17] [Carrier-Envelope Phase Control of Orbital Angular Momentum in Solid-State High-Harmonic Generation](https://arxiv.org/abs/2607.23652)
...
### [18] [Nonreciprocal subdiffraction imaging with staggered gyromagnetic photonic crystals](https://arxiv.org/abs/2607.23708)
...
### [19] [Nanoscale Photo-Thermal Interaction Theory](https://arxiv.org/abs/2607.23807)
...
### [20] [Position measurement of a levitated particle with vectorial light](https://arxiv.org/abs/2607.23833)
...
### [21] [Dispersion models describing coupled systems in doped crystals. II. Infrared phonon excitations in GaAs single crystals and phonon-plasmon coupling in Zn-doped GaAs](https://arxiv.org/abs/2607.23868)
...
### [22] [Non-Centrosymmetric $γ$-Phase GaS Nanobelts for On-Chip Nonlinear Photonic Applications](https://arxiv.org/abs/2607.23939)
...
### [23] [Quantitative infrared nanoscopy: Probe-cavity eigenmodes and nano-gap polaritons for strongly coupled nanoscale optics](https://arxiv.org/abs/2607.23950)
...
### [24] [Architecture-agnostic analysis of partially coherent light with programmable photonics](https://arxiv.org/abs/2607.24104)
...
### [25] [Ultranarrow-linewidth self-injection-locked tunable blue GaN DFB laser](https://arxiv.org/abs/2607.24240)
...
### [26] [Hyperspectral imaging for inline quality monitoring of roll-to-roll slot-die coated organic photovoltaic active layers](https://arxiv.org/abs/2607.24278)
...
### [27] [Comparison between methods to measureintensity modulator Vpi](https://arxiv.org/abs/2607.24294)
...
### [28] [Lead nanoparticles, the deep-ultraviolet to near-infrared plasmonic platform](https://arxiv.org/abs/2607.24340)
...
### [29] [Wavelength-diverse transmission for turbulence-resistant free-space optical communication](https://arxiv.org/abs/2607.24408)
...
### [30] [Experimental Observation of Ghost Image Revivals via Structured Coherence](https://arxiv.org/abs/2607.24486)
...
### [31] [Wearable metasurfaces for boosting the effective area of mobile-device antennas](https://arxiv.org/abs/2607.24497)
...
### [32] [Universal Statistics of Energy and Information Flow in Random Electromagnetic Fields](https://arxiv.org/abs/2607.24631)
...
### [33] [Characterisation of a multistable turbulent wake: application of an improved regime identification with analytical model training](https://arxiv.org/abs/2607.23206)
...
### [34] [Dynamics of fluid-fluid displacements in a model rough fracture beyond the quasistatic limit: A spectral approach](https://arxiv.org/abs/2607.23759)
...
### [35] [Adjoint Sensitivity Maps for Passive Flow Control Around Rotating Circular Cylinders Across a Wide Operating Envelope](https://arxiv.org/abs/2607.23831)
*Niklas Kühl*
...
### [36] [Influence of a vertical-wall leading edge on bouncing and escape bubble rising regimes](https://arxiv.org/abs/2607.24248)
...
### [37] [Bubble growth on arrays of micro-electrodes](https://arxiv.org/abs/2607.24286)
...
### [38] [The balance between compactness and forecast accuracy of data-driven latent-space reduced-order models in controlled wake flows](https://arxiv.org/abs/2607.24569)
...
### [39] [A Modified Moving Reference Frame Method for Propeller Resolution](https://arxiv.org/abs/2607.24630)
...
### [40] [Radiation Pressure Effect on the degenerate Electron-Positron Plasma Dynamics](https://arxiv.org/abs/2607.23217)
...
### [41] [Comparative qualification of advanced plasma-facing materials for fusion pilot plants through public- and private-sector experiments in DIII-D](https://arxiv.org/abs/2607.23400)
...
### [42] [Implementation and first application of EMC3-EIRENE on DTT for assessing the heat load on the ICRH antenna](https://arxiv.org/abs/2607.23528)
...
### [43] [Spacecraft heat shield study in the DIII-D tokamak](https://arxiv.org/abs/2607.23895)
...
### [44] [Gravitational Sedimentation and Rebound of Strongly Coupled Dusty Plasma Crystals: A Molecular Dynamics Study](https://arxiv.org/abs/2607.24044)
...
### [45] [Modeling ultrarelativistic streaming plasma instabilities under the quasistatic approximation](https://arxiv.org/abs/2607.24214)
...
### [46] [Quasistatic modeling of ultrarelativistic beam-plasma instabilities](https://arxiv.org/abs/2607.24234)
...
### [47] [Impact of ion-electron collisions on nonlocal ion heat conduction, viscous stress, and diffusion](https://arxiv.org/abs/2607.24505)
...
### [48] [Solution to an unsolved problem in diodes: Limiting current for small emission area and low emission energy](https://arxiv.org/abs/2607.24590)
...
### [49] [Implementation and verification of the avalanche source in a 3D full-f particle-in-cell model of relativistic electrons for studies of tokamak disruptions](https://arxiv.org/abs/2607.24602)
...
### [50] [Gravity-Aligned Vertical Electron-Positron Linear Collider](https://arxiv.org/abs/2607.24179)
*Tetsuo Abe*
...
### [51] [A corrective agentic hybrid RAG and an operations-grounded evaluation for a scientific facility](https://arxiv.org/abs/2607.24663)
