...
### [6] [Extraction of Effective Electromagnetic Material Properties for Rydberg Electrometer Vapor Cells from 10-300 MHz](https://arxiv.org/abs/2604.11785)
...
### [7] [Unified scaling laws for turbulent boundary layers across flow regimes](https://arxiv.org/abs/2604.09947)
...
### [8] [Unified Gas-Kinetic Scheme for Unsteady Multiscale Flows with Moving Boundaries](https://arxiv.org/abs/2604.09984)
...
### [9] [Fundamental thermo-visco mechanical interactions governing the acoustic response of laser-excited nanoparticles](https://arxiv.org/abs/2604.10201)
...
### [10] [Dynamic multiphase flow triggers chaotic mixing in porous media](https://arxiv.org/abs/2604.10382)
...
### [11] [Weakly coupled fluid-structure interaction between wall-bounded turbulent flows and defect-embedded phononic subsurfaces](https://arxiv.org/abs/2604.10430)
...
### [12] [Fate of Secondary Droplets Produced by High-speed Raindrops Interacting with a Liquid Pool](https://arxiv.org/abs/2604.10491)
...
### [13] [Magnetohydrodynamic drag on an oscillating sphere in a rotating cavity](https://arxiv.org/abs/2604.10594)
...
### [14] [Wake-Induced Drag and Phase-Reconstructed Dynamics of a Flexible Plate in Normal Flow](https://arxiv.org/abs/2604.10840)
...
### [15] [Non-Monotonic Marangoni Suppression of Hydrodynamic Coarsening in Bicontinuous Liquid-Liquid Phase Separation](https://arxiv.org/abs/2604.10920)
...
### [16] [LCS.jl: A High-Performance, Multi-Platform Computational Model in Julia for Turbulent Particle-Laden Flows](https://arxiv.org/abs/2604.11008)
...
### [17] [Patchy Polymeric Scalar Turbulence](https://arxiv.org/abs/2604.11034)
...
### [18] [Bicuspid Valve Closure and Backflow Prevention: Role of Leaflet Geometry](https://arxiv.org/abs/2604.11776)
...
### [19] [Signal-Aware Conditional Diffusion Surrogates for Transonic Wing Pressure Prediction](https://arxiv.org/abs/2604.11263)
...
### [20] [Compressible turbulent boundary layers over two-dimensional square-rib roughness](https://arxiv.org/abs/2604.11414)
...
### [21] [Finite Vertical Windows: Seeing Only Part of the Picture in Rotating Turbulence](https://arxiv.org/abs/2604.11457)
...
### [22] [From Sedimentation to Suspension: Critical Strain as a Predictor of Particle Resuspension Thresholds](https://arxiv.org/abs/2604.11634)
...
### [23] [Influence of plume activity on thermal convection in a rectangular cell](https://arxiv.org/abs/2604.11670)
...
### [24] [Data-driven oscillator model for multi-frequency turbulent flows](https://arxiv.org/abs/2604.11745)
...
### [25] [Schrödinger-Navier-Stokes equation for capillary fluids](https://arxiv.org/abs/2604.11747)
...
### [26] [Shape-dependence of electrophoretic mobility](https://arxiv.org/abs/2604.11771)
...
### [27] [Learning noisy phase transition dynamics from stochastic partial differential equations](https://arxiv.org/abs/2604.09664)
...
### [28] [Differentiable free energy surface: a variational approach to directly observing rare events using generative deep-learning models](https://arxiv.org/abs/2604.09769)
...
### [29] [Admissible Reconstruction of Reaction-Channel Levels on Fixed Subgroup Support for Cross-Section-Space Probability Table Constructions](https://arxiv.org/abs/2604.09992)
...
### [30] [A sign-blocking method for mitigating the fermion sign problem](https://arxiv.org/abs/2604.10156)
...
### [31] [A unified sharp-diffusive phase-field model for bulk and interfacial cohesive fracture](https://arxiv.org/abs/2604.10623)
*Ye-Hang Qin,Ye Feng*
...
### [32] [Polarization-Sensitive Third Harmonic Generation in resonant silicon nitride Metasurfaces for deep-UV Emission](https://arxiv.org/abs/2604.11238)
...
### [33] [Observation of Discrete 1D Solitons in an Optically Induced Lattice in Rubidium Atomic Vapor](https://arxiv.org/abs/2604.11493)
...
### [34] [High bandwidth traveling wave electro-optic modulator at 1μm on thin-film lithium tantalate](https://arxiv.org/abs/2604.09825)
...
### [35] [Interference Limited Absorption in Dense Molecular Nanolayers Near Reflecting Surfaces](https://arxiv.org/abs/2604.09851)
...
### [36] [Nonlocal current-response theory of structured-light dichroism](https://arxiv.org/abs/2604.10001)
...
### [37] [High-speed recording technique by synchronous movement of media and spherical reference wave for holographic data storage](https://arxiv.org/abs/2604.10069)
...
### [38] [Experimental Observation of Time-Domain Bound States in The Continuum](https://arxiv.org/abs/2604.10111)
...
### [39] [Engineering Multi-wavelength Emission in All-Fiber Laser Mode-Locked Through Nonlinear Polarization Rotation](https://arxiv.org/abs/2604.10198)
...
### [40] [Deep Photonic Reservoir Computer Meets UAV Control: An ultra-fast learning-based compensator for agile flight in confined space](https://arxiv.org/abs/2604.10262)
...
### [41] [Physics-Informed Synthetic Dataset and Denoising TIE-Reconstructed Phase Maps in Transient Flows Using Deep Learning](https://arxiv.org/abs/2604.10610)
...
### [42] [Optimal Null-Constrained Source-Basis Sensing in a Time-Reversed Young Interferometer](https://arxiv.org/abs/2604.10320)
*Jianming Wen*
...
### [43] [Precise measurement of the Kerr coefficient using phase-sensitive pump-probe hyperspectral imaging](https://arxiv.org/abs/2604.10340)
...
### [44] [Efficient imaging of quantum emitters using compressive sensing](https://arxiv.org/abs/2604.10463)
...
### [45] [Disorder-immune momentum band winding topology](https://arxiv.org/abs/2604.10486)
...
### [46] [Transmission-Mode Silicon-Rich Nitride Mie-Void Metasurfaces in the Visible](https://arxiv.org/abs/2604.10488)
...
### [47] [OAM modes characteristics analysis and low-loss transmission based on topological confinement](https://arxiv.org/abs/2604.10515)
...
### [48] [Electro-optically controlled photon group velocity, temporal walk-off and two-photon entanglement via nematic liquid crystal](https://arxiv.org/abs/2604.10537)
...
### [49] [Direct volumetric reconstruction for highly compressive x-ray fluorescence ghost tomography](https://arxiv.org/abs/2604.10671)
...
### [50] [Real-time polarization tuning in Mach-Zehnder interferometer using electro-optically modulated twist angles of nematic liquid crystal Note: This paper has been accepted for publication in "Journal of Theoretical and Applied Physics"](https://arxiv.org/abs/2604.10691)
...
### [51] [Reducing the Carrier-Envelope-Phase-dependence of High-Harmonic-Generation by Vectorial-Time-Polarization-Gating](https://arxiv.org/abs/2604.10817)
...
### [52] [Harnessing Photonics for Machine Intelligence](https://arxiv.org/abs/2604.10841)
...
### [53] [Ultrasensitive Nanoplastics Detection Leveraging Shrinking Surface Plasmonic Bubble](https://arxiv.org/abs/2604.10871)
...
### [54] [Twist-Controlled Symmetry Breaking in Surface Phonon Polariton Moiré Metasurfaces](https://arxiv.org/abs/2604.10915)
...
### [55] [Iterative approach for high-quality binary intensity hologram generation in augmented reality applications](https://arxiv.org/abs/2604.11181)
...
### [56] [Recovery of tunable bound-states in the continuum](https://arxiv.org/abs/2604.11217)
...
### [57] [Artificial-atom arrays in moire superlattices for quantum optics](https://arxiv.org/abs/2604.11360)
...
### [58] [Long-wave infrared Fourier transform spectroscopy with enhanced and scalable sensitivity](https://arxiv.org/abs/2604.11622)
...
### [59] [High-Endurance, Low-loss Sb2Se3 Optical Switches on Silicon Nitride using Transparent Conductive Heaters](https://arxiv.org/abs/2604.11649)
...
### [60] [Anisotropic photonic time interfaces via isotropic spacetime modulations](https://arxiv.org/abs/2604.11683)
...
### [61] [Magnetic switching of self-hybridized exciton-polaritons in CrSBr photonic crystal slabs](https://arxiv.org/abs/2604.11750)
...
### [62] [Self-Configuring Universal Multichannel and Multidimensional Integrated Photonic Processing Engine](https://arxiv.org/abs/2604.11763)
