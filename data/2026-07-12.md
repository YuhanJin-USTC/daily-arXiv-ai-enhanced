...
### [9] [Probing individual phonon-polaritonic nanoparticle-on-mirror cavities by infrared nanospectroscopy](https://arxiv.org/abs/2607.07941)
...
### [10] [Ultra-high-speed chemiluminescence tomography of spinning-mode detonation waves](https://arxiv.org/abs/2607.07971)
...
### [11] [Multiband topological group-velocity control from slow light to light stopping](https://arxiv.org/abs/2607.08055)
...
### [12] [Nyquist-Sampled Time-Domain Adjoint FDTD for Memory-Efficient Broadband Nanophotonic Inverse Design](https://arxiv.org/abs/2607.08159)
...
### [13] [Nanosecond Pulsed-Laser Treatment Couples Chloride Removal with Oxide Transformation in Salt-Corroded Carbon Steel](https://arxiv.org/abs/2607.08229)
...
### [14] [Ion-Implanted Silicon Nanoregions Enable Ultra-Low-Loss Trimming of Cladded Photonic Integrated Circuits](https://arxiv.org/abs/2607.08266)
...
### [15] [Inverse-designed meta processing units for multi-task near-field photonic computing](https://arxiv.org/abs/2607.08360)
...
### [16] [Joint Discrete-Continuous Flow Matching for Open-Vocabulary Inverse Design of Multilayer Optical Coatings](https://arxiv.org/abs/2607.08392)
...
### [17] [Doubly resonant enhancement of second-harmonic generation with in-plane phase matching in plasmonic metasurfaces on an AlInP slab waveguide](https://arxiv.org/abs/2607.08430)
...
### [18] [Optimal slit width for high-precision orbital angular momentum measurement using angular double-slit interferometry](https://arxiv.org/abs/2607.08549)
...
### [19] [Broadband silicon photonic phase shifters driven by gradient optical forces](https://arxiv.org/abs/2607.08558)
...
### [20] [Intracellular luminescence thermometry: A story of disagreement, trust, and hope](https://arxiv.org/abs/2607.08574)
...
### [21] [Asymmetric high-harmonic generation from subwavelength bianisotropic resonators](https://arxiv.org/abs/2607.08715)
...
### [22] [TeV Electron Beams from Plasma Acceleration via Regenerative Cascading](https://arxiv.org/abs/2607.07979)
...
### [23] [Multi-GeV Electron Combs from a Plasma Wakefield Accelerator](https://arxiv.org/abs/2607.08069)
...
### [24] [Dual-Platform Precision Measurement of the $3^2D_{5/2}$ to $4^2S_{1/2}$ $g$-Factor Ratio in $^{40}\text{Ca}^+$](https://arxiv.org/abs/2607.07929)
...
### [25] [Theoretical ab initio Evolution of Satellite Intensity near Threshold for Cu K-shell transitions](https://arxiv.org/abs/2607.07983)
...
### [26] [Extracting inter-nuclear distances in the oxygen molecule interacting with an XFEL-pulse: a fundamental system for understanding Coulomb explosion imaging](https://arxiv.org/abs/2607.08211)
...
### [27] [Efficient photo-ionizing elimination of detrimental electric fields for Rydberg atoms](https://arxiv.org/abs/2607.08418)
...
### [28] [Fourier imaging of collective spontaneous emission modes in superradiant cold atomic clouds](https://arxiv.org/abs/2607.08421)
...
### [29] [A Puck-informed mode-resolved phase-field fatigue framework for unidirectional composites](https://arxiv.org/abs/2607.07977)
*Aamir Dean*
...
### [30] [Parallel simulation of rarefied gas flows on unstructured meshes using the DIG-augmented DSMC method](https://arxiv.org/abs/2607.08195)
...
### [31] [Learned Committors as Reaction Coordinates for Nucleation Rates](https://arxiv.org/abs/2607.08207)
...
### [32] [Repurposing acquisition devices into trigger-based timing synchronization of breakdown events during MITICA high voltage holding experiments](https://arxiv.org/abs/2607.08501)
...
### [33] [Analysis of collisional and facility effects in a magnetic nozzle plasma expansion](https://arxiv.org/abs/2607.07861)
...
### [34] [Sensitivity of a low-shear heliotron configuration to localised ferrite perturbations](https://arxiv.org/abs/2607.08290)
...
### [35] [Precision mapping of laser-driven magnetic fields and their evolution in high-energy-density plasmas](https://arxiv.org/abs/2607.08680)
