...
### [5] [From populations to absolute binding affinities in molecular simulations: exact volumetric terms and practical estimators](https://arxiv.org/abs/2608.04834)
...
### [6] [Photo-ionization Compensation of Stray Electric Fields for Cold Rydberg Atoms](https://arxiv.org/abs/2608.04660)
...
### [7] [Field Deviations in Dipole-Driven Linear Paul Traps: Effects of Endcap Boundaries and their Minimization](https://arxiv.org/abs/2608.04681)
...
### [8] [Diatomic molecular anions of alkali-metal and alkaline-earth-metal atoms](https://arxiv.org/abs/2608.05067)
...
### [9] [Impact of Wind Direction on Flow and Turbulent Statistics Over a Realistic Urban Area: A Large-Eddy Simulation Study](https://arxiv.org/abs/2608.04136)
...
### [10] [Floquet stability analysis of pulsatile particle-laden channel flow](https://arxiv.org/abs/2608.04161)
...
### [11] [An Artificial-Compressibility Physics-Informed Neural Network for the Unsteady Incompressible Navier--Stokes Equations](https://arxiv.org/abs/2608.04191)
*Aytekin Çibik*
...
### [12] [TIDE: A Physically Diverse 3D Turbulence Benchmark Dataset for Advancing Scientific Machine Learning](https://arxiv.org/abs/2608.04222)
...
### [13] [Beyond the Mean-flow: A Spectral-Dynamic Approach to Unraveling the Physics of Droplet Capture in Fog Harvesting Meshes](https://arxiv.org/abs/2608.04325)
...
### [14] [Expansion of a hole in a viscoelastic liquid sheet](https://arxiv.org/abs/2608.04345)
...
### [15] [Reliable and efficient steady CFD from surrogate predictions through Newton-Krylov correction](https://arxiv.org/abs/2608.04400)
...
### [16] [Interfacial dynamics and energy cascade in immiscible Rayleigh-Taylor turbulence](https://arxiv.org/abs/2608.04447)
...
### [17] [Higher-Order Extensions of Weakly Viscous Dysthe Theory and a Phase-Lag Model for Nonlinear Mean-Flow Damping](https://arxiv.org/abs/2608.04473)
*C. M. Schober,A. Islas*
...
### [18] [Erodible bed turbulence modulation driven by transition between longitudinal and transverse bedforms at varying Shields numbers](https://arxiv.org/abs/2608.04648)
...
### [19] [Free-surface curvature and its relation to subsurface turbulence](https://arxiv.org/abs/2608.04687)
...
### [20] [A hybrid proper orthogonal decomposition and diffusion framework for reduced-order forecasting of turbulent flow dynamics](https://arxiv.org/abs/2608.04728)
...
### [21] [Laminar gaps mirror turbulent puffs in pipe flow](https://arxiv.org/abs/2608.04823)
...
### [22] [Extreme flows: where physics meets mathematically rigorous bounds](https://arxiv.org/abs/2608.04859)
*Bartosz Protas*
...
### [23] [Structured light under turbulence](https://arxiv.org/abs/2608.04090)
...
### [24] [Analysis of Nonlinear Phase Noise in Coherent Fiber-Optic Systems Based on Phase Shift Keying](https://arxiv.org/abs/2608.04221)
*Shiva Kumar*
...
### [25] [Quantum optoelectronics in semiconductor solar cell materials and devices](https://arxiv.org/abs/2608.04328)
...
### [26] [All-Optical Field-Resolved Spectroscopy With Interferometric Nonlinear Cross-Correlations](https://arxiv.org/abs/2608.04493)
...
### [27] [Photogalvanic second harmonic generation in Si3N4 for 1 Hz level on-chip metrology and spectroscopy](https://arxiv.org/abs/2608.04555)
...
### [28] [Design of a thermal loading resilient optical enhancement cavity for operation at 515 nm for X-ray production through inverse Compton scattering in an energy recovery linac](https://arxiv.org/abs/2608.04580)
...
### [29] [Universal Function Approximation via Diffractive Optical Processors: Physical Limits, Error Bounds, and Learnability](https://arxiv.org/abs/2608.04582)
...
### [30] [Freeform super-oscillatory optics for CMOS-integrated THz super-resolution imaging](https://arxiv.org/abs/2608.04711)
...
### [31] [Photonic-chip-based generation of sub-100-femtosecond optical frequency combs](https://arxiv.org/abs/2608.04931)
...
### [32] [Mask-free fast patterning of organic light-emitting diode pixels using laser-assisted close-space sublimation](https://arxiv.org/abs/2608.05073)
...
### [33] [Accessing the symmetric component of quadrupole misalignment through counter-rotating closed orbits in EDM storage rings](https://arxiv.org/abs/2608.04647)
...
### [34] [Laser-Plasma Accelerator Beams in Light Sources: Femtosecond High-Brightness Radiation through Chirped Pulse Injection](https://arxiv.org/abs/2608.04699)
...
### [35] [Building a Start-to-End Model of the CESR Injector Linac](https://arxiv.org/abs/2608.05094)
