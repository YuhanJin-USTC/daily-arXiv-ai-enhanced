...
### [1] [Experimental observation of strong field stabilization](https://arxiv.org/abs/2606.00242)
...
### [2] [Theory for the Rydberg states of helium: quantum defect extensions and comparison with experiment up to $n = 102$ for the singlet and triplet $P$-states](https://arxiv.org/abs/2606.00814)
...
### [3] [A tunable feedback-controlled magnetic trap for a magnet in free fall](https://arxiv.org/abs/2606.01056)
...
### [4] [Non-destructive cavity readout of molecules for precision measurements](https://arxiv.org/abs/2606.01743)
...
### [5] [Creating and Probing Spin-Squeezed States of Molecules](https://arxiv.org/abs/2606.02500)
...
### [6] [Suppression of differential light shifts in ground and metastable trapped-ion qubits](https://arxiv.org/abs/2606.02543)
...
### [7] [A Mid-Infrared Platform Based on Strontium Tweezer Arrays](https://arxiv.org/abs/2606.02560)
...
### [8] [Viability of Tensor Train Methods for Geophysical Fluid Dynamics](https://arxiv.org/abs/2606.00055)
...
### [9] [Lattice Boltzmann Methods for Compressible (Magneto)hydrodynamics](https://arxiv.org/abs/2606.00641)
...
### [10] [Surrogate-Based Aerodynamic Shape Optimization in Multiscale Flows via the Implicit Unified Gas-Kinetic Scheme](https://arxiv.org/abs/2606.00645)
...
### [11] [Linear causality and stability constraints on relativistic second-order magnetohydrodynamics](https://arxiv.org/abs/2606.00649)
...
### [12] [Disentangling spanwise asymmetries in unsteady wing wakes: global mode sensitivity and spatio-temporal harmonic resolvent analyses](https://arxiv.org/abs/2606.00859)
...
### [13] [Solubility enhanced surfactant-induced flow in air-liquid-air sheets](https://arxiv.org/abs/2606.00921)
...
### [14] [Start-up and inertialess instability of elasto-viscoplastic channel flow](https://arxiv.org/abs/2606.01010)
...
### [15] [End-to-end optimization of subgrid scale models for discontinuous spectral element schemes based on the discrete adjoint method](https://arxiv.org/abs/2606.01150)
...
### [16] [Emergent Transfer of a Physics Foundation Model from Simulation to Laboratory Turbulence](https://arxiv.org/abs/2606.01470)
...
### [17] [Anti-Fourier heat flux does not certify the fourth-order closure state of a rarefied cavity](https://arxiv.org/abs/2606.01480)
*Ehsan Roohi*
...
### [18] [Interaction between vapor bubbles during flow boiling heat transfer in microchannels](https://arxiv.org/abs/2606.01654)
...
### [19] [Breaking-induced energy dissipation of surface gravity waves at varying scales and co-flowing wind stresses](https://arxiv.org/abs/2606.01705)
...
### [20] [A model for pulsation in high-speed double cone flow](https://arxiv.org/abs/2606.01942)
...
### [21] [Identifying sensitivity-dominant parameters via active subspaces in reduced-order modeling of fluid dynamics](https://arxiv.org/abs/2606.02315)
...
### [22] [Sharp-interface Simulations of Energetic Multiphase Flows with Large Density and Viscosity Ratios](https://arxiv.org/abs/2606.02467)
...
### [23] [Development of flash lithium evaporators for NSTX-U](https://arxiv.org/abs/2606.00777)
...
### [24] [The Diocotron Instability in the Trapped Electrons Experiment T-REX and its Relevance to Electron Clouds in Gyrotron Guns](https://arxiv.org/abs/2606.02217)
...
### [25] [Resistive wall mode induced disruptions in an advanced tokamak](https://arxiv.org/abs/2606.02349)
*Sui Wan,Ping Zhu*
...
### [26] [Electron injection and acceleration into laser-driven wakefield from a solid overdense plasma target](https://arxiv.org/abs/2606.02454)
...
### [27] [Modeling Torque Induced Alignment in a Dusty Plasma System](https://arxiv.org/abs/2606.02554)
...
### [28] [Robust Radiative Cooling in Functionalizable Silica Microsphere Paints](https://arxiv.org/abs/2606.00565)
...
### [29] [Möbius-like Real-Space Topology Reshapes Spectral Winding Topology in Hatano-Nelson Rings](https://arxiv.org/abs/2606.00627)
...
### [30] [Autonomous agentic design for photonics](https://arxiv.org/abs/2606.00915)
...
### [31] [Fundamental Limit for One versus Two Point Sources Detection using Direct Imaging](https://arxiv.org/abs/2606.00968)
...
### [32] [Breaking the Cascade: Compact Nonlinear Optical Computing with Single-Layer Encoder-Decoder Co-Localization](https://arxiv.org/abs/2606.01032)
...
### [33] [Multiparameter Maximum Information States for Coherent Diffraction Measurements](https://arxiv.org/abs/2606.01445)
...
### [34] [Emerging Non-Volatile Opto-electronic Resistive Memories for Next-Generation Photonic Integrated Circuits](https://arxiv.org/abs/2606.01463)
...
### [35] [Single-Photon Infrared Imaging with a Silicon Camera Based on Long-Wavelength-Pumping Two-Photon Absorption](https://arxiv.org/abs/2606.01550)
...
### [36] [High-precision passive stabilization of repetition rate for a mode-locked fiber laser based on optical pulse injection](https://arxiv.org/abs/2606.01555)
...
### [37] [Mid-Infrared Single-Photon Edge Enhanced Imaging based on Nonlinear Vortex Filtering](https://arxiv.org/abs/2606.01583)
...
### [38] [Manifold partitioning induced sequential optical reasoning and decision framework for photonic computing](https://arxiv.org/abs/2606.01616)
...
### [39] [In-situ Silicon Doped hBN by High-Temperature Molecular Beam Epitaxy Enables Single Photon Emission](https://arxiv.org/abs/2606.01727)
...
### [40] [Near-UV Single-Pixel Imaging with All-Inorganic Lead-Free Perovskite](https://arxiv.org/abs/2606.01731)
...
### [41] [Gain and One-Way Propagation in Synthetically Moving non-Foster Gratings](https://arxiv.org/abs/2606.01864)
...
### [42] [Dielectric-Anisotropy-Induced Quasi-BIC Activation for Spatial Differentiation in All-Dielectric Metasurfaces](https://arxiv.org/abs/2606.01983)
...
### [43] [Photon thermalization in a disordered scattering medium](https://arxiv.org/abs/2606.01997)
...
### [44] [Bragg-enhanced time-domain Brillouin scattering from a propagating acoustic grating](https://arxiv.org/abs/2606.02012)
...
### [45] [Dipolar Modeling of Multipolar Metasurfaces](https://arxiv.org/abs/2606.02033)
...
### [46] [Ultrafast internal dynamics of chiral domain walls probed by time-resolved XRMS](https://arxiv.org/abs/2606.02154)
...
### [47] [Transverse spin texture in optical non-Hermitian skin modes](https://arxiv.org/abs/2606.02189)
...
### [48] [Drift-free characterization of electro-optic tuning efficiency in lithium niobate photonic nanocavities](https://arxiv.org/abs/2606.02216)
...
### [49] [Skyrmions in scalar fields of non-Hermitian optical microcavities: spontaneous formation, nonlinear control, and optical forces](https://arxiv.org/abs/2606.02265)
...
### [50] [Perturbative photonic matrix-vector multiplication with reduced phase-shift range](https://arxiv.org/abs/2606.02451)
...
### [51] [Multilayer Babinet metamaterial to initiate nonreciprocal topological phenomena and generalized Faraday rotation](https://arxiv.org/abs/2606.02571)
...
### [52] [Data-Driven Spectral Prediction for Accelerating Large-Scale Electronic Structure Calculations](https://arxiv.org/abs/2606.00401)
...
### [53] [Rossi-alpha Benchmark Validation of a Static Alpha Eigenvalue Capability in OpenMC](https://arxiv.org/abs/2606.00907)
...
### [54] [The semi-explicit nonsmooth Newmark time integrator for robust unilateral contact in dynamic fragmentation simulations](https://arxiv.org/abs/2606.01355)
...
### [55] [Differentiable Particle-Mesh Ewald with Cartesian Tensor Message Passing for Learning Long-Range Electrostatics and Dipole Response](https://arxiv.org/abs/2606.01598)
...
### [56] [Sequential Subspace Mode Adaptation for the Reduced-Order Homogenization of Dissipative Microstructures using E3C Hyper-Reduction](https://arxiv.org/abs/2606.02089)
...
### [57] [Results of R&D Programmes and LP&CW EXFEL Cryomodule Tests in the Period from 2005 to 2023](https://arxiv.org/abs/2606.00723)
*J. Sekutowicz,D. Proch,J. Eschke,K. Jensch,W-D Moeller,A. Goessel,W. Cichalewski,A. Bellandi,J. Branlard,D. Kostin,W. Merz,N. Mildner,F. Mittag,R. Onken,E. Vogel,H. Weise,M. Wiencek*
