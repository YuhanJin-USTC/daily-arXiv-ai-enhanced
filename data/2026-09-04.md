...
### [1] [MGKDB: An IMAS-aligned multicode gyrokinetic simulation database for reproducible fusion turbulence modeling and data-driven analysis](https://arxiv.org/abs/2609.03132)
...
### [2] [Dependence of self-injected bunch parameters on the plasma density gradient and laser pulse amplitude at LWFA in a conical plasma channel](https://arxiv.org/abs/2609.03479)
...
### [7] [Finite-source filtering and Doppler modulation of infragravity waves generated by breakpoint forcing](https://arxiv.org/abs/2609.03300)
...
### [8] [Cascade coalescence dynamically sustains bubble retention near gas-evolving surfaces](https://arxiv.org/abs/2609.03387)
...
### [9] [Interface-resolved simulations of boiling heat transfer](https://arxiv.org/abs/2609.03396)
...
### [10] [A conservative coupling method of sharp-interface and multi-species model for compressible reacting gas-liquid flows with phase change](https://arxiv.org/abs/2609.03509)
...
### [11] [Mach-number-dependent dissipative anomaly in isothermal compressible turbulence](https://arxiv.org/abs/2609.03945)
...
### [12] [How do flapping avian wing exhibit superior aerodynamic performance?](https://arxiv.org/abs/2609.03957)
...
### [13] [Analytic study of the continuous spectrum of three-dimensional weak shock layers](https://arxiv.org/abs/2609.03969)
*Vassilis Theofilis*
...
### [14] [Dissipation scaling in wind turbine wakes exposed to free-stream turbulence](https://arxiv.org/abs/2609.03996)
...
### [15] [Effects of the Direct Space Charge on Transverse Coupled-Bunch Instabilities](https://arxiv.org/abs/2609.03771)
*Chao Li*
...
### [16] [Grammar-based topology search for reconfigurable integrated photonic spectrometers](https://arxiv.org/abs/2609.03196)
*Juejun Hu*
...
### [17] [Vortex solitons in disclination quasicrystals](https://arxiv.org/abs/2609.03244)
...
### [18] [A Silicon-Compatible Uncooled Compact Broadband Infrared Spectrometer](https://arxiv.org/abs/2609.03284)
...
### [19] [Machine learning-assisted design and explainable optimization of CdSnP2-based integrated solar-photodetector devices](https://arxiv.org/abs/2609.03642)
...
### [20] [3D scattered light imaging: extracting 3D fiber orientations from 1D line profiles in brain imaging](https://arxiv.org/abs/2609.03764)
...
### [21] [Thermal Noise in Optical Coatings: A Rigorous Opto-Mechanical Comparison of Nanolaminates and Isotropic Mixtures](https://arxiv.org/abs/2609.03850)
...
### [22] [Cavity Ring-Down Spectroscopy at Benchmark-Level Sub-Permille Accuracy Enabled by a System-Level Detection Transfer Function](https://arxiv.org/abs/2609.04027)
...
### [23] [Twin-photon generation in a silicon nitride microresonator](https://arxiv.org/abs/2609.04171)
...
### [24] [BU-MBAR: A hybrid solution strategy for the MBAR equations](https://arxiv.org/abs/2609.03541)
...
### [25] [Computing high-order mixed derivatives in physics-informed neural networks using multi-index Bell polynomials](https://arxiv.org/abs/2609.03768)
*Fumihiro Imoto*
...
### [26] [Stochastic Operator Inference for reduced-order modeling of capillary wave turbulence using experimental measurements](https://arxiv.org/abs/2609.04008)
...
### [27] [Spectral and Eigenvector Crossovers in Random Mixed Graphs](https://arxiv.org/abs/2609.04152)
...
### [28] [Low stray-field ion pump configuration for cold atom experiments](https://arxiv.org/abs/2609.03570)
...
### [29] [Magnetic Dipole Hyperfine Constants of 15 Energy Levels in $^{169}$Tm II Determined by Collinear Laser Fluorescence Spectroscopy](https://arxiv.org/abs/2609.03997)
...
### [30] [Sub-barrier peaks in atom-atom-ion three-body recombination](https://arxiv.org/abs/2609.04106)
